			...
			<div class="clear"></div>		
				...
				<?php  $objfeatureimage->isfeatureImage($event_id);
					...
					<li style="margin: 0; display: block;">
                                <a href="#feature_image" id="feature"><img src="<?php echo $obj_base_path->base_path(); ?>/files/event/gallery/medium/<?php echo $objfeatureimage->f('media_url');?>"  border="0"  /></a>
                                </li>
                                 <script type="text/javascript">
					$(document).ready(function() {
						$("#feature").fancybox({ 
						...
						'hideOnContentClick':false
                                  ...
                                  <div style="display:none;">
                                  	<div style="width:auto;height:auto; background:#FFF; padding:10px;" id="feature_image">
                                    	<img src="<?php echo $obj_base_path->base_path(); ?>/files/event/gallery/medium/<?php echo $objfeatureimage->f('media_url');?>"  border="0"  />
                                    </div>
                                  </div>
