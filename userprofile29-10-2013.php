            ...
            <div class="Tchai_box1" style="width: 570px; margin: 18px auto; border-left: 0x solid #CCCCCC; float: left;">
              ...
              <input type="hidden" name="set_param" id="set_param" value="" />
                <table width="100%" align="center" border="0" cellpadding="4" cellspacing="4" style="border-collapse:separate;">
                  ...
                  <tr>
                    ...
                    <td>
                        <span style="margin-right:1px;"><a href="<?php echo $obj_base_path->base_path(); ?>/about/<?php echo $obj_page->f('page_link')?>" target="_blank" style="text-decoration:underline;"><?php echo Personal;?></a>&nbsp;&nbsp;<input type="radio" name="account_type" id="pincode1" checked="checked" value="0"  onclick="displayOther()" /></span> <?php echo OR_TXT;?>
                        <span style="margin-left:10px;"><a href="<?php echo $obj_base_path->base_path(); ?>/about/<?php echo $obj_page1->f('page_link')?>" target="_blank" style="text-decoration:underline;"><?php echo Professional;?></a>&nbsp;&nbsp;<input type="radio" name="account_type" id="pincode2" value="1" onclick="displayOther()"  /></span>                            
                    </td>
                  </tr>
                  <tr>
              ...
              <tr>
                ...
                <td>
                  ...
                  <input type="text" name="phone" id="phone" class="textbg_grey" value="<?php echo $obj->f('mobile')?>" style="width: 190px;" onblur="checkPhone()" />
