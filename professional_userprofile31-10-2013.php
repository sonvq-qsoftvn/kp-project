...
function checkReg()
{
	...
	if($('#us_phone').val() == '') msg +="<?php echo PL_ENTER." ".US_PHONE_NEXTEL;?>\n";
	if($('#nextel').val() == '') msg +="<?php echo PL_ENTER." ".NEXTEL;?>\n";
	if($('#country_id').val() == '') msg +="<?php echo PL_ENTER." ".COUNTRY;?>\n";
               ...
               <table width="100%" border="0" cellspacing="0" cellpadding="0">
                 <tr>
                   <td><table width="100%" align="left" border="0" cellpadding="0" cellspacing="0" class="prefer_pro1">
                      ...
                      <tr>
                        <td><?php echo US_PHONE_NEXTEL;?><span style="color:red;">*</span></td>
                      ...
                      <tr>
                        <td><?php echo NEXTEL;?><span style="color:red;">*</span></td>
                        <td>
