...
<table width="675" border="0" align="center" cellpadding="0" cellspacing="0" class="credit_box">
    ...
    <tr>
     ...
     <tr>
      ...
      <td style="text-align:left; font-weight:bold" colspan="2">$<?php echo number_format($_REQUEST['amount'],2); ?></td>
    	...
    	<tr>
		<td >First Name</td>
		<td style="float:left"><input name="firstname" type="text" class="textfield_reg1"  maxlength="32" value="<?php echo $_REQUEST['fname']; ?>"></td>
	</tr>
	<tr>
		<td >Last Name</td>
		<td style="float:left"><input name="lastname" type="text" class="textfield_reg1" maxlength="32" value="<?php echo $_REQUEST['lname']; ?>"></td>
	</tr>
   ...
   <!-- <tr>
    ...
    <tr>
      <td>Address</td>
      <td colspan="2"><span class="textfield_reg"><input type="text" class="textfield_reg1" name="address1" value="<?php echo $_REQUEST['address']; ?>"/></span></td>
    </tr>
    <?php /*?><tr>
      <td>Address 2</td>
    ...
    <tr>
      <td>City</td>
      <td colspan="2"><span class="textfield_reg"><input type="text" class="textfield_reg1" name="city" value="<?php echo $_REQUEST['city']; ?>"/></span></td>
    </tr>
    <tr>
      <td>State</td>
      <?php
      ...
      ?>
      <td colspan="2"><span class="textfield_reg"><input type="text" class="textfield_reg1" name="state" value="<?php echo $obj_province_name->f('state_name'); ?>" /></span></td>
    </tr>
    <tr>
      <td>Country</td>
      <th colspan="2" style="float:left; padding:8px 0 0 30px;">
	<select name="select2" class="textfield_reg1" style="width:200px; height:32px;">
	<?php 
	//list country
	...
	?>
		<option value="<?php echo $obj_countries->f('id'); ?>" <?php if($obj_countries->f('id') == $REQUEST['country_id'] ) echo $sel; else echo '' ;?> >
    ...
    <tr>
      <td>Zipcode</td>
      <td colspan="2"><span class="textfield_reg"><input type="text" class="textfield_reg1" name="zip"  value="<?php echo $_REQUEST['postal_code']; ?>" style="width:196px;"/></span></td>
    </tr>
