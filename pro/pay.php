...
<input type="hidden" name="cart_id" value="<?php echo $_REQUEST['cart_id']; ?>" />
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="credit_box">
   ...
   <!-- <tr>
    ...
    <tr>
      <td>&nbsp;</td>
      <td colspan="2"><input type="submit" name="Submit52" value="<?php if($_SESSION['langSessId']=='eng'){echo "Submit";}elseif($_SESSION['langSessId']=='spn'){ echo "Enviar";}?>" class="btn1_sudip" style="float:left;"/></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td colspan="2">&nbsp;</td>
