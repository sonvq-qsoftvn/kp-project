	...
	<div class="body_bg">
    	...
    	<div class="container">
        	<div class="left_panel bg" style="width:978px;">
                <div style="text-align: right;"><a href="<?php echo $obj_base_path->base_path(); ?>/payment/<?php echo $_REQUEST['event_id']; ?>"><input type="button" class="btn1_sudip" value="Cancel & Return to payment selection"></a></div> 
                  <div class="clear"></div>
                          <div class="clear"></div>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="credit_box">
   ...
   <!-- <tr>
    ...
    <tr>
      ...
      <td ><select name="cardmonth" class="selectbg12">
   ...
   <!-- <tr>
    ...
    <tr>
      <td>&nbsp;</td>
      <td colspan="2"><input type="submit" name="Submit52" value="Submit" class="btn1_sudip" style="float:left;"/></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td colspan="2">&nbsp;</td>
		...
		<div style="text-align: right;"><a href=""><input type="button" class="btn1_sudip" value="Cancel & Return to payment selection"></a></div>  
