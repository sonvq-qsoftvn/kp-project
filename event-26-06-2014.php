...
-->                <div class="clear"></div>
		...
		//echo "<br/>var=".$var;?>
	     ...
	     <?php if($_SESSION['langSessId']=='eng') { ?> 
	       <li style="border: 1px solid #CCCCCC; margin: 0 4px; width: 170px;" id="media_click"><a href='<?php echo $obj_base_path->base_path(); ?>/en/event/<?php echo htmlentities(stripslashes($objEvent->f('event_name_en')));?>/gallery/<?php echo $media_id;?>/<?php echo $media_name;?>' class="fancybox"><img src="<?php echo $obj_base_path->base_path(); ?>/files/event/gallery/thumb/<?php echo $obj_event_media->f('media_url'); ?>" alt="" width="190" height="143" /></a></li>
	       <?php } else {?>
	       <li style="border: 1px solid #CCCCCC; margin: 0 4px; width: 170px;" id="media_click"><a href='<?php echo $obj_base_path->base_path(); ?>/es/evento/<?php echo htmlentities(stripslashes($objEvent->f('event_name_sp')));?>/galeria/<?php echo $media_id;?>/<?php echo $media_name;?>' class="fancybox"><img src="<?php echo $obj_base_path->base_path(); ?>/files/event/gallery/thumb/<?php echo $obj_event_media->f('media_url'); ?>" alt="" width="190" height="143" /></a></li> <?php } ?>
	       <?php } // if not video
