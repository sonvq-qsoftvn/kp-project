...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="event_review">
    ...
    <tr>
      ...
      <td><strong>Total : <?php $obj_total->totalAmount($_SESSION['ses_admin_id'],$_SESSION['pay'],$_SESSION['unique'],$event_id); $obj_total->next_record(); echo $obj_total->f('Amt');?></strong></td>
