...
<p></p>
				...
				$_SESSION['for_pass_msg'] =  "We have sent a message with information about resetting your password to Email Address ".$email.". <br />Check the message and follow instructions to reset your password.";
			}
		}
		echo 1;
	}
