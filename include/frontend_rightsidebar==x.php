...
$objright_banner->all_ad_image();

//$num=$objright_banner->num_rows();
//echo $num;
//$num=$objright_banner->next_record();
//print_r($num);
//exit();
//$all_ad_image = $objright_banner->f('ad_id');
//$all_ad_image
//print_r($all_ad_image); exit;
...
<form action="http://kpasapp.us8.list-manage.com/subscribe/post?u=130e6654487fe713844d189db&amp;id=e429b6d314" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
	   ...
	   <div class="e-labe-wrapp"> <label for="mce-EMAIL"><?php if($_SESSION['langSessId']=="eng"){ echo "Send me your alerts & newsletters"; }elseif($_SESSION['langSessId']=="spn"){?>Envíeme su alertas y boletines<?php }?></label></div>
        ...
        <div class="signupbox" style=" background: #22456D; margin: 0 0 4px 0;">
            ...
            <div class="fieldbox" style=" padding: 10px; width: 240px; background: #bde6fa;">
                ...
                <div class="sign-wraap">
                    <h1 class="sign-text"><?php echo SIGN_IN_WITH?></h1>
                 </div>
                <div class="face-wrapper">
				 ...
				 <div class="or-text">
                  <h1 class="or"><?php echo ORSHOW?></h1>
                </div>    
                </div>
                <div class="clear"></div>
...
<div class="clear"></div>
        <div class="botadd">
        <a href="/event/694"><img src="<?php echo $obj_base_path->base_path(); ?>/files/event/medium/1403495012poster mango dorothy, leon, iron,espanta.jpg" width="275" height="auto" border="0" /></a>
        </br>
        </br>
        <a href="/event/726"><img src="<?php echo $obj_base_path->base_path(); ?>/files/event/medium/1403394243UGC-Congreso Diseno.JPG" width="275" height="auto" border="0" /></a>
        </div>
<!-- end -------------------------->
<div class="clear"></div>
 <div class="botadd">
...
while($rows= $objright_banner->next_record())
{
     ...
     //echo 'test'. $objright_banner->f('ad_image_name');
      
  ?>   
      <a href="#"><img src="<?php echo $obj_base_path->base_path(); ?>/files/event/advertisement/thumb/<?php echo $objright_banner->f('ad_image_name') ?>" border="0" /></a>
        </br>
        </br>
