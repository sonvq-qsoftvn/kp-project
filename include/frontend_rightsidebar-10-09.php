...
<link rel="stylesheet" type="text/css" href="<?php echo $obj_base_path->base_path(); ?>/include/fancybox/jquery.fancybox-1.3.4.css" media="screen" />
	...
	<div class="right_panel">
      <?php if($_SESSION['ses_admin_id']==""){?>
        <div class="signupbox" style=" background: #22456D;">
            ...
            <div class="fieldbox" style=" padding: 10px; width: 240px; background: #bde6fa;">
                ...
                <div style="color:red;font: normal 12px/20px Arial, Helvetica, sans-serif;">
                ...
                <div style="width: 120px; float: left; margin: 10px auto 0 3px;">
                    <h1 style="font: normal 22px/20px Arial, Helvetica, sans-serif; color: #000000; padding:0px; margin: 0;">Sign in with</h1>
                 </div>
                ...
                <div class="clear"></div>                            
                  <form method="post" action="" enctype="multipart/form-data" name="signin" id="signin" autocomplete = "off">
                    ...
                    <table width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td id="text_email" style="text-align: left; text-transform: none; font-size: 12px;">Email or Cell#</td>
                        <td width="23%"><input type="text" name="email_cell"  id="email_cell" class="textbg_grey" value="" style="width:124px; line-height: 20px; height: 18px;"/></td>
                      </tr>
                      <tr>
                        <td style="text-align: left;  text-transform: none; font-size: 12px;">Password<div><a href="<?php echo $obj_base_path->base_path(); ?>/forgot_password.php" style="text-decoration: underline; color:#0066CC;">forgot</a></div></td>
                        <td><input type="password" name="pass_signin" value="" id="pass_signin" style="width:134px; height: 16px; border-radius:5px;"/> </td>
                      </tr>
                      <tr>
                      <td colspan="2"><input type="submit" name="submit11" id="submit11" value="" class="event_signin" style="cursor:pointer;" /></td>
                      </tr>
                       <tr>
                       <td colspan="2" style="text-align: left; font-size: 12px;">Do not have a KPasapp account?<!--<div class="upcoming_btn"><a href="<?php echo $obj_base_path->base_path(); ?>/registration">
        <img src="<?php echo $obj_base_path->base_path(); ?>/images/create_imgbtn.png" border="0" style="margin: 0 auto; display: block;" /></a></div>
    </div>--></td>
                     </tr>
                     <tr>
                      <td colspan="2" style="text-align:right">
                        <a href="<?php echo $obj_base_path->base_path(); ?>/registration"><img src="<?php echo $obj_base_path->base_path(); ?>/images/sign_up_btn.png" border="0" /></a>
                        </td>
                      </tr>
                    </table>
                  </form>
		 ...
		 <?php } if($_SESSION['ses_admin_id']!=""){?>
             <div class="light_greybox">
                <div class="heading_bg" style="height:auto !important;">
                    <ul>
                        <li style="margin:0;">
                             <a href="<?php echo $obj_base_path->base_path(); ?>/userprofile" style="text-decoration:none;">
		...
		<div class="clear"></div>		
	   <?php //} //else { ?>
        <div class="signupbox" style="border: 1px solid #666; border-radius: 0px; background:none;">            
