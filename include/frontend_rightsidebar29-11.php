                  ...
                  <form method="post" action="" enctype="multipart/form-data" name="signin" id="signin" autocomplete="off">
                    ...
                    <table width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <td style="text-align: left; text-transform: none; font-size: 12px;">
                      	<div style="float:right; text-transform:none;"><input type="checkbox" name="remember_me" id="remember_me" value="1" /> <?php if($_SESSION['langSessId']=="eng"){ echo REMEMBER_ME; }elseif($_SESSION['langSessId']=="spn"){?>Recordarme<?php }?> </div>
                      </td>
