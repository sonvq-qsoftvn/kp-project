...
<div class="secondary_navigation_<?php echo $_SESSION['langSessId']?>" style="margin:0 auto;">
    ...
    ?>
        ...
        <ul>
         ...
         <li><a href="<?php  if($_SESSION['langSessId']=='eng') { echo $obj_base_path->base_path(); ?>/en/about-kpasapp/ <?php } else {echo $obj_base_path->base_path(); ?>/es/acerca-de-kpasapp/ <?php }?> "><?=ABOUT_KCPASA?></a></li>
            ...
            <li><img alt="secondary nav devider" src="<?php echo $obj_base_path->base_path(); ?>/images/secondary_nav_devider.gif" border="0" /></li>
    ...
    <div class="icon_link_box">
        <div class="icon_link">
            <ul>
                <li>
                    <a href="https://www.facebook.com/master.kpasapp" target="_blank">
                        <img alt="facebook share icon" src="<?php echo $obj_base_path->base_path(); ?>/images/icon_link1.png" border="0" width="26" height="30"/>
                    </a>
                </li>
                <li>
                    <img alt="secondary nav devider" src="<?php echo $obj_base_path->base_path(); ?>/images/icon_link_devider.gif" border="0"/>
                </li>
                <li>
                    <a href="https://twitter.com/KPasapp" target="_blank">
                        <img alt="twitter share icon" src="<?php echo $obj_base_path->base_path(); ?>/images/icon_link2.png" border="0"  width="26" height="30"/>
                    </a>
                </li>
                <li>
                    <img alt="secondary nav devider" src="<?php echo $obj_base_path->base_path(); ?>/images/icon_link_devider.gif" border="0"/>
                ...
                <li>
                    <a href="https://plus.google.com/u/0/b/104323031953314630567" target="_blank">
                        <img alt="google plus share icon" src="<?php echo $obj_base_path->base_path(); ?>/images/icon_link4.png" border="0"  width="26" height="30"/>
                    </a>
                </li>
                <li>
                    <img alt="secondary nav devider" src="<?php echo $obj_base_path->base_path(); ?>/images/icon_link_devider.gif" border="0"/>
                ...
                <li>
                    <a href="#">
                        <img alt="rss share icon" src="<?php echo $obj_base_path->base_path(); ?>/images/icon_link3.png" border="0"  width="26" height="30"/>
                    </a>
                </li>
            </ul>
        </div>
