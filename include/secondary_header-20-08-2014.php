...
<div class="secondary_navigation_<?php echo $_SESSION['langSessId']?>" style="margin:0 auto;">
    ...
    ?>
        ...
        <ul>
         ...
         <li><a href="<?php  if($_SESSION['langSessId']=='eng') { echo $obj_base_path->base_path(); ?>/en/about_kpasapp/ <?php } else {echo $obj_base_path->base_path(); ?>/es/acerca_de_kpasapp/ <?php }?> "><?=ABOUT_KCPASA?></a></li>
...
?>
		<form method="post" action="<?php echo $action;?>" name="frmlanguage" id="frmlanguage">
