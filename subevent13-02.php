...
function save(type){
	...
	window.open('<?php echo $obj_base_path->base_path()?>/payment/<?php echo $event_id;?>'); 
...
-->                          <!--<div id="map" style="width:323px; height:325px; font-family: arial; font-size: 12px; color: #313E61; text-align: center; background-color:#FFFFFF;"></div>-->    
			...
			<input type="hidden" name="is_multi" id="is_multi" value="<?php echo $objEvent->f('identical_function');?>" />
					...
					$count=1;
                              ...
                              <tr>
                                <td width="10%">
                                    <div class="dropdown25"><select name="ticket_num" id="ticket_num<?php echo $count;?>" onchange="addtocart(<?php echo $count;?>,<?php echo $obj_sub_ticket->f('price_mx');?>,<?php echo $obj_sub_ticket->f('price_us');?>,<?php echo $obj_sub_ticket->f('ticket_id');?>,<?php echo $event_id;?>,'<?php echo date("d-m-Y",strtotime($sub_event_date_new));?>','<?php echo date("d-m-Y",strtotime($sub_event_end_new));?>','<?php echo date('g:i A',strtotime($sub_event_time_new));?>','<?php echo date('g:i A',strtotime($sub_event_time_end_new));?>');">
