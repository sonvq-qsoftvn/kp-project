					...
					<div class="hot_event7">
					  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="event_review">
                        ...
                        <tr>
						  ...
						  ?></td>
                          <td><a href="<?php echo $obj_base_path->base_path()."/payment.php?act=del&tid=".$obj_ticket->f('cart_id'); ?>">Remove</a></td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
                          <td><strong>Total : <?php $obj_total->totalTicket($_SESSION['ses_admin_id']); $obj_total->next_record(); echo $obj_total->f('Total');?></strong></td>
