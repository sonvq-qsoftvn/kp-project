...
if($_SESSION['ses_admin_id']!="" && $_SESSION['lang_change']==1){
	...
	$(document).ready(function(){
		$('#languageId').val('<?php echo $obj_user_ck->f('language');?>');
		$('#frmlanguage').submit();
	});
	</script>
	<?php
     ...
     <div class="left_panel bg">
        ...
        <div class="party_base_box">
            ...
            <?php           
				...
				$objsubEventAll->SubEventAll($limit,$tags,$category,$evn_city,$evn_venue,$start_date,$end_date,$key_word,$county_val,$event_categories);
				...
				if($num>0)
				{
					...
					//echo $eachVal['sub_events_types']."||"."<br>";
				...
				<?php
					...
					{
						$row1[$k_sub]['multi_event_date'] = $event_date;
						$row1[$k_sub]['city'] = $obj_venue->f('city');
						$row1[$k_sub]['venue_name'] = $obj_venue->f('venue_name');
						$row1[$k_sub]['id'] = $eachVal['id'];
						...
						//echo $k_sub."===".$row1[$k_sub]['multi_event_date']."----".$row1[$k_sub-1]['multi_event_date']."== id =".$row1[$k_sub]['id']."-----" .$row1[$k_sub-1]['id']."<br>";
				
						if(($row1[$k_sub]['multi_event_date']!=$row1[$k_sub-1]['multi_event_date']) || ($row1[$k_sub]['id']!=$row1[$k_sub-1]['id']))
						{
						
							$date_sub = date('Y-m-d',strtotime($row1[$k_sub]['multi_event_date']. "+1 day"));
							$objsub_date->subevent_datewise($eachVal['id'],$row1[$k_sub]['multi_event_date'],$date_sub);
