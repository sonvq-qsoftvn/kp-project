...
class EasyGoogleMap {
	 ...
	 * @return: void
	 */
	function SetMapWidth($width=600) {
	 ...
	 */
	function GmapsKey() {
		return "<script type=\"text/javascript\" src=\"http://maps.google.com/maps?file=api&v=2&key={$this->mMapKey}\">/*** EasyGoogleMap Class by: Mitchelle Pascual ***/</script>\n";	
	} # end function
