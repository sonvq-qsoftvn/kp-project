...
function event_details_byID($event_id){
	...
	$sql='SELECT V.*,E.event_id as e_id, E.`event_name_en`, E.`event_name_sp`, E.`event_start_date_time`, E.`event_start_ampm`, E.`event_end_date_time`, E.`event_end_ampm`, S.state_name as st_name,C.city_name as city FROM '.$this->prefix().'general_events E Left join '.$this->prefix().'venue V ON (E.event_venue = V.venue_id ) Left join '.$this->prefix().'state S on (S.id = E.event_venue_state)  Left join '.$this->prefix().'city C on (C.id = E.event_venue_city) WHERE E.event_id="'.$event_id.'" AND E.event_status="Y" ';
	//echo $sql;
	return $this->query($sql);	
}
...
function insert_ad_contain_es($result_last_ad_id, $ad_title_es,$ad_contain_es,$ad_text_es,$lenguage_id_es,$ad_url_es,$image_name_es)
	{
		$sql="INSERT INTO ".$this->prefix()."ad_content set ad_id='".$result_last_ad_id."',ad_image_name='".$image_name_es."',ad_alternate_text='".$ad_contain_es."', language_id='".$lenguage_id_es."',ad_title='".$ad_title_es."',ad_text='".$ad_text_es."',link_url='".$ad_url_es."'";
		//echo $sql;
		$rs=$this->query($sql);
		return mysql_insert_id();
	}
...
function insert_ad_contain_en($result_last_ad_id, $ad_title_en,$ad_contain_en,$ad_text_en,$lenguage_id_en,$ad_url_en,$image_name_en)
	{
		$sql="INSERT INTO ".$this->prefix()."ad_content set ad_id='".$result_last_ad_id."',ad_image_name='".$image_name_en."',ad_alternate_text='".$ad_contain_en."', language_id='".$lenguage_id_en."',ad_title='".$ad_title_en."',ad_text='".$ad_text_en."',link_url='".$ad_url_en."'";
		//echo $sql;
		$rs=$this->query($sql);
		return mysql_insert_id();
	}
