...
function edit_admin_details($fname,$lname,$email,$province,$city,$account_type,$admin_id,$county,$country_id,$country_code,$language,$address,$postal_code)
{
	$sql="UPDATE ".$this->prefix()."admin SET fname = '".$fname."',lname = '".$lname."',email = '".$email."',province = '".$province."',city = '".$city."',language = '".$language."',account_type = '".$account_type."',county = '".$county."',country_id = '".$country_id."',address = '".addslashes($address)."',postal_code = '".$postal_code."',country_code = '".$country_code."' where admin_id = '".$admin_id."'";
	//echo $sql;exit;
	$this->query($sql);
}
