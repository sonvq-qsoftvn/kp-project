...
function send_confrimation($email,$fname){
...
<tbody><tr>
	<td valign="top" align="center">
		...
		<table width="550" cellspacing="0" cellpadding="20" bgcolor="#FFFFFF">
			<tbody><tr>
				<td valign="top" bgcolor="#FFFFFF" style="font-size:12px;color:#444444;line-height:150%;font-family:trebuchet ms;border-left:1px solid #e0e0e0;border-right:1px solid #e0e0e0;border-bottom:1px solid #e0e0e0"><p dir="ltr"><strong id="docs-internal-guid-5dddb8f4-3078-c5de-a01a-95d21091b1ea">Dear '.$fname.',</strong></p>
				  <p style="font-size:12px;color:#444444;line-height:150%;font-family:trebuchet ms"><strong id="docs-internal-guid-5dddb8f4-3079-639a-60df-ebc5922ff6e5">You added a new email address to your KPasapp account. Please verify this email address to confirm it belongs to you by clicking on the link </strong></p>
					  ...
					  <table>
					    <tr>
					      <td><p dir="ltr"><strong id="docs-internal-guid-5dddb8f4-3079-9d88-499c-ae80ffeba552">
						  	<a target="_blank" href="'.$this->base_path().'/confirm_email"  style="font-weight:bold;">Confirm My Email Address </a></strong></p>
						 </td>
				        </tr>
				      </table>
				  </div>
					<p dir="ltr"><strong id="docs-internal-guid-5dddb8f4-307a-34a0-5c37-db21e11d2783">Once you confirm it, you can use this email address for your KPasapp operations such as reservations and notifications. You can also make it your primary address for all your KPasapp business.</strong></p>
					
                    <p dir="ltr"><strong id="docs-internal-guid-5dddb8f4-307a-34a0-5c37-db21e11d2783">If you didnot add this email,<a href="https://www.kpasapp.com/fraudalert"> let us know right away</a> for your own security. Its important because it helps us make sure no one is getting into your account without your knowledge.</strong></p>
                    <p dir="ltr"><strong id="docs-internal-guid-5dddb8f4-307a-34a0-5c37-db21e11d2783">Sincerely,</strong></p>
                    <br>
                    <p dir="ltr"><strong id="docs-internal-guid-5dddb8f4-307a-34a0-5c37-db21e11d2783">The KPasapp Team</strong></p>
                  <p dir="ltr"><strong id="docs-internal-guid-5dddb8f4-307a-34a0-5c37-db21e11d2783">Do not reply to this email.</strong></p>
...
{
	$sql="UPDATE ".$this->prefix()."admin_additional_email SET email_address = '".$altername_email."' WHERE admin_id= '".$admin_id."'";
	$this->query($sql);
}		
