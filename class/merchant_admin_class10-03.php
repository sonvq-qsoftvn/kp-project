...
class merchant_admin extends DB_Sql 
{
	...
	//==============================  Manage page ======================
		...
		function edit_page($page_name,$title_sp,$page_content,$page_content_sp,$page_id,$page_link)
			{
				$sql = "update ".$this->prefix()."page set page_name='".$page_name."',title_sp='".$title_sp."',page_content='".$page_content."',page_content_sp='".$page_content_sp."',page_link='".$page_link."' where page_id=".$page_id;
				/*echo $sql;
				exit;*/
	 			$this->query($sql);
			}
		function add_page($page_name,$title_sp,$page_content,$page_content_sp,$page_link)
			{
				$sql = "INSERT INTO ".$this->prefix()."page set page_name='".$page_name."',title_sp='".$title_sp."',page_content='".$page_content."',page_content_sp='".$page_content_sp."',page_link='".$page_link."' ";
				//exit;
	 			$this->query($sql);
			}	
