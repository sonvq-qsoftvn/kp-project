...
function add_order_TNS($item_name,$item_number,$payment_status,$payment_amount,$payment_currency,$txn_id,$receiver_email,$payer_email,$event_id,$ticket,$payment,$ticket_id,$multi_id,$user_id,$order_no,$cart_id) {
	  $sql="INSERT ".$this->prefix()."transaction SET 
			item_name='".$item_name."',
			item_number='".$item_number."',
			payment_status='".$payment_status."',
