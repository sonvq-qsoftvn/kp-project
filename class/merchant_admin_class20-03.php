...
//==================================== End ============================================
	...
	function get_event($cur,$upto){
		...
		$sql="SELECT * FROM ".$this->prefix()."general_events as E join ".$this->prefix()."city as C on E.event_venue_city = C.id   WHERE E.event_start_date_time >= '".$cur."' and E.event_start_date_time <= '".$upto."' order by E.event_start_date_time asc";
		//echo $sql;
		return $this->query($sql);
	}
