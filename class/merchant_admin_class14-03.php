...
class merchant_admin extends DB_Sql 
{
	...
	//==============================  Manage page ======================
		...
		function edit_page($page_name,$title_sp,$page_content,$page_content_sp,$page_id,$page_link,$social,$path,$file_name)
			{
				$sql = "update ".$this->prefix()."page set page_name='".$page_name."',title_sp='".$title_sp."',page_content='".$page_content."',page_content_sp='".$page_content_sp."',page_link='".$page_link."',path='".$path."',social='".$social."',photo='".$file_name."' where page_id=".$page_id;
				/*echo $sql;
				exit;*/
	 			$this->query($sql);
			}
		function add_page($page_name,$title_sp,$page_content,$page_content_sp,$page_link,$social,$path,$file_name)
			{
				$sql = "INSERT INTO ".$this->prefix()."page set page_name='".$page_name."',title_sp='".$title_sp."',page_content='".$page_content."',page_content_sp='".$page_content_sp."',page_link='".$page_link."',path='".$path."',social='".$social."',photo='".$file_name."' ";
				//exit;
	 			$this->query($sql);
			}	
