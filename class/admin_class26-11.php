...
{
	$sql = "select * from ".$this->prefix()."admin A join ".$this->prefix()."city C ON A.city=C.id join ".$this->prefix()."county B ON A.county=B.id join ".$this->prefix()."countries D ON A.country_id=D.id WHERE admin_id=".$admin_id;
	$this->query($sql);
