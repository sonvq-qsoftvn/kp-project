...
function event_details_byID($event_id){
	...
	$sql='SELECT V.*,E.event_id as e_id, E.`event_name_en`, E.`event_name_sp`, E.`event_start_date_time`, E.`event_start_ampm`, E.`event_end_date_time`, E.`event_end_ampm`, S.state_name as st_name,C.city_name as city FROM '.$this->prefix().'general_events E Inner join '.$this->prefix().'venue V ON (E.event_venue = V.venue_id ) Inner join '.$this->prefix().'state S on (S.id = E.event_venue_state)  Inner join '.$this->prefix().'city C on (C.id = E.event_venue_city) WHERE E.event_id="'.$event_id.'" AND E.event_status="Y" ';
	//echo $sql;
	return $this->query($sql);	
}
...
/*-------------------------------Promotion  Section--------------------------------------------*/
function add_social($social_url,$social_type,$social_lang)
	{
		$sql="INSERT INTO ".$this->prefix()."social set social_url='".$social_url."',social_type='".$social_type."',social_lang='".$social_lang."'";
		echo $sql;
		$rs=$this->query($sql);
		return mysql_insert_id();
	}
...
//function allPromotionByEventID($event_id,$limit){
//
//	$sql="SELECT *,S.social_id as sc_id FROM ".$this->prefix()."social S Left join ".$this->prefix()."event_social ES ON (S.social_id = ES.social_id ) Left join ".$this->prefix()."social_by_admin SA on (SA.social_id = S.social_id)  WHERE ES.event_id=".$event_id." Order By S.social_id DESC $limit";
//	echo $sql;
//	return $this->query($sql);
//}
//
//function allPromotionByEventIDCount($event_id){
//
//	$sql="SELECT *,S.social_id as sc_id FROM ".$this->prefix()."social S Left join ".$this->prefix()."event_social ES ON (S.social_id = ES.social_id ) Left join ".$this->prefix()."social_by_admin SA on (SA.social_id = S.social_id)  WHERE ES.event_id=".$event_id." Order By S.social_id DESC";
//	echo $sql;
//	return $this->query($sql);
//}
...
//function allSocialNotInEvent($event_id,$admin_id){
//
//  $sql="SELECT *,S.social_id as sc_id FROM ".$this->prefix()."social S, ".$this->prefix()."social_by_admin as SA  WHERE SA.social_id=S.social_id and S.social_id NOT IN (SELECT social_id FROM ".$this->prefix()."event_social WHERE event_id ='".$event_id."') AND SA.admin_id='".$admin_id."'  order by S.social_id DESC";
//	//echo $sql;
//	return $this->query($sql);
//}
...
function update_social($social_id,$social_url,$social_type,$social_lang)
{
    $sql="update ".$this->prefix()."social  set social_url='".$social_url."',social_type='".$social_type."',social_lang='".$social_lang."' WHERE social_id=".$social_id;
    echo $sql;
    $rs=$this->query($sql);
...
function insert_ad($ad_size,$ad_position, $from_date,$duration)
	{
		$sql="INSERT INTO ".$this->prefix()."ad set ad_size='".$ad_size."',position_id='".$ad_position."',From_date='".$from_date."', duration='".$duration."'";
		//echo $sql;
		$rs=$this->query($sql);
		return mysql_insert_id();
	}

function insert_ad_contain_es($result_last_ad_id, $ad_title_es,$ad_contain_es,$ad_text_es,$lenguage_id_es,$image_name_es)
	{
		$sql="INSERT INTO ".$this->prefix()."ad set ad_id='".$result_last_ad_id."',ad_image_name='".$image_name_es."',ad_content='".$ad_contain_es."', language_id='".$lenguage_id_es."',ad_title='".$ad_title_es."',ad_text='".$ad_text_es."'";
		//echo $sql;
		$rs=$this->query($sql);
		return mysql_insert_id();
	}
	...
	function insert_ad_contain_en($result_last_ad_id, $ad_title_en,$ad_contain_esn,$ad_text_en,$lenguage_id_en,$image_name_en)
	{
		$sql="INSERT INTO ".$this->prefix()."ad set ad_id='".$result_last_ad_id."',ad_image_name='".$image_name_en."',ad_content='".$ad_contain_en."', language_id='".$lenguage_id_en."',ad_title='".$ad_title_en."',ad_text='".$ad_text_en."'";
		//echo $sql;
		$rs=$this->query($sql);
		return mysql_insert_id();
	}
