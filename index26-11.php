					...
					?>
						<div class="party_details_box">
							<div class="box1">
								...
								<p class="sub"><a style="color:#056A86" href="<?php echo $obj_base_path->base_path(); ?>/venue/<?php echo $obj_venue->f('venue_id');?>"><strong><?php if($_SESSION['langSessId']=='eng') { echo substr($obj_venue->f('venue_name'),0,30); } else { echo substr($obj_venue->f('venue_name_sp'),0,30); };?></strong></a></p>
