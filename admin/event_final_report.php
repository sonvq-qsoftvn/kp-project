	...
	if($report_check_arr!="")  //check transaction
	...
	else
	 {
		$msg = "No event has been selected for report.";
                $_SESSION['msg'] = $msg;
                header("location:".$obj_base_path->base_path()."/admin/event-final-report/");
		exit();
	 }
...
<title>Kcpasa - Event Final Report</title>
		   ...
		   <div id="body">
			<div class="body2"> 
			   ...
			   <div class="blue_box1">
				...
				<div class="blue_boxr">
				<ul>
				<li><a href="<?php echo $obj_base_path->base_path()."/admin/event-final-report/"?>" class="here">Final Report</a></li>
