...
<?php include("admin_header.php"); ?>
  <div id="maindiv">
	...
	<!----------------------------------------->
		...
		<table width="100%" border=0 align="center" cellpadding="0" cellspacing="0" class="abck-form add-ads-table">
...
<!--		<tr>
		...
		<td width="87%">
         ...
         <option value="">--Please Select client--</option>
          ...
          <?php while($row = $obj_ads_client->next_record())
            ...
            <option value="<?php echo  $obj_ads_client->f('client_id'); ?>"><?php echo  $obj_ads_client->f('business_name'); ?> </option>
		...
		<td width="87%">
		    ...
		    <input type="text" name="from_date" id="event_date_st" value="" />
		...
		<td width="87%">
                    <input type="text" name="ad_title_es" id="ad_title_es"  value="" onkeyup="limiter()" /><span><script type="text/javascript">
		...
		<td width="87%">
		<textarea name="ad_text_es" id="ad_text_es" rows="4" cols="50" onkeyup="limiter_text();"><?php echo $objmedia_es->f('alternative_text')?></textarea>
                <span>   
               <script type="text/javascript">
		...
		<textarea name="ad_contain_es" id="ad_contain_es" rows="4" cols="50"></textarea>
		...
		<td width="87%">
		<input type="text" name="ad_url_es" id="ad_url_es"  value="" />
		</td>
		</tr>
		...
		<td width="87%">
                    ...
                    <input type="text" name="call_to_action_es" id="call_to_action_es" value="" onkeyup="limiter_call_to_action_es()"/>
 ...
 <!-------------------For English  image upload----------------------------->
		...
		<tr>
                ...
                <div class="event_ticket"">
		<!--<h1>Set gallery image <img src="<?php //echo $obj_base_path->base_path(); ?>/images/question_mark.gif" alt="" width="31" height="28" border="0"/></h1>-->
		<p id="upload_file_hide_en">Upload Files</p>
		<ul style="margin-left: 10px;">
		<li><a href="#" class="here"> 
		...
		<td width="13%" style="font: normal 12px/18px Arial, Helvetica, sans-serif; padding: 0;">Ad Title ::</td>
		<td width="87%">
                    <input type="text" name="ad_title_en" id="ad_title_en"  value="" onkeyup="limiter1()" />
		...
		<td width="13%" style="font: normal 12px/18px Arial, Helvetica, sans-serif; padding: 0;">Ad Text ::</td>
		<td width="87%">
		<textarea name="ad_text_en" id="ad_text_en" rows="4" cols="50" onkeyup="limiter_text1();"><?php echo $objmedia_es->f('alternative_text')?></textarea>
		...
		<textarea name="ad_contain_en" id="ad_contain_en" rows="4" cols="50"></textarea>
		...
		<td width="13%" style="font: normal 12px/18px Arial, Helvetica, sans-serif; padding: 0;">Ad Url ::</td>
		<td width="87%">
		<input type="text" name="ad_url_en" id="ad_url_en"  value="" />
		</td>
		</tr>
   ...
   <tr>
		...
		<td width="87%">
		    ...
		    <input type="text" name="call_to_action_en" id="call_to_action_en" value="" onkeyup="limiter_call_to_action_en()"/>
