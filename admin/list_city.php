          ...
          <div class="clear"></div>
           ...
           <?php
			...
			?>
				<div class="blue_boxr">
				  <ul>
				   <li><a href="<?php echo $obj_base_path->base_path(); ?>/admin/add_city">Create/Edit City</a></li>
				   <li><a href="<?php echo $obj_base_path->base_path(); ?>/admin/list_city" <?php if($path_parts['filename']=="list_city") {?> class="here" <?php } ?>>List City</a></li>
        ...
        <div class="table_wrapper">
            ...
            <table cellpadding="0" cellspacing="0" width="100%" border="0"  class="id_detail2">               
                ...
                <?php
                    ...
                    {
                ?>
                <td width="8%" colspan="7" style="font: bold 13px/30px Arial, Helvetica, sans-serif; text-align:center; padding: 2px 0; color:#000; background: #ccc;">Successfully added</td>
                <?php
                    }
                ?>
            </tr>
                ...
                <tr>
                    ...
                    <th  class="top_txt">State</th>
                    <th  class="top_txt">County</th>
                    <th  class="top_txt">City Name SP</th>
                    <th  class="top_txt">City Name SP</th>
                ...
                <?php
					...
					$objlist->cityDtlslist($limit);
					$objlist_num->cityDtlslist_num();
					...
					?>
					<tr>         
					<td width="5%" style="padding: 0 10px;"><?php echo $cnt;;?></td>
					<td width="19%"><?php echo $objlist->f('state_name');?></td>
					<td width="17%"><?php echo $objlist->f('county_name');?></td>
					<td width="16%"><?php echo $objlist->f('city_name');?></td>
					<td width="16%"><?php echo $objlist->f('city_name_sp');?></td>
					...
					<?php $cnt++; } if($num>25){?>
					<tr><td colspan="6" align="left"><div style="width: 150px; float:right; margin: 0 auto;"><?php $p->show();?></div></td></tr>
					<?php
					}
					}
					else
