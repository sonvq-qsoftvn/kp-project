...
if(isset($_REQUEST['submit'])) /*save for media image*/
	{
		...
		//echo $sc_id."<==>".$social_url."<==>".$social_name."<==>".$social_type."<==>".$urlstr;
		
		$obj_social_update->update_social($sc_id,$social_url,$social_name,$social_type,$urlstr);
...
<title>Kcpasa - Edit promotion</title>
    ...
    <div class="myevent_box"> 
        <div class="table_wrapper">
		   ...
		   <form name="frm" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>"  enctype="multipart/form-data">
			...
			<td width="87%">
			<input type="text" name="social_name" id="social_name" size="40"  value="<?php echo $objsociallist->f('social_name');?>"/>
			</td>
			</tr>                                                   
			<tr>
