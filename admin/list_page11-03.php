        ...
        <div class="table_wrapper">
            ...
            <tr>
                ...
                <?php
					...
					?>
					<tr>         
					<td width="8%" style="padding: 0 10px;"><?php echo $objlist->f('page_id');?></td>
					<td width="24%"><?php echo $objlist->f('page_name');?></td>
					
					<td width="11%"><img src="<?php echo $obj_base_path->base_path(); ?>/images/edit.gif" alt="" width="20" height="16" /><a href="<?php echo $obj_base_path->base_path(); ?>/admin/edit_page/<?php echo $objlist->f('page_id');?>">Edit</a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="<?php echo $obj_base_path->base_path(); ?>/<?php echo $objlist->f('path');?>/<?php echo $objlist->f('page_link');?>" target="_blank">Preview</a>
					</td>
