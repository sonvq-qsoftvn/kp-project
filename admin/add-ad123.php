...
action: '<?php echo $obj_base_path->base_path(); ?>/admin/uploadAdphoto.php?ad_size='+ad_size,
name: 'uploadfile',
...
var files=$('#files');
new AjaxUpload(btnUpload, {
action: '<?php echo $obj_base_path->base_path(); ?>/admin/uploadAdphoto.php?ad_size='+$('#ad_size').val(),
name: 'uploadfile',
onSubmit: function(file, ext){
