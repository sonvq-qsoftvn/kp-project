...
<div id="maindiv">
	...
	<a class="fancybox_test fancybox.iframe" href="https://www.youtube.com/watch?v=opj24KnzrWo">Preview</a>
	<script>
     ...
     <div class="container">
		...
		<!--start body-->
		   <div id="body">
			...
			?>
			<span class="add_media"><a href="<?php echo $obj_base_path->base_path(); ?>/admin/add-gallery/event/<?php echo $event_id?>" <?php if($page_set=="add-gallery") {?> class="here" <?php } ?>>Add media</a></span></div>
	...
	<img src="<?php echo $obj_base_path->base_path(); ?>/files/event/gallery/thumb/<?php echo $objgallerylist->f('media_url'); ?>" alt="" width="150" height="90" />
	<?php }
	else{?>
	<?php  if($var=="youtube") { ?>
...
-->	   
	...
	<span style="margin:0;"><?php if($objgallerylist->f('admin_id')==$_SESSION['ses_user_id']){?><a href="<?php echo $obj_base_path->base_path(); ?>/admin/edit-gallery/<?php echo $objgallerylist->f('m_id');?>"><img src="<?php echo $obj_base_path->base_path(); ?>/images/edit.gif" alt="" width="20" height="16" /></a><?php }?></span>
	...
	<a href="#feature_image<?php echo $j;?>" id="feature<?php echo $j;?>">Preview</a>
       ...
       <a href="#feature_url<?php echo $j;?>" id="feature<?php echo $j;?>">Preview</a>
		...
		<div style="width:auto;height:auto; background:#FFF; padding:10px;" id="feature_image<?php echo $j;?>">
                <img src="<?php echo $obj_base_path->base_path(); ?>/files/event/gallery/large/<?php echo $objgallerylist->f('media_url');?>"  border="0"  />   
                                    </div>
	    </div>
