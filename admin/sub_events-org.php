...
<?php include("admin_header.php"); ?>
  <div id="maindiv">
	...
	<input type="hidden" name="event_id" id="event_id" value="<?php echo $obj_parent->f('event_id');?>" />
     ...
     <input type="text" name="close" id="close" value="0"   />
...
?>
	<tr>
		...
		<td width="10%"><a href="javascript:void(0);" onclick="EditSubEvent('<?php echo $objlist->f('event_id')?>','<?php echo $obj_parent->f('event_id');?>');"><img src="<?php echo $obj_base_path->base_path(); ?>/images/edit.gif" alt="" width="20" height="16" /></a></td>
    ...
    <tr>
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><input type="text" name="event_day_st" id="event_date_st" value="<?php if($event_day_st!=""){echo $event_day_st;}else{echo 00;}?>"  class="textbg_grey"  style="width: 30px;" /></td>
          <td>/</td>
          <td><input type="text" name="event_month_st" id="event_month_st" value="<?php if($event_month_st!=""){echo $event_month_st;}else{echo 00;}?>" class="textbg_grey"  style="width: 30px;" /></td>
          <td>/</td>
          <td><input type="text" name="event_year_st" id="event_year_st"  value="<?php if($event_year_st!=""){echo $event_year_st;}else{echo 0000;}?>" class="textbg_grey"  style="width: 40px;" /></td>
          <td></td>
        </tr>
        <tr>
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin: 20px 0 0 0;">
        <tr>
          <td><input type="text" name="event_day_end" id="event_date_end" value="<?php if($event_day_end!=""){echo $event_day_end;}else{echo 00;}?>" class="textbg_grey" style="width: 30px;"/></td>
          <td>/</td>
          <td><input type="text" name="event_month_end" id="event_month_end" value="<?php if($event_month_end!=""){echo $event_month_end;}else{echo 00;}?>"  class="textbg_grey" style="width: 30px;"/></td>
          <td>/</td>
          <td><input type="text" name="event_year_end" id="event_year_end" value="<?php if($event_year_end!=""){echo $event_year_end;}else{echo 0000;}?>"  class="textbg_grey" style="width: 40px;"/></td>
        </tr>
        <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
     <tr>
      ...
      <td width="22%">
		  ...
		  <select name="venue_city" class="selectbg12" onchange="saveAutoEvent();">
   ...
   <?php /*?> <textarea name="page_content_sp" cols="35" rows="10"><?php if($msg!="" && $page_content_sp!=""){echo $page_content_sp;}?></textarea><?php */?>
	...
	<ul style="margin-left: 10px;">
        <li><a href="#" class="here"> <?php if(!$_POST['event_photo']){ ?>
    ...
    <div>
     <ul>
		...
		<li><input name="radio_access" type="radio" value="2" onclick="showticketingsection(); saveAutoEvent();"/><strong>Access to this sub-event is included in atleast one of the master events tickets</strong></li>
	...
	<div class="event_ticket" style="background: none; width: 702px; border: 0; margin: 0 auto 0 10px;">
	 ...
	 <div class="event_ticketr" style="margin: 0 auto 0 11px; width: auto; padding-right: 15px;">
        <h1>
            <input type="submit" name="publish" value="Save And Create New Sub-Event" onclick="return complete();" class="event_save" style="padding:0px; height: auto;" /><br />
			<input type="button" name="publish" value="Save And Duplicate Sub-Event" onclick="return complete1();" class="event_save" style="padding:0px; height: auto;" /><br />
			...
			<input type="button" name="publish" value="Discard And Exit" onclick="return complete();" class="event_save" style="padding:0px; height: auto;" /><br />
    ...
    <div class="myevent_right">
        ...
        <h1>
            <input type="button" name="publish" value="Save And Create New Sub-Event" onclick="return complete();" class="event_save" style="padding:0px; height: auto;" /><br />
            <input type="button" name="publish" value="Save And Duplicate Sub-Event" onclick="return complete1();" class="event_save" style="padding:0px; height: auto;" /><br />
            <input type="button" name="publish" value="Save And Exit" onclick="return save_exit();" class="event_save" style="padding:0px; height: auto;cursor:pointer;" /><br />
            <input type="button" name="publish" value="Discard And Exit" onclick="return complete();" class="event_save" style="padding:0px; height: auto;" /><br />
        </h1>
	  	<div class="clear"></div>
         <!--<div class="selectbgpublish">
           <select name="select" style="width: 219px;">
