...
//creation of objects
	...
	if(isset($_REQUEST['submit1']))
	{
		...
		if($_POST['page_link']!='') {
            ...
            $page_link = preg_replace("%[^-/+|\w ]%", '', $_POST['title']);
		...
		//window.location="<?php echo $obj_base_path->base_path();?>/admin/sitemap.php?from=blog_create";
    ...
    <table width="80%" border=0 align="center" cellpadding="0" cellspacing="0">
      ...
      <input type="hidden" name="page_id" value="<?php echo $page_id  ?>">
        <tr>
				...
				<input type="radio" name="path" id="path" value="terms_condition" > terms & condition<br>
				<input type="radio" name="path" id="path" value="contact_us" > Contact Us<br>
				<input type="radio" name="path" id="path" value="other" > other<br>
				</td>
	</tr>
