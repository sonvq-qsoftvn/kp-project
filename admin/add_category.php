...
include('../include/admin_inc.php');
	...
	if(isset($_POST['addcat']) && $_POST['addcat'] == '1')	
	{
		...
		$obj_add->addEventCategory($parent_id,$category_name,$category_name_sp,$category_rank);
    ...
    <!--start body-->
      <div id="body">
        <div class="body2"> 
          <div class="clear"></div>
           <div class="blue_box1">
           <div class="blue_box10"><p>Add Category</p></div>
												  ...
												  <div class="table_wrapper_inner">														
													...
													<tr>
                                                      ...
                                                      <tr>
                                                        <th colspan="2">
														Parent Category<br/>
														<span class="event_fieldbg20"><select name="pcat" id="pcat" class="selectbg20">
														<option value="">Select</option>
														<?php 
														$obj_category->categorylist();
														while($obj_category->next_record()){
														?>
														<option value="<?php echo $obj_category->f('category_id'); ?>"><?php echo stripslashes($obj_category->f('category_name')); ?></option>
														<?php } ?>
														  </select></span>
                                                          </th>
                                                      </tr>
                                                      <tr>
  <th width="16%"><span style="background: #FFFFFF; color: #FF0000; border: 1px solid #CCCCCC; margin: 8px 10px 0 0; padding:2px; font: bold 20px/20px Arial, Helvetica, sans-serif; display: inline-block;">SP</span><br/><span class="event_fieldbg20"><input type="text" name="catname" id="catname" value="Category Name" class="event_field" style="height: 25px; margin: 5px 0; width: 290px;"/></span></th>
                                                      </tr>
                                                      <tr>                                                      
                                                        <th>
														<span style="background: #FFFFFF; color: #FF0000; border: 1px solid #CCCCCC; margin: 8px 10px 0 0; padding:2px; font: bold 20px/20px Arial, Helvetica, sans-serif; display: inline-block;">EN</span><br/><span class="event_fieldbg20"><input type="text" name="catname" id="catname" value="Category Name" class="event_field" style="height: 25px; margin: 5px 0; width: 290px;"/></span>														</th>
                                                      </tr>
                                                      <tr>
                                                        <th colspan="2">Rank<br/><span class="event_fieldbg20"><input type="text" name="rank" id="rank" value="1" class="event_field" style="height: 25px; margin: 5px 0; width: 290px;"/></span></th>
                                                      </tr>
                                                      <tr>                                                        
