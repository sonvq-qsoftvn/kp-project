...
if(isset($_REQUEST['action']) && $_REQUEST['action'] == "delete")	
{
	...
	header("Location:".$obj_base_path->base_path()."/admin/list_profession_user");
	exit;
}
...
function del(eID,emailId)
{
	...
	{
		location.href="<?php echo $obj_base_path->base_path(); ?>/admin/list_profession_user/delete/"+eID+"/"+emailId;
	}
...
<span style="margin:0;"><a href="javascript:void(0);" onClick="del('<?php echo $objlist->f('admin_id');?>','<?php echo $objlist->f('email');?>');"><img src="<?php echo $obj_base_path->base_path(); ?>/images/cross.gif" alt="" width="20" height="16" /></a></span>
					...
					<?php $cnt++; } if($num>25){?>
					<tr><td colspan="8" align="left"><div style="width: 150px; float:right; margin:-14px 74px 10px 0;"><?php $p->show();?></div></td></tr>
					<?php
					}
					}
					else
