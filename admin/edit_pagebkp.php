	...
	if(isset($_REQUEST['submit1']))
		{
			...
			if($page_id){
			// -- Edit Content --		
			$objedit->edit_page($page_name,$title_sp,$page_content,$page_content_sp,$page_id,$page_link);
			}
			else{
  ...
  <div id="maindiv">
    ...
    <div class="sct_right">
			...
			<div class="TabbedPanelsContent2">
                ...
                <td><input type="text" name="page_link" class="event_field8" style="height: 24px;"  value="<?php echo $objlist->f('page_link')  ?>"></td></tr>
