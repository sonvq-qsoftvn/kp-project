...
$(document).ready(function(){
	...
	if ($("#add_short_by" ).val()!="") {
		...
		?>
	       //var  url = "<?php echo $obj_base_path->base_path();?>/admin/ad_list.php?add_size=<?php echo $_REQUEST['add_size']?>&short_by="+short_by_val+"&add_then_by=<?php echo $_REQUEST['add_then_by']?>"+"&page=<?php echo $_REQUEST['page']?>";
		...
		?>
		//var  url = "<?php echo $obj_base_path->base_path();?>/admin/ad_list.php?add_size=<?php echo $_REQUEST['add_size']?>&short_by="+short_by_val+"&add_then_by=<?php echo $_REQUEST['add_then_by']?>";	
    ...
    $( "#add_then_by" ).change(function() {
		...
		<?php
			if(isset($_REQUEST['page']) and is_numeric($_REQUEST['page'])){
		?>
			//var  url = "<?php echo $obj_base_path->base_path();?>/admin/ad_list.php?short_by=<?php echo $_REQUEST['short_by']?>&add_then_by="+add_then_by+"&page=<?php echo $_REQUEST['page']?>";	
                        
                        var  url = "<?php echo $obj_base_path->base_path();?>/admin/ad_list.php?add_size=<?php echo $_REQUEST['add_size']?>&position_id=<?php echo $_REQUEST['position_id']?>&short_by=<?php echo $_REQUEST['add_short_by']?>&add_then_by="+add_then_by+"&client_id=<?php echo $_REQUEST['client_id']?>&page=<?php echo $_REQUEST['page']?>";
	       
		<?php
			}
			else{
		?>
			//var  url = "<?php echo $obj_base_path->base_path();?>/admin/ad_list.php?short_by=<?php echo $_REQUEST['short_by']?>&add_then_by="+add_then_by;
                         var  url = "<?php echo $obj_base_path->base_path();?>/admin/ad_list.php?add_size=<?php echo $_REQUEST['add_size']?>&position_id=<?php echo $_REQUEST['position_id']?>&short_by=<?php echo $_REQUEST['add_short_by']?>&add_then_by="+add_then_by+"&client_id=<?php echo $_REQUEST['client_id']?>";
	...
	if ($("#add_owner" ).val()!="") {	
		...
		?>
               ...
               var  url = "<?php echo $obj_base_path->base_path();?>/admin/ad_list.php?add_size=<?php echo $_REQUEST['add_size']?>&position_id=<?php echo $_REQUEST['position_id']?>&short_by=<?php echo $_REQUEST['add_short_by']?>&add_then_by=<?php echo $_REQUEST['add_then_by']?>&client_id="+short_by_add_owner+"&page=<?php echo $_REQUEST['page']?>";
		...
		?>
		var  url = "<?php echo $obj_base_path->base_path();?>/admin/ad_list.php?add_size=<?php echo $_REQUEST['add_size']?>&position_id=<?php echo $_REQUEST['position_id']?>&short_by=<?php echo $_REQUEST['add_short_by']?>&add_then_by=<?php echo $_REQUEST['add_then_by']?>&client_id="+short_by_add_owner;
   ...
   $( "#add_short_by_size" ).change(function() {
	if ($("#add_short_by_size" ).val()!="") {	
	       ...
	       <?php
			if(isset($_REQUEST['page']) and is_numeric($_REQUEST['page'])){
		?>
	       //var  url = "<?php echo $obj_base_path->base_path();?>/admin/ad_list.php?add_size="+short_by_va_size+" &position_id="<?php echo $_REQUEST['position_id']?>+"&short_by="<?php echo $_REQUEST['add_short_by']?>+"&add_then_by=<?php echo $_REQUEST['add_then_by']?>"+"&page=<?php echo $_REQUEST['page']?>";
               
               
               var  url = "<?php echo $obj_base_path->base_path();?>/admin/ad_list.php?add_size="+short_by_va_size+"&position_id=<?php echo $_REQUEST['position_id']?>&short_by=<?php echo $_REQUEST['add_short_by']?>&add_then_by=<?php echo $_REQUEST['add_then_by']?>&client_id=<?php echo $_REQUEST['client_id']?>&page=<?php echo $_REQUEST['page']?>";
		...
		?>
		var  url = "<?php echo $obj_base_path->base_path();?>/admin/ad_list.php?add_size="+short_by_va_size+"&position_id=<?php echo $_REQUEST['position_id']?>&short_by=<?php echo $_REQUEST['add_short_by']?>&add_then_by=<?php echo $_REQUEST['add_then_by']?>&client_id=<?php echo $_REQUEST['client_id']?>";
	...
	if ($("#add_then_by_position" ).val()!="") {	
	       ...
	       <?php
			if(isset($_REQUEST['page']) and is_numeric($_REQUEST['page'])){
		?>
	       var  url = "<?php echo $obj_base_path->base_path();?>/admin/ad_list.php?add_size=<?php echo $_REQUEST['add_size']?>&position_id="+short_by_va_position+"&short_by=<?php echo $_REQUEST['add_short_by']?>&add_then_by=<?php echo $_REQUEST['add_then_by']?>&client_id=<?php echo $_REQUEST['client_id']?>&page=<?php echo $_REQUEST['page']?>";
               
	       <?php
			}
			else{
		?>
		var  url = "<?php echo $obj_base_path->base_path();?>/admin/ad_list.php?add_size=<?php echo $_REQUEST['add_size']?>&position_id="+short_by_va_position+"&short_by=<?php echo $_REQUEST['add_then_by']?>&add_then_by=<?php echo $_REQUEST['add_then_by']?>&client_id=<?php echo $_REQUEST['client_id']?>";	
     ...
     <div>
         <select id="add_owner">
                <option value="">Ad Owner</option> 
			     ...
			     { ?>
 <option value="<?php echo  $obj_ads_client->f('client_id'); ?>"<?php if($_REQUEST['client_id']==$obj_ads_client->f('client_id')){?> selected <?php } ?>   ><?php echo  $obj_ads_client->f('Contact_first_name'); ?> <?php echo  $obj_ads_client->f('Contact_last_name'); ?> </option>
	 ...
	 <div class="myevent_box">
	   <div class="event_header" style="color:#FF0000"><strong><?php echo $msg;?></strong></div>
		...
		<td><?php echo $objadlist->f('ad_title');?></td>
	        <td><?php echo $objadlist->f('Contact_first_name');?> <?php echo $objadlist->f('Contact_last_name');?></td>
