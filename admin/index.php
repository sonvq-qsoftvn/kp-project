...
<!---------------------put your div--here-------------------------------------------------- --> 
            <div class="box1">
				  ...
				  <div style="font-family:Arial, Helvetica, sans-serif; padding-left:10px; color:#FF0000"><?php if(isset($msg)) echo $msg;?></div>
                  <form name="frm" method="post" action="index.php" onSubmit="return chk();">
                  <input type="hidden" name="submittype" value="false">
                    <div class="log">
                    <ul>
                        <li><span><?php echo AD_USERNAME; ?></span><input type="text" name="username" id="username" class="textfield_name"  /> </li>
                    </ul>
                    <ul>
                        <li><span><?php echo AD_PASSWORD; ?></span> <input type="Password" name="password" id="password" maxlength="20" class="textfield_name"/></li>
                    </ul>
                    <ul>
                        <li><input name="submit1" type="submit" value="LOGIN" class="login_btn" /> <a href="<?php echo $obj_base_path->base_path(); ?>/forgot_password.php"><?php echo AD_FORGOT_YOUR_PASS; ?>?</a></li>
                    </ul>
                </div>
                </form>
             <div class="clear"></div>
