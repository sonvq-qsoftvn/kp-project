...
function limiter_text(){
		...
		document.frm.limit_text.value = count_text-len;
	}
...
function limiter_text1(){
		...
		document.frm.limit_text1.value = count_text1-len;
	}
...
function limiter_call_to_action_es(){
		...
		var len = tex.length;
		if(len > count_call_to_action_es){
				tex = tex.substring(0,count_call_to_action_es);
				document.frm.call_to_action_es.value =tex;
				return false;
		}
		document.frm.limit_action.value = count_call_to_action_es-len;
	}     
...
function limiter_call_to_action_en(){
           ...
           // var tex= $('#call_to_action_en').val() ;
	
		var tex = document.frm.call_to_action_en.value;
            
		var len = tex.length;
		if(len > count_call_to_action_en){
				tex = tex.substring(0,count_call_to_action_en);
				document.frm.call_to_action_en.value =tex;
				return false;
		}
		document.frm.limit_action1.value = count_call_to_action_en-len;
	}     
		...
		<td width="87%">
         ...
         <option value="">--Please Select client--</option>
          ...
          <?php while($row = $obj_ads_client->next_record())
            ...
            <option value="<?php echo  $obj_ads_client->f('client_id'); ?>" <?php if($obj_ads_client->f('client_id')==$obj_media_update_es->f('client_id')) echo 'selected=selected' ?>   ><?php echo  $obj_ads_client->f('Contact_first_name'); ?> <?php echo  $obj_ads_client->f('Contact_last_name'); ?></option>
      ...
      echo $obj_media_update_es->f('ad_image_name');   
        ...
        ?>
			  ...
			  <?php if($call_to_action_es_title>0) { ?>
				document.write("<input type=text name=limit size=4 readonly value=<?php echo $call_to_action_remaining_action_title_es;?>>");
			  <?php } else { ?>
		...
		<td width="87%">
		<textarea name="ad_text_es" id="ad_text_es" rows="2" cols="50" onkeyup="limiter1()"><?php echo $obj_media_update_es->f('ad_text')?></textarea>
                
                 
                     <?php
            $call_to_action_es_text = strlen($obj_media_update_es->f('ad_text'));
            $call_to_action_remaining_action_text_es= 90-$call_to_action_es_text ;
        ?>
                    
                    <span>     
                    <script type="text/javascript">
			  <?php if($call_to_action_length_title>0) { ?>
				document.write("<input type=text name=limit_text size=4 readonly value=<?php echo $call_to_action_remaining_action_text_es;?>>");
			  <?php } else { ?>
				document.write("<input type=text name=limit1_text size=4 readonly value="+count_text+">");
			  <?php } ?>
		</script>
		...
		<textarea name="ad_contain_es" id="ad_contain_es" rows="2" cols="50"><?php echo $obj_media_update_es->f('ad_alternate_text')?></textarea>
		...
		<td width="87%">
                    ...
                    <input type="text" name="call_to_action_es" id="call_to_action_es" value="<?php echo $obj_media_update_es->f('call_to_action')?>" size="52" onkeyup="limiter_call_to_action_es()"/>
                     ...
                     <?php
            $call_to_action_en = strlen($obj_media_update_es->f('call_to_action'));
            $call_to_action_remaining_action= 25-$call_to_action_en ;
        ?>
                    
                    <span>     
                    <script type="text/javascript">
			  <?php if($call_to_action_length_title>0) { ?>
				document.write("<input type=text name=limit_action size=4 readonly value=<?php echo $call_to_action_remaining_action;?>>");
			  <?php } else { ?>
				document.write("<input type=text name=limit_action size=4 readonly value="+count_call_to_action+">");
			  <?php } ?>
		</script>
    ...
    echo $_POST['ad_photo_en'];
      ...
      echo $obj_media_update_en->f('ad_image_name');   
		...
		<td width="87%">
               ...
               <?php
                    $call_to_action_length_title = strlen($obj_media_update_en->f('ad_text'));
          ...
          ?>
                    ...
                    <script type="text/javascript">
			  <?php if($call_to_action_length_title>0) { ?>
				document.write("<input type=text name=limit1 size=4 readonly value=<?php echo $call_to_action_remaining_title;?>>");
			  <?php } else { ?>
				document.write("<input type=text name=limit11 size=4 readonly value="+count1+">");
			  <?php } ?>
		</script>
		...
		<td width="13%" style="font: normal 12px/18px Arial, Helvetica, sans-serif; padding: 0;">Ad Text ::</td>
		<td width="87%">
		<textarea name="ad_text_en" id="ad_text_en" rows="2" cols="50" onkeyup="limiter_text1()"><?php echo $obj_media_update_en->f('ad_text')?></textarea>
              
                
                 <?php
            $call_to_action_length_text = strlen($obj_media_update_en->f('ad_text'));
            $call_to_action_remaining_text = 90-$call_to_action_length_text;
        ?>
                    
                    <span>     
                    <script type="text/javascript">
			  <?php if($call_to_action_length_text>0) { ?>
				document.write("<input type=text name=limit_text1 size=4 readonly value=<?php echo $call_to_action_remaining_text;?>>");
			  <?php } else { ?>
				document.write("<input type=text name=limit_text1 size=4 readonly value="+count_text1+">");
			  <?php } ?>
		</script>
		...
		<textarea name="ad_contain_en" id="ad_contain_en" rows="2" cols="50"><?php echo $obj_media_update_en->f('ad_alternate_text')?></textarea>
  ...
  <tr>
		...
		<td width="87%">
		    ...
		    <input type="text" name="call_to_action_en" id="call_to_action_en" value="<?php echo $obj_media_update_en->f('call_to_action')?>" size="52"  onkeyup="limiter_call_to_action_en()"/>
                   ...
                   <?php
            $call_to_action_length1 = strlen($obj_media_update_en->f('call_to_action'));
            $call_to_action_remaining1 = 20-$call_to_action_length1;
        ?>
                    
                    <span>     
                    <script type="text/javascript">
			  <?php if($call_to_action_length1>0) { ?>
				document.write("<input type=text name=limit_action1 size=4 readonly value=<?php echo $call_to_action_remaining1;?>>");
			  <?php } else { ?>
				document.write("<input type=text name=limit_action1 size=4 readonly value="+count_call_to_action_en+">");
			  <?php } ?>
		</script>
