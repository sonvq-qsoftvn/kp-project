...
if($short_desc_sp==""){
	$short_desc_sp = substr(trim(strip_tags(addslashes($_POST['event_des_sp']))),0,160);
}

if($short_desc_en==""){
	$short_desc_en = substr(trim(strip_tags(addslashes($_POST['event_des_en']))),0,160);
}
