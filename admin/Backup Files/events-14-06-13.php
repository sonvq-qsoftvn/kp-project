...
function checkReg()
{
	...
	if($("#event_date_st").val()=="" || $("#event_date_st").val()=="00")
	{
	...
	if($("#venue").val()=="")
	{
	 ...
	 $.ajax({ 
	   url: "<?php echo $obj_base_path->base_path(); ?>/admin/ajax_check_ticket.php",
	   cache: false,
	   type: "POST",
	   success: function(data){ 
	  // alert(data)
	   	if(data==0)
			alert("Please Insert tickets.");
			$('#ticket_buy1').focus();
			//$('#openPop').trigger("click");
	   		return false;
	   }
...
<?php include("admin_header.php"); ?>
  <div id="maindiv">
    ...
    <span class="event_fieldbg"><span style="background: #FFFFFF; color: #FF0000; margin: 8px 0 0 0; padding: 4px; font: bold 22px/22px Arial, Helvetica, sans-serif; display: inline-block;">SP</span><input type="text" name="event_name_sp" id="event_name_sp" style="width: 550px; margin:10px 0;" class="event_field" value="Nombre del evento" onClick="if(this.defaultValue==this.value) this.value=''" onBlur="if (this.value=='') this.value=this.defaultValue"/></span><br/>
    <span class="event_fieldbg"><span style="background: #FFFFFF; color: #FF0000; margin: 8px 0 0 0; padding: 4px; font: bold 22px/22px Arial, Helvetica, sans-serif; display: inline-block;">EN</span><input type="text" name="event_name_en" id="event_name_en" class="event_field" value="Event Name" style="width: 546px; margin:10px 0;" onClick="if(this.defaultValue==this.value) this.value=''" onBlur="if (this.value=='') this.value=this.defaultValue" /></span>
    </div>
    </div>
    <div class="clear"></div>
    ...
    <tr>
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><input type="text" name="event_day_st" id="event_date_st"  class="textbg_grey" value="00" style="width: 30px;"/></td>
          <td>/</td>
          <td><input type="text" name="event_month_st" id="event_month_st" class="textbg_grey" value="00" style="width: 30px;"/></td>
          <td>/</td>
          <td><input type="text" name="event_year_st" id="event_year_st"  class="textbg_grey" value="0000" style="width: 40px;"/></td>
          <td></td>
        </tr>
        <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
     <tr>
      ...
      <td width="8%"><select name="venue_state" id="venue_state" class="selectbg12" onChange="getCounty(this.value);">
