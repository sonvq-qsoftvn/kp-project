...
.but:hover{
	...
	<h1><a href="javascript:media_library()"  onclick="" >Set Feature Image And Event Gallery <img src="<?php echo $obj_base_path->base_path(); ?>/images/question_mark.gif" alt="" width="31" height="28" border="0"/></a></h1>
        <div class="event_featue_text">The feature image is used by social networks. It is highly recommended to set it for your event.
You can also add photos or videos to your media library.</div>
    ...
    <div id="ticket_area" style="display:none;">
       <div class="event_ticket2">
            <div><h2>Create/edit Ticket/reservations<img src="<?php echo $obj_base_path->base_path(); ?>/images/question_mark.gif" width="31" height="28" border="0"/>
      ...
      <input type="hidden" name="exit_ticket_id" id="exit_ticket_id" value="0" />
       ...
       <div class="event_date8">
        ...
        <div class="event_date9">
            ...
            To <input type="text" name="to_ticket" id="to_ticket" value="<?php echo $start_day."-".$start_mon."-".$start_yr;?>"  />
        </div>	
        <div class="event_date9">
        ...
        <div style="float: right; width: 375px; margin: 0 auto;">
            ...
            <input type="button" name="Submit2" value="Save & Exit" class="event_save" onClick="save_new_popup()" style="cursor:pointer;"/></div>
        </div>
    ...
    <div class="event_ticket" style="background: none; width: 265px; border: 0; margin: -10px auto 0 10px;">    
      <div class="event_ticketr" style="float: right; margin-right: 24px;">
        ...
        <!----For Promote------>
         <div style="margin:2px 0 2px 46px;font-weight:bold;">Promote your event</div>
         <div style="margin: 10px 0 2px 85px;"><input type="button" name="promote" value="Promote" class="update_btn" onclick="promote_submit_but(<?php echo $obj->f('event_id')?>)" /><img src="<?php echo $obj_base_path->base_path(); ?>/images/question_img.gif" alt="" width="28" height="28" border="0" align="absmiddle" style="margin: 10px 0 0 0;"/></div>
         <!----Promote END------>
