...
$id = $_REQUEST['id'];
$obj_edit_state->getState($id);
$obj_edit_state->next_record();
...
if(isset($_POST['addcat']) && $_POST['addcat'] == '1')	
{
	...
	$obj_add->EditState($country_id,$state_name_sp,$state_name,$id);
	$msg = "State edit successfully";
}
          ...
          <div class="clear"></div>
           ...
           <?php
			...
			?>
				<div class="blue_boxr">
				  <ul>
				   <li><a href="<?php echo $obj_base_path->base_path(); ?>/admin/add_state" class="here">Create/Edit State</a></li>
                      ...
                      <div class="table_wrapper_inner">														
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="sptable">
                         ...
                         <tr>
                            ...
                            ?>
                            <option value="<?php echo $obj_category->f('id'); ?>" <?php if($obj_edit_state->f('country_id')==$obj_category->f('id')){?> selected="selected"<?php } ?>><?php echo stripslashes($obj_category->f('nicename')); ?></option>
                            <?php } ?>
                              </select></span>
                            </th>
                          </tr>
                          <tr>
            				<th width="16%">
                                ...
                                <span class="event_fieldbg20"><input type="text" name="state_name_sp" id="state_name_sp"  class="event_field" value="<?php echo $obj_edit_state->f('state_name_sp');?>" style="height: 25px; margin: 5px 0; width: 290px;"/></span>
                            </th>
                          </tr>
                          <tr>                                                      
                            <th>
                            <span class="state_en">EN</span><br/>
                            <span class="event_fieldbg20"><input type="text" name="state_name" id="state_name" class="event_field" value="<?php echo $obj_edit_state->f('state_name');?>"  style="height: 25px; margin: 5px 0; width: 290px;"/></span>														</th>
                          </tr>
                          
                          <tr>                                                        
                            <th colspan="2"><input type="hidden" name="addcat" value="1" /><input type="submit" name="submit" id="submit" value="Save" class="createbtn" style="cursor:pointer;"/></th>
                          </tr>
                        </table>
                      </div>
                    </div>											
