        ...
        <div class="table_wrapper">
            ...
            <tr>
                ...
                <?php
					...
					<td width="11%"><img src="<?php echo $obj_base_path->base_path(); ?>/images/edit.gif" alt="" width="20" height="16" /><a href="<?php echo $obj_base_path->base_path(); ?>/admin/edit_page/<?php echo $objlist->f('page_id');?>">Edit</a></td>
