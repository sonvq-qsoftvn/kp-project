...
<!--		<tr>
         ...
         <option value="">--Please Select client--</option>
          ...
          <?php while($row = $obj_ads_client->next_record())
            ...
            <option value="<?php echo  $obj_ads_client->f('client_id'); ?>"><?php echo  $obj_ads_client->f('Contact_first_name'); ?> <?php echo  $obj_ads_client->f('Contact_last_name'); ?></option>
                ...
                <div id="hide_next_frm" style="display: block;">   
		...
		<td width="87%">
                    <input type="text" name="ad_title_es" id="ad_title_es"  value="" onkeyup="limiter()"  size="52"/><span><script type="text/javascript">
		...
		<textarea name="ad_text_es" id="ad_text_es" rows="2" cols="50" onkeyup="limiter_text()"><?php echo $objmedia_es->f('alternative_text')?></textarea>
               ...
               <script type="text/javascript">
				...
				document.write("<input type=text name=limit_text size=4 readonly value="+count_text+">");
		...
		<td width="87%">
                    ...
                    <input type="text" name="call_to_action_es" id="call_to_action_es" value="" size="52" onkeyup="limiter_call_to_action_es()"/>
                    
                    <span>  <script type="text/javascript">
			
				document.write("<input type=text name=limit_action size=4 readonly value="+count_call_to_action_es+">");
 ...
 <!-------------------For English  image upload----------------------------->
		...
		<?php } else { ?>
                <img  id="img_src_en_id" src="<?php echo $obj_base_path->base_path(); ?>/files/event/thumb/<?php echo $_POST['ad_photo_en']; ?>" alt="" />
		<?php }  ?>
		<div class="clear"></div>
   ...
   <tr>
		...
		<td width="87%">
		    ...
		    <input type="text" name="call_to_action_en" id="call_to_action_en" value="" size="52" onkeyup="limiter_call_to_action_en()"/>
