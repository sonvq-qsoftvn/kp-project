                ...
                <?php
					...
					<!---------THIS PRIVIEW URL ONLY FOR BLOG---------->
					  <?php if($objlist->f('path')=='blog') {?> 
						<a href="<?php echo $obj_base_path->base_path(); ?>/en/<?php echo $objlist->f('path');?>/<?php echo $objlist->f('page_id');?>/<?php echo str_replace(',','',str_replace(' ', '-',$objlist->f('page_name')));?>" target="_blank">Preview EN</a>
						&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="<?php echo $obj_base_path->base_path(); ?>/es/<?php echo $objlist->f('path');?>/<?php echo $objlist->f('page_id');?>/<?php echo str_replace(' ', '-',$objlist->f('title_sp'));?>" target="_blank">Preview ES</a>
					      <?php }
					      else { ?>
					<!---------THIS PRIVIEW URL ONLY FOR BLOG---------->
					...
					<!---------THIS PRIVIEW URL FOR ALL PAGES START---------->
						...
						<a href="<?php echo $obj_base_path->base_path(); ?>/en/<?php echo $objlist->f('path');?>/" target="_blank">Preview EN</a>
						&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="<?php echo $obj_base_path->base_path(); ?>/es/<?php echo $objlist->f('path');?>/" target="_blank">Preview ES</a>
					      <?php } ?>
