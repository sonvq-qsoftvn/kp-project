...
if($_POST['edit_rate']==0){
	$obj_add->addStandardRatesVenue($obj_ven->f('unique_id'),$rate_name_en,$rate_name_sp,$description_en,$description_sp,$price_mx,$price_us,$venue_id);
}
else
{
	$exit_rate_id = $_POST['exit_rate_id'];
