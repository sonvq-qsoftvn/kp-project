...
if($_POST['edit_ticket']==0){
	$obj_add->addsub_event_final_tickets($ticket_name_en,$ticket_name_sp,$description_en,$description_sp,$price_mx,$price_us,$ticket_num,$from_ticket,$to_ticket,$eairly_dis_percen,$eairly_days,$group_dis_per,$group_dis_days,$ticket_icon,$members_only,$_SESSION['unique_id_subevent'],$event_id,$sub_event_id);
}
else
{
    ...
    <ul>
        ...
        <li style="margin-right: 0;">
            <span class="tic_edit">
                ...
                <span style="cursor:pointer;" onclick="deleteTemp(<?php echo $obj_temp_tickets->f('ticket_id') ?>,<?php echo $sub_event_id;?>)"><img src="<?php echo $obj_base_path->base_path(); ?>/images/cross.gif" alt="" width="20" height="16" border="0" align="absmiddle"/> Delete </span>
            </span>
        </li>
    </ul>
</div>
