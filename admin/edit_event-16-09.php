...
<?php include("admin_header.php"); ?>
  <div id="maindiv">
    ...
    <span class="event_fieldbg8">
		<input type="text" name="event_name_sp" id="event_name_sp" style="width: 290px; margin: 5px 0; height: 25px;" class="event_field" value="<?php echo stripslashes($obj->f('event_name_sp'));?>" onBlur="saveAutoEvent();"/>
	</span>	
	<br/>
		<?php
        ...
        ?>
		<span class="event_fieldbg8"><textarea name="short_desc_sp" class="event_field" style="width:290px; margin: 5px 0; padding: 3px 5px; height: 60px;" onblur="saveAutoEvent();" onkeyup="limiter()"><?php echo stripslashes($obj->f('event_short_desc_sp'));?></textarea>
    ...
    <span class="event_fieldbg8">
	<input type="text" name="event_name_en" id="event_name_en" style="width: 290px; margin: 5px 0; height: 25px;" class="event_field" value="<?php echo stripslashes($obj->f('event_name_en'));?>" onBlur="saveAutoEvent();"/>
	</span>	
	<br/>
	<?php
    ...
    ?>
	<span class="event_fieldbg8">
	<textarea name="short_desc_en" class="event_field" style="width: 290px; margin: 5px 0; padding: 3px 5px; height: 60px;" onblur="saveAutoEvent();" onkeyup="limiter1()"><?php echo stripslashes($obj->f('event_short_desc_en'));?></textarea>
	<script type="text/javascript">
		  <?php if($biodata_length>0) { ?>
			document.write("<input type=text name=limit size=4 readonly value=<?php echo $biodata_character_remaining;?>>");
		  <?php } else { ?>
			document.write("<input type=text name=limit size=4 readonly value="+count1+">");
		  <?php } ?>
	</script>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
     <tr>
      ...
      <td width="22%">
		  ...
		  <select name="venue_city" class="selectbg12" onchange="getVenue(this.value); saveAutoEvent()">
...
function subEventEdit() 
{
    ...
    <div class="event_date" style="float: right; width: 700px;">
    	...
    	<tr>
          <td width="75%"><p style="text-align: right; padding-right: 13px;"><img src="<?php echo $obj_base_path->base_path(); ?>/images/question_mark.gif" alt="" width="31" height="28" border="0"/> This event has several identical functions</p></td>
          <td width="25%">
	  		...
	  		<div class="event_ticketl2">
				...
				<div style="float: right; width: 420px;">
					<!--<span><?php echo date("D",strtotime($event_date))." ".date("M",strtotime($event_date))." ".date("d",strtotime($event_date)).", ".date("Y",strtotime($event_date));?> - <?php echo date('g:i a A',strtotime($event_time)); ?></span>-->
						...
						<span style="cursor:pointer;" onclick="delete_multipleEvents('<?php echo $obj_temp_mulEve->f('multi_id');?>','<?php echo $_GET['id'];?>')"><img src="<?php echo $obj_base_path->base_path(); ?>/images/cross.gif" alt="" width="20" height="16" border="0" align="absmiddle"/> Delete</span>
					 </span>
				</div>
				</div>
				 <?php
				...
				?>				
                 ...
                 <div class="clear"></div>
				<div id="add_edit_show"><h1 style="color:#000000;">Add another function</h1></div>
	...
	<li><select name="event_time" class="selectbg" id="event_time" title="" style="width:70px;float:left; margin: 8px 0; height: 20px;" onchange="check(this.value);" onblur="saveAutoEvent();">
				  ...
				  <option value="Daily" <?php if($obj->f('event_time') == 'Daily') { echo 'selected'; } ?>>Daily</option>
				  <option value="Weekly" <?php if($obj->f('event_time') == 'Weekly') { echo 'selected'; } ?>>Weekly</option>
				  <option value="Monthly" <?php if($obj->f('event_time') == 'Monthly') { echo 'selected'; } ?>>Monthly</option>
				  <option value="Yearly" <?php if($obj->f('event_time') == 'Yearly') { echo 'selected'; } ?>>Yearly</option>
                </select></li>
	<li>Every</li>
		...
		<ul>
			<li>
				<select name="r_month" class="selectbg" id="r_month" title="" style="width:70px;float:left; margin: 8px 0; height: 20px;" onchange="saveAutoEvent();">
                  <option value="">Select</option>
				  <option value="First" <?php if($obj->f('r_month') == 'First') { echo 'selected'; }?>>First</option>
				  <option value="Second" <?php if($obj->f('r_month') == 'Second') { echo 'selected'; }?>>Second</option>
				  <option value="Third" <?php if($obj->f('r_month') == 'Third') { echo 'selected'; }?>>Third</option>
				  <option value="Fourth" <?php if($obj->f('r_month') == 'Fourth') { echo 'selected'; }?>>Fourth</option>
				  <option value="Last" <?php if($obj->f('r_month') == 'Last') { echo 'selected'; }?>>Last</option>
                </select>
			</li>
			<li>
				<select name="r_month_day" class="selectbg" id="r_month_day" title="" style="width:70px;float:left; margin: 8px 0; height: 20px;" onchange="saveAutoEvent();">
                  <option value="">Select</option>
				  <option value="Monday" <?php if($obj->f('r_month_day') == 'Monday') { echo 'selected'; }?>>Monday</option>
				  <option value="Tuesday" <?php if($obj->f('r_month_day') == 'Tuesday') { echo 'selected'; }?>>Tuesday</option>
				  <option value="Wednesday" <?php if($obj->f('r_month_day') == 'Wednesday') { echo 'selected'; }?>>Wednesday</option>
				  <option value="Thursday" <?php if($obj->f('r_month_day') == 'Thursday') { echo 'selected'; }?>>Thursday</option>
				  <option value="Friday" <?php if($obj->f('r_month_day') == 'Friday') { echo 'selected'; }?>>Friday</option>
				  <option value="Saturday" <?php if($obj->f('r_month_day') == 'Saturday') { echo 'selected'; }?>>Saturday</option>
				  <option value="Sunday" <?php if($obj->f('r_month_day') == 'Sunday') { echo 'selected'; }?>>Sunday</option>
                </select>
			</li>
			<li>of each month</li>
		</ul>
    ...
    <?php
	/*$obj_subEv = new event;
	$obj_subEv->allSubEventList($_GET['id']);
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="id_detail2" id="div_subevent_list">
          <tr>
            <td width="22%" class="top_txt" style="text-align:left">Event</td>
            <td width="18%" class="top_txt" style="text-align:left">Venue</td>
            <td width="10%" class="top_txt" style="text-align:left">Event Date</td>
            <td width="19%" class="top_txt" style="text-align:left">Start Time - End Time</td>
            <td width="6%" class="top_txt" style="text-align:left">Edit</td>
            <td width="9%" class="top_txt" style="text-align:left">Delete</td>
          </tr>
          <?php
		  	$obj_subEv = new event;
			$obj_subEv->allSubEventList($_GET['id']);
          ...
          <?php
			...
			?>
            <tr>
	            <td colspan="6" style="text-align:left">No record.</td>
            </tr>
			<?php
			}
          ?>
...
.but:hover{
	...
	cursor:pointer;
		...
		<a href="<?php echo $obj_base_path->base_path(); ?>/admin/sub-events-edit/<?php echo $_GET['id'];?>" class="but" target="_blank">Add a New Sub-Event</a>
	</div>
	<?php } ?>
    <script type="text/javascript">
    ...
    <div class="event_ticket" style="background:none;">
		...
		<span style="float: left;">
        	<p class="rad_button"><input type="radio" name="privacy" id="public_privacy" value="0" <?php if($obj->f('set_privacy') == '0') { ?> checked="checked" <?php } ?> onclick="privacy_policy(); saveAutoEvent();" /> Public</p>	
			<p class="rad_button"><input type="radio" name="privacy" id="private_privacy" value="1" <?php if($obj->f('set_privacy') == '1') { ?> checked="checked" <?php } ?> onclick="privacy_policy(); saveAutoEvent();" /> Private</p>
         </span>
		...
		<span id="private_content">
            <table width="100%" border="1">
              ...
              <tr>
                <td><input type="checkbox" name="attendees" id="attendees" value="1" <?php if($obj->f('attendees_share') == '1') { ?> checked="checked" <?php } ?> onclick="saveAutoEvent();"  />&nbsp; Attendees can share the event with their friends on socail networks.</td>
              </tr>
              <tr>
                <td><input type="checkbox" name="invitation_only" id="invitation_only" value="1" <?php if($obj->f('attendees_invitation') == '1') { ?> checked="checked" <?php } ?> onclick="saveAutoEvent();"  />&nbsp; Invitation Only - Attendees must receive a KPasapp invitation to register.</td>
              </tr>
              <tr>
                <td><input type="checkbox" name="password_protect_check" id="password_protect_check" value="1" <?php if($obj->f('password_protect') == '1') { ?> checked="checked" <?php } ?> onclick="saveAutoEvent();"  />&nbsp; Password Protected &nbsp; 
    ...
    <div>
     <ul>
        <li><input name="radio_access" id="radio_access" type="radio" value="1" <?php if($obj->f('all_access') == '1') { ?> checked="checked" <?php } ?> onclick="showticketingsection(); saveAutoEvent();" /><strong>Some or all access to this event requires reservation, ticketing and/or RSVP</strong></li>
        <li><input name="radio_access" id="radio_access" type="radio" value="0" <?php if($obj->f('all_access') == '0') { ?> checked="checked" <?php } ?> onclick="showticketingsection(); saveAutoEvent();" /><strong>All access to this event is open to the public free of charge and without reservation</strong></li>
        ...
        <li class="payment_resarvation" style="margin-left:10px;display:none;">Price includes payment & Ticketing fee
        	<span class="ticektfee">
            	<input name="pay_ticket_fee" type="radio" value="1" <?php if($obj->f('include_payment') == '1') { ?> checked="checked" <?php } ?>  style="margin: 5px;" onclick="saveAutoEvent();"/>Yes 
                <input name="pay_ticket_fee" type="radio" value="0" <?php if($obj->f('include_payment') == '0') { ?> checked="checked" <?php } ?> style="margin: 5px;" onclick="saveAutoEvent();"/> No 
            </span>
        </li>
        <li class="payment_resarvation" style="margin: 0 0 0 10px;display:none;">Price includes promotion charges
        	<span class="ticketfee1" style="margin:0 34px;">
                <input name="promo_charge" type="radio" value="1" <?php if($obj->f('include_promotion') == '1') { ?> checked="checked" <?php } ?> style="margin: 5px;" onclick="saveAutoEvent();"/>Yes 
                <input name="promo_charge" type="radio" value="0" <?php if($obj->f('include_promotion') == '0') { ?> checked="checked" <?php } ?> style="margin:5px;" onclick="saveAutoEvent();"/> No 
            </span>
        </li>
	 </ul>
	</div>
    ...
    <div id="ticket_area" style="display:none;">
				...
				<ul>
					...
					<li style="margin-right: 0;">
						<span class="tic_edit">
							...
							<span style="cursor:pointer;" onclick="deleteTemp('<?php echo $obj_temp_tickets->f('ticket_id') ?>','<?php echo $_GET['id']?>')"><img src="<?php echo $obj_base_path->base_path(); ?>/images/cross.gif" alt="" width="20" height="16" border="0" align="absmiddle"/> Delete </span>
						</span>
					</li>
				</ul>
			</div>
      ...
      <input type="hidden" name="exit_ticket_id" id="exit_ticket_id" value="0" />
       ...
       <div class="event_date8">
        ...
        <div class="event_date9">
        	Number of available seats <input type="text" name="ticket_num" id="ticket_num" style="width: 64px;" onclick="saveAutoEvent();"/> 
        	From <input type="text" name="from_ticket" id="from_ticket" onclick="saveAutoEvent();" /> 
            To <input type="text" name="to_ticket" id="to_ticket" onclick="saveAutoEvent();" />
        </div>	
        <div class="event_date9">
        	Early bird discount <input type="text" name="eairly_dis_percen" id="eairly_dis_percen" onclick="saveAutoEvent();" /> 
        	% Up to <input type="text" name="eairly_days" id="eairly_days" style="width: 64px;" onclick="saveAutoEvent();"/> days before the event
        </div>
        <div class="event_date9">
        	Group discount <input type="text" name="group_dis_per" id="group_dis_per" onclick="saveAutoEvent();" /> 
            % over <input type="text" name="group_dis_days" id="group_dis_days" style="width: 64px;" onclick="saveAutoEvent();"/> tickets
        </div>
        <div class="event_date9">Membership only
        	<span class="membershipClass">
            	<input name="members_only" id="members_only1" type="radio" value="1" style="margin: 5px;" onclick="saveAutoEvent();"/>Yes 
                <input name="members_only" id="members_only2" type="radio" value="0" checked="checked"  style="margin: 5px;" onclick="saveAutoEvent();"/> No 
            </span>
        </div>
     ...
     <div class="event_ticketl">
        ...
        <div style="width: 180px; float: left; margin: 0 auto;">
            <ul>
                ...
                <li><input type="checkbox" name="Paypal" value="1" <?php if($obj->f('Paypal') == '1') { ?> checked="checked" <?php } ?> onclick="saveAutoEvent();"/>  Paypal/Credit card</li>
                <li><input type="checkbox" name="Bank" value="1" <?php if($obj->f('Bank_deposite') == '1') { ?> checked="checked" <?php } ?> onclick="saveAutoEvent();"/>  Bank deposite</li>
                <li><input type="checkbox" name="Oxxo" value="1" <?php if($obj->f('Oxxo_Payment') == '1') { ?> checked="checked" <?php } ?> onclick="saveAutoEvent();"/>  Oxxo Payment</li>
                <li><input type="checkbox" name="Mobile" value="1" <?php if($obj->f('Mobile_Payment') == '1') { ?> checked="checked" <?php } ?> onclick="saveAutoEvent();"/>  Mobile Payment</li>
                <li><input type="checkbox" name="Offline" value="1" <?php if($obj->f('Offline_Payment') == '1') { ?> checked="checked" <?php } ?> onclick="saveAutoEvent();"/>  Offline Payment</li>
            </ul>
        </div>
        <div style="width: 200px; float: right; margin: 0 auto;">
            <ul>
                ...
                <li><input type="checkbox" name="paper_less_mob_ticket" value="1" <?php if($obj->f('paper_less_mob_ticket') == '1') { ?> checked="checked" <?php } ?> onclick="saveAutoEvent();"/>  Paperless mobile ticket</li>
                <li><input type="checkbox" name="print" value="1" <?php if($obj->f('print') == '1') { ?> checked="checked" <?php } ?> onclick="saveAutoEvent();"/>  Print</li>
                <li><input type="checkbox" name="will_call" <?php if($obj->f('will_call') == '1') { ?> checked="checked" <?php } ?> value="1" onclick="saveAutoEvent();"/>  Will Call</li>
            </ul>
        </div>
	</div>
    <div class="event_ticket" style="background: none; width: 265px; border: 0; margin: -10px auto 0 10px;">    
      <div class="event_ticketr" style="float: right; margin-right: 24px;">
		...
		<?php if(date("Y-m-d")>=$obj->f('publish_date')) { ?>
            <div style="margin:2px 0 2px 40px; font-weight:bold;">Published on <?php echo date("d/m/Y",strtotime($obj->f('publish_date')));?></div>
            <div style="margin:2px 0 2px 30px;font-weight:bold;">Save your work regularly</div>
            <div style="margin: 10px 0 2px 85px;"><input type="button" name="save" value="Update" class="update_btn" onclick="form_submit_but()" /><img src="<?php echo $obj_base_path->base_path(); ?>/images/question_img.gif" alt="" width="28" height="28" border="0" align="absmiddle" style="margin: 10px 0 0 0;"/></div>
		<?php } else { ?>
...
function checkCat(category_id)
{
                ...
                <ul>
                 <?php
                    ...
                    <li style="padding-left: 8px;">
                    	<input type="checkbox" name="maincat[]" id="maincat<?php echo $objlist->f('category_id');?>" value="<?php echo $objlist->f('category_id');?>" class="category_1" onclick="showSubCat(<?php echo $objlist->f('category_id');?>); saveAutoEvent();" <?php if(in_array($objlist->f('category_id'),$arrMaincat)) { echo 'checked'; }?> /><?php echo $objlist->f('category_name'); if($obj_subcat->num_rows()){?> 			  
                    ...
                    <?php
					 ...
					 ?>
                            ...
                            <li style="padding-left:8px;"><input onclick="checkCat(<?php echo $objlist->f('category_id');?>);saveAutoEvent();" type="checkbox" name="maincat[]" value="<?php echo $obj_subcat->f('category_id');?>" <?php if(in_array($obj_subcat->f('category_id'),$arrMaincat)) { echo 'checked'; }?> /><?php echo $obj_subcat->f('category_name');?></li>
                         <?php
								}
							}
						?></ul>	
	...
	<div class="eventag_box">
		...
		<div class="clear"></div>
		<div><input type="text" name="event_tag" id="event_tag" class="textbg_add" value="<?php echo stripslashes($obj->f('event_tag'));?>" /> <input type="button" name="save" value="Add" class="btn_add" onclick="saveAutoEvent();" /></div>
		<div class="clear"></div>
