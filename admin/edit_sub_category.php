...
include('../include/admin_inc.php');
	...
	if(isset($_POST['editcat']) && $_POST['editcat'] == '1')	
	{
		...
		$_SESSION['cat_edit'] = "Sub-category updated successfully";
		header("Location:".$obj_base_path->base_path()."/admin/list_subcategory");
	}
												  ...
												  <div class="table_wrapper_inner">														
													...
													<tr>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td><select name="pcat" id="pcat">
														<option value="">Select</option>
														<?php 
														$obj_category->categorylist();
														while($obj_category->next_record()){
														?>
														<option value="<?php echo $obj_category->f('category_id'); ?>" <?php if($obj_category->f('category_id') == $obj->f('parent_category')) { echo 'selected'; }?>><?php echo stripslashes($obj_category->f('category_name')); ?></option>
														<?php } ?>
														</select></td>
                                                      </tr>
                                                      <tr>
                                                      ...
                                                      <tr>
                                                        <td>&nbsp;</td>
                                                        <td><input type="hidden" name="editcat" value="1" /><input type="submit" name="submit" id="submit" value="Save"  /></td>
                                                      </tr>
                                                    </table>
												  </div>
												</div>											
