	...
	<form action="#">       
		...
		<th  class="top_txt">Status</th>
                ...
                <?php
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<!---------THIS PRIVIEW URL ONLY FOR BLOG---------->
					  <?php if($objlist->f('path')=='blog') {?> 
						<a href="<?php echo $obj_base_path->base_path(); ?>/en/<?php echo $objlist->f('path');?>/<?php echo $objlist->f('page_id');?>/<?php echo strtolower(preg_replace($old_pattern, $new_pattern ,$objlist->f('page_name')));?>" target="_blank">Preview EN</a>
						&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="<?php echo $obj_base_path->base_path(); ?>/es/<?php echo $objlist->f('path');?>/<?php echo $objlist->f('page_id');?>/<?php echo strtolower(preg_replace($old_pattern, $new_pattern ,$objlist->f('title_sp')));?>" target="_blank">Preview ES</a>
					      <?php } 
                          else if($objlist->f('path')=='about_kp') {?> 						   
                                <a href="<?php echo $obj_base_path->base_path(); ?>/en/about-kpasapp/<?php echo $objlist->f('page_link') ;?>" target="_blank">Preview EN</a>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <a href="<?php echo $obj_base_path->base_path(); ?>/es/acerca-de-kpasapp/<?php echo $objlist->f('page_link') ;?>" target="_blank">Preview ES</a>
					      <?php } 
                          
					      else { ?>
					<!---------THIS PRIVIEW URL ONLY FOR BLOG---------->
					
					<!---------THIS PRIVIEW URL FOR ALL PAGES START---------->
					
<a href="<?php echo $obj_base_path->base_path(); ?>/en/<?php echo strtolower(preg_replace($old_pattern, $new_pattern ,$objlist->f('page_name')));?>/" target="_blank">Preview EN</a>
				&nbsp;&nbsp;&nbsp;&nbsp;
<a href="<?php echo $obj_base_path->base_path(); ?>/es/<?php echo strtolower(preg_replace($old_pattern, $new_pattern ,$objlist->f('title_sp')));?>/" target="_blank">Preview ES</a>
					      <?php } ?>
					<!---------THIS PRIVIEW URL FOR ALL PAGES END---------->
