                    ...
                    <div class="mediaimage">
                        <table width="80%" border=0 align="center" cellpadding="0" cellspacing="0" class="abck-form add-ads-table">
                            <form name="frm" id="frm_ad" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                                ...
                                <tr>
                                    <td><div align="center"><?php echo $updated_msg; ?></div></td>
                                    <td>&nbsp;</td>
                                </tr>               
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td width="87%">			
                                        <select name="duration_date" id="duration_date">			
                                            <option value="7"  <?php if ($total_dduration_date == 7) echo 'selected=selected' ?>>1 week</option>
                                            <option value="14"  <?php if ($total_dduration_date == 14) echo 'selected=selected' ?>>2 weeks</option>
                                            <option value="30"  <?php if ($total_dduration_date == 30) echo 'selected=selected' ?>>1 month</option>
                                            <option value="180"  <?php if ($total_dduration_date == 180) echo 'selected=selected' ?>>6 months</option>		   
                                            <option value="365"  <?php if ($total_dduration_date == 365) echo 'selected=selected' ?>>1 year</option>
                                        </select>
                                    </td>	
                                </tr>		
                                <br />                
                                            ...
                                            <ul style="margin-left: 10px;">
                                                <li>
                                                    <a href="#" class="here"> 			    
                                                        ...
                                                        <input type="hidden" name="ad_photo_en" id="ad_photo_en" value="<?php if ($_POST['ad_photo_en']) { echo $_POST['ad_photo_en']; } else { echo $obj_media_update_en->f('ad_image_name'); } ?>" />
                                                    </a>
                                                </li>             
                                            </ul>
                                        </div>   
