    ...
    <tr>
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <?php 
                $start_day = "";
                if ($st_eve_dy_sub != "" && $st_eve_mn_sub != "" && $st_eve_yr_sub != "") {
                    $start_day = $st_eve_mn_sub . '/' . $st_eve_dy_sub . '/' . $st_eve_yr_sub;
                }
            ?>
            <td style="position: relative">
                ...
                <input type="text" name="event_day_st" id="event_date_st" value="<?php if($st_eve_dy_sub!=""){echo $st_eve_dy_sub;}else{echo 00;}?>"  class="textbg_grey"  style="width: 30px;" />
            </td>
            <td>/</td>
            <td style="position: relative">
                <input type="text" <?php if ($start_day != "") { echo "value='$start_day'"; } ?> style="display: none; width: 30px; position: absolute;" class="textbg_grey event_start_datepicker"/>
                <input type="text" name="event_month_st" id="event_month_st" value="<?php if($st_eve_mn_sub!=""){echo $st_eve_mn_sub;}else{echo 00;}?>" class="textbg_grey"  style="width: 30px;" />
            </td>
            <td>/</td>
            <td style="position: relative">
                <input type="text" <?php if ($start_day != "") { echo "value='$start_day'"; } ?> style="display: none; width: 30px; position: absolute;" class="textbg_grey event_start_datepicker"/>
                <input type="text" name="event_year_st" id="event_year_st"  value="<?php if($st_eve_yr_sub!=""){echo $st_eve_yr_sub;}else{echo 0000;}?>" class="textbg_grey"  style="width: 40px;" />
            </td>
            <td></td>
        </tr>
        <tr>
          ...
          <td style="padding: 9px 0;">&nbsp;</td>
            <td style="padding: 9px 0; visibility: hidden">
                <select name="event_start_ampm" class="selectbg" id="event_start_ampm" title="Please select AM or PM" style="width:50px;float:left;">
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <?php 
                $end_day = "";
                if ($end_eve_dy_sub != "" && $end_eve_mn_sub!="" && $end_eve_yr_sub!="") {
                    $end_day = $end_eve_mn_sub . '/' . $end_eve_dy_sub . '/' . $end_eve_yr_sub;
                }
            ?>
            <td style="position: relative">
                ...
                <input type="text" name="event_day_end" id="event_date_end" value="<?php if($end_eve_dy_sub!=""){echo $end_eve_dy_sub;}else{echo 00;}?>" class="textbg_grey" style="width: 30px;"/>
            </td>
            <td>/</td>
            <td style="position: relative">
                <input type="text" <?php if ($end_day != "") { echo "value='$end_day'"; } ?> style="display: none; width: 30px; position: absolute;" class="textbg_grey event_end_datepicker"/>
                <input type="text" name="event_month_end" id="event_month_end" value="<?php if($end_eve_mn_sub!=""){echo $end_eve_mn_sub;}else{echo 00;}?>"  class="textbg_grey" style="width: 30px;"/></td>
            <td>/</td>
            <td style="position: relative">
                <input type="text" <?php if ($end_day != "") { echo "value='$end_day'"; } ?> style="display: none; width: 30px; position: absolute;" class="textbg_grey event_end_datepicker"/>
                <input type="text" name="event_year_end" id="event_year_end" value="<?php if($end_eve_yr_sub!=""){echo $end_eve_yr_sub;}else{echo 0000;}?>"  class="textbg_grey" style="width: 40px;"/>
            </td>
        </tr>
        <tr>
         ...
         <td style="padding: 9px 0;"><select name="event_min_end" class="selectbg" id="event_min_end" title="Please select event miniute" style="width:50px;float:left;">
          ...
          <td style="padding: 9px 0;">&nbsp;</td>
            <td style="padding: 9px 0; visibility: hidden">
               <select name="event_end_ampm" class="selectbg" id="event_end_ampm" title="Please select event miniute" style="width:50px;float:left;">
