...
$(document).ready(function() {
	$('#from_ticket').datepicker({firstDay: 1});
	$('#to_ticket').datepicker({firstDay: 1});
})
</script>
...
<?php include("admin_header.php"); ?>
  <div id="maindiv">
	...
	<input type="text" name="event_name_sp" id="event_name_sp" style="width: 550px; margin:10px 0;" class="event_field"   value="<?php if($msg!="" && $event_name_sp!=""){echo $event_name_sp;}else{echo "Nombre del evento";}?>" onClick="if(this.defaultValue==this.value) this.value=''" onBlur="if (this.value=='') this.value=this.defaultValue"/>
	</span>
	<br/>
	...
	<input type="text" name="event_name_en" id="event_name_en" class="event_field" value="<?php if($msg!="" && $event_name_en!=""){echo $event_name_en;}else{echo "Event Name";}?>" style="width: 546px; margin:10px 0;" onClick="if(this.defaultValue==this.value) this.value=''" onBlur="if (this.value=='') this.value=this.defaultValue" />
	</span>
    ...
    <tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin: 8px 0 0 0; width: 150px; border: 1px solid #CCCCCC; background: #f5f5f5; height: 30px;">
        <tr>
		  ...
		  <input name="several_fun_event" type="radio" value="1" <?php  if($msg!="" && $_POST['several_fun_event']==1){?> checked="checked"<?php }?>/>
		  </td>
          <td width="6%" align="center" valign="middle" style="padding: 4px;">Yes</td>
          <td width="4%" align="center" valign="middle" style="padding: 4px;">
		  <input name="several_fun_event" type="radio" value="0" <?php  if($msg!="" && $_POST['several_fun_event']==0){?> checked="checked"<?php }?>/>
		  </td>
    ...
    <tr>
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin: 8px 0 0 0; border: 1px solid #CCCCCC; width: 150px; background: #f5f5f5; height: 30px;">
        <tr>
          <td width="3%" align="center" valign="middle" style="padding: 4px;"><input name="recurring_event" type="radio" value="1" <?php  if($msg!="" && $_POST['recurring_event']==1){?> checked="checked"<?php }?>/></td>
          <td width="6%" align="center" valign="middle" style="padding: 4px;">Yes</td>
          <td width="4%" align="center" valign="middle" style="padding: 4px;"><input name="recurring_event" type="radio" value="0" <?php  if($msg!="" && $_POST['recurring_event']==0){?> checked="checked"<?php }?>/></td>
          <td width="87%" align="center" valign="middle" style="padding: 4px;">No</td>
        </tr>
      </table></td>
    </tr>
    <tr>
     ...
     <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin: 8px 0 0 0; border: 1px solid #CCCCCC;  width: 150px; background: #f5f5f5; height: 30px;">
        <tr>
          <td width="3%" align="center" valign="middle" style="padding: 4px;"><input name="multi_days_event" type="radio" value="1" <?php  if($msg!="" && $_POST['multi_days_event']==1){?> checked="checked"<?php }?>/></td>
          <td width="6%" align="center" valign="middle" style="padding: 4px;">Yes</td>
          <td width="4%" align="center" valign="middle" style="padding: 4px;"><input name="multi_days_event" type="radio" value="0"  <?php  if($msg!="" && $_POST['multi_days_event']==0){?> checked="checked"<?php }?>/></td>
          <td width="87%" align="center" valign="middle" style="padding: 4px;">No</td>
        </tr>
      </table></td>
    </tr>
    ...
    <textarea name="page_content_en" cols="35" rows="10"><?php if($msg!="" && $page_content_en!=""){echo $page_content_en;}?></textarea>
     <?php
    ...
    <div class="TabbedPanelsContent2">
    <textarea name="page_content_sp" cols="35" rows="10"><?php if($msg!="" && $page_content_sp!=""){echo $page_content_sp;}?></textarea>
     <?php
