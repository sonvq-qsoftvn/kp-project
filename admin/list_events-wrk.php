...
<?php /*?><?php
		...
		?>
		 ...
		 ?>
<?php */?> <tr>
                <td width="17%" class="top_txt">Event</td>
                <td width="14%" class="top_txt">Date & Time</td>
                <td width="14%" class="top_txt">Venue</td>
                <td width="10%" class="top_txt">City</td>
                <td width="8%" class="top_txt">County</td>
		<td width="7%" class="top_txt">Gallery</td>
                <td width="13%" class="top_txt center">Status</td>
                <td width="17%" class="top_txt">Manage</td>
            </tr>
	        <?php
      ...
      <tr>
		...
		echo $ev_day."/".$ev_mon."/".$ev_year." - ".$hr.":".$ev_min." ".$objlist->f('event_start_ampm');?></td>
