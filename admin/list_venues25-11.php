	    ...
	    <div class="myevent_left" style="width:1000px;">
          ...
          <tr>
            ...
            <td style="padding: 5px;">
                ...
                <span style="margin:0;"><a href="<?php echo $obj_base_path->base_path(); ?>/event/<?php echo $objlist->f('venue_id');?>" target="_blank" style="color:#000;">Preview</a></span>
            </td>
          </tr>
      <?php } ?>
         <td colspan="7" align="left"><div style="width: 160px; float:right; margin: 0 auto;"><?php $p->show();?></div></td></tr>
             <?php
                }
                else
                {
