...
?>		
		...
		<span class="err" id="err_postal_code" style="color:red;"></span>
              ...
              <tr>
                <td style="padding-left: 18px;"><?php if($_SESSION['langSessId']=='eng'){echo "Password";}elseif($_SESSION['langSessId']=='spn'){ echo "Contrase&#241;a";}?><span style="color:red;">*</span><br /></td>
                <td>
		    ...
		    <input type="submit" name="submit" class="btn1_sudip" value="Save" />
		    <?php }elseif($_SESSION['langSessId']=='spn'){?>
                <input type="submit" name="submit" class="btn1_sudip" value="Guardar" />
                 <?php }?>
		</td>
              </tr>
	...
	<table width="100%" align="center" border="0" cellpadding="4" cellspacing="4" style="border-collapse:separate;">
		...
		<?php if($_SESSION['langSessId']=='eng'){
		    ...
		    echo "Forgot password?";
			 ...
			 echo "¿Has olvidado tu contraseña?";
			 } ?>
			 </a></td>
                <td>
                <input type="password" name="pass_signin" id="pass_signin" class="textbg_grey" style="width: 190px; margin-right: 6px;" value="" />
                </td>
              </tr>
              <tr>
              	<td colspan="2">
