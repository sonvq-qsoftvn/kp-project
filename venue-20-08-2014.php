...
<meta property="og:title" content="<?php if($_SESSION['langSessId']=='eng') { echo htmlentities(stripslashes($obj_venue->f('venue_name'))); } else { echo htmlentities(stripslashes($obj_venue->f('venue_name_sp')));}?>" />

<meta name="title" content="<?php if($_SESSION['langSessId']=='eng') { echo htmlentities(stripslashes($obj_venue->f('venue_name'))); } else { echo htmlentities(stripslashes($obj_venue->f('venue_name_sp')));}?>" />

<meta property="og:url" content="<?php echo $url; ?>" />

<meta property="og:description" content="<?php  if($_SESSION['langSessId']=='eng') { echo htmlentities(stripslashes($obj_venue->f('venue_address').' '.$obj_venue->f('city').', '.$obj_venue->f('st_name').','.$obj_venue->f('venue_short_add_en'))); } else { echo htmlentities(stripslashes($obj_venue->f('venue_address').' '.$obj_venue->f('city').', '.$obj_venue->f('st_name').','.$obj_venue->f('venue_short_add_sp')));}?>" />

<meta name="description" content="<?php  if($_SESSION['langSessId']=='eng') { echo htmlentities(stripslashes($obj_venue->f('venue_address').' '.$obj_venue->f('city').', '.$obj_venue->f('st_name').','.$obj_venue->f('venue_short_add_en'))); } else { echo htmlentities(stripslashes($obj_venue->f('venue_address').' '.$obj_venue->f('city').', '.$obj_venue->f('st_name').','.$obj_venue->f('venue_short_add_sp')));}?>" />
