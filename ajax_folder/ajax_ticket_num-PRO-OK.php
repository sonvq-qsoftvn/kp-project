...
?>		
	    ...
	    echo  $total_of_same_ticket =  number_format($obj_ticket->f('ticket')*($obj_ticket->f('mx_price')+$add_ed_fee_inc_payment + $add_ed_fee_inc_promotion),2,'.',',');
			  ...
			  ?>
                          ...
                          <td><a href="<?php echo $obj_base_path->base_path()."/payment.php?event_id=".$_SESSION['event_id']."&action=del&attempt_id=".$_GET['attempt_id']."&tid=".$obj_ticket->f('cart_id'); ?>">Remove</a></td>
                        </tr>
