	...
	<div class="body_bg">
    	...
    	<div class="container">
        	<div class="left_panel bg" style="width:978px;">
                  <div class="blue_box1" style="width: 976px;"><div class="blue_boxh"><p>Order Completed</p></div></div>
                  <div class="clear"></div>
                          <div class="clear"></div>
				...
				<tr>
                                  <td><strong>Your order no. is : <?php echo $obj_order_details->f('order_no');?></strong></td>
                                </tr>
				<tr>
                                  <td><img src="images/spacer.gif" alt="" width="1" height="9" /></td>
                                </tr>
