...
<?php if($_SESSION['langSessId']=='eng') {?>  US$ <?php }elseif($_SESSION['langSessId']=='spn'){?>EE.UU. $<?php }?> <a href="<?php echo $obj_base_path->base_path()."/payment.php?event_id=".$e_id."&act=us"; ?>"><input type="radio" name="cur" id="" value="" <?php if($_SESSION['pay'] == 'us'){ echo "checked";}?> /></a> 
	...
	<?php }?>
		 ...
		 <li><a href="#"><?php if($_SESSION['langSessId']=='eng') {?>Paypal<?php }elseif($_SESSION['langSessId']=='spn'){?>Paypal<?php }?></a><br/><img src='<?php echo $obj_base_path->base_path(); ?>/images/logo6.gif' width="35" height="19" border="0"/><br/><input name="radiobutton" id="pro" type="radio" value="radiobutton" onClick="pay_type('standard');"/></li>
		 <li><a href="#"><?php if($_SESSION['langSessId']=='eng') {?>Bank Transfer<?php }elseif($_SESSION['langSessId']=='spn'){?>Transferencia bancaria<?php }?></a><br/><img src='<?php echo $obj_base_path->base_path(); ?>/images/logo7.gif' width="40" height="21" border="0"/><br/><input name="radiobutton" id="radiobutton" type="radio" value="radiobutton"/></li>
		 <?php if($_SESSION['pay'] == 'mx'){?>
         <li style="border: 0;"><a href="#"><?php if($_SESSION['langSessId']=='eng') {?>Cash<?php }elseif($_SESSION['langSessId']=='spn'){?>efectivo<?php }?></a><br/><img src='<?php echo $obj_base_path->base_path(); ?>/images/logo8.gif' width="44" height="21" border="0"/><br/><input name="radiobutton" id="radiobutton" type="radio" value="radiobutton"/></li>
         <?php }?>
		 </ul>
		 </div>
		 </div>
	...
	<?php }elseif($_SESSION['langSessId']=='spn'){?>
	Al hacer clic en el bot&oacute;n "Enviar pedido", est&aacute;s aceptando la Política de Compra y Pol'&#237';tica de Privacidad KPasapp.com. Todos los pedidos est&aacute;n sujetos a la aprobaci&oacute;n de los pagos y a la verificaci&oacute;n de direcciones de facturaci&oacute;n. Por favor, p&oacute;ngase en contacto con atenci&oacute;n al cliente si tiene alguna pregunta acerca de su pedido.
	<?php }?>
