        	...
        	<div class="left_panel bg" style="width:978px;">
            	<div class="cheese_box">
					...
					<div style="font: normal 12px/17px Verdana, Arial, Helvetica, sans-serif; padding: 12px 0 0 20px;">
                    	Congratulations! You have successfully reset your password.</div>
                	<div class="clear"></div>
                    ...
                    <div>
	                  <form method="post" action="" enctype="multipart/form-data" name="signin" id="signin" autocomplete = "off">
                    	...
                    	<table width="100%" border="1">
                          <tr>
                            <td width="44%" style="text-align:center;"><input type="text" name="email_cell"  id="email_cell" class="textbg_grey" placeholder="Email address or Cell#" style="width:124px; line-height: 20px; height: 18px;"/></td>
                            <td width="27%"><input type="password" name="pass_signin" placeholder="Password" id="pass_signin" style="width:134px; height: 16px; border-radius:5px;"/></td>
