    	...
    	<div class="container">
        	<div class="left_panel bg" style="width:978px;">
                          ...
                          <div class="clear"></div>
                            <form action="" method="post" enctype="multipart/form-data">
                              <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" style="padding: 24px 0;">
                                ...
                                <tr>
                                  <td>
                                  <div style="text-align:center; color:#06F; font-size:18px;font-weight:bold;margin-top:10px;">
                                  Thank you for your order. </div></td>
                                </tr>
					...
					<td>
						...
						<div class="hot_event7">
							<?php
								...
								$obj_order_details->getOrderDetails($_SESSION['tid']);
					    ...
					    <?php
								...
								?>
								<p><?php echo date("l, m, d, Y",strtotime($date))." ".$start;?> - <?php if($obj_order_details->f('sdate') != $obj_order_details->f('edate')){ echo date("l, m, d, Y",strtotime($edate))." ";} echo $end;?></p>
				...
				<tr>
					<td>
						<p>
		You will receive shortly an email confirmation with your electronic confirmation. 
...
We look forward to seeing you at <strong><?php
						  if($_SESSION['langSessId']=='eng') {
										echo $obj_ticket->f('ticket_name_en');
									  }
									  elseif($_SESSION['langSessId']=='spn')
									  ...
									  ?></strong>!<br>
<a href="">Click Here</a> to return to KPasapp home page</p>
					</td>
				</tr>
                               </table>
                            </form>
