...
function AgendaView(element, calendar, viewName) {
	...
	function buildSkeleton() {
		...
		if (showWeekNumbers) {
			...
			s += "<th class='fc-agenda-axis " + headerClass + "' style='display:none'>&nbsp;</th>";
		}

		for (i=0; i<colCnt; i++) {
			s +=
				"<th class='fc- fc-col" + i + ' ' + headerClass + "' style='border:1px solid #aed0ea; width: 87px;'/>"; // fc- needed for setDayID
		}
		s +=
		...
		for (i=0; i<colCnt; i++) {
			s +=
				"<td class='fc- fc-col" + i + ' ' + contentClass + "' style='width: 87px;'>" + // fc- needed for setDayID
				"<div style='height: auto; min-height:525px; overflow: hidden; margin: display: inline-block; 8px auto;'>" +
