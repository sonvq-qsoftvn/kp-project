...
<div id="maindiv">
	...
	<div class="body_bg">
    	...
    	<div class="container">
		 ...
		 <div class="blue_box1">
                   <div class="blue_boxh"><a href="<?php echo $obj_base_path->base_path(); ?>/about/kpasapp" style="text-decoration:none;"><p><?php echo About;?></p></a></div>
		   <?php if($page_id!="about-baja-sur"){?>
                   <div class="blue_boxr">
                       <ul>
