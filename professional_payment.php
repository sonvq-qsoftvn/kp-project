...
if(isset($_POST['hid_edit']))
{
	...
	if($faq->num_rows()>0){	
		...
		$add_pay->add_user_payment_final($_SESSION['ses_admin_id']);
	}
...
<title>proffessional payment</title>
    <meta charset="utf-8">
        <meta name="title" content="proffessional_payment">
        <meta name="keywords" content="proffessional_payment">
        <meta name="description" content="proffessional payment">
