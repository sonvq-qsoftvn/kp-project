    	...
    	<div class="container">
        	<div class="left_panel bg" style="width:978px;">
            	<div class="cheese_box">
                	...
                	<div class="clear"></div>
					<div style="font:normal 12px/17px Verdana, Arial, Helvetica,sans-serif;font-weight:bold;padding: 12px 0 0 20px;">We have successfully verified your identity.</div>
					<div style="font: normal 12px/17px Verdana, Arial, Helvetica, sans-serif; padding: 12px 0 0 20px;">Enter a New Password for your KPasapp account</div>
                	<div class="clear"></div>
					...
					<div class="clear"></div>
                      ...
                      <form method="post" action="" enctype="multipart/form-data" name="reset_pwd" id="reset_pwd" autocomplete = "off" onsubmit="return resetPassword();">
                        ...
                        <table width="100%" align="center" border="0" cellpadding="4" cellspacing="4" style="border-collapse:separate;">
                          <tr>
                            <td width="36%" style="padding-left: 18px;">New Password <span style="color:red;">*</span></td>
                          ...
                          <tr>
                            <td style="padding-left: 18px;">Retype the New Password <span style="color:red;">*</span></td>
