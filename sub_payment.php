...
if( isset($_POST['hid_sign']) )
{
	...
	else
	{
		...
		header("Location:".$obj_base_path->base_path()."/sub_payment/".$_GET['event_id']."/sub_id/".$sub_id);
		exit;
	}
}
//echo $_SESSION['err'];
...
{	
	...
	else
	{
		...
		header("Location:".$obj_base_path->base_path()."/sub_payment/".$pay_eid."/sub_id/".$sub_id);
		exit;
	}
...
if($_GET['action'] == 'del' && $_GET['tid'] !=''){
	...
	header("location: ".$obj_base_path->base_path()."/sub_payment/".$e_id."/sub_id/".$sub_id);
	exit;
}
...
function change(eid,type,sub_id) {
  //alert("hi"+eid+type);
  window.location.href='<?php echo $obj_base_path->base_path()?>/sub_payment.php?event_id='+eid+'&sub_id='+sub_id+'&act='+type+'';
}
</script>
...
<?php if($_SESSION['langSessId']=='eng') {?>  MX Pesos <?php }elseif($_SESSION['langSessId']=='spn'){?> Pesos MX <?php }?> <!--<a href="<?php //echo $obj_base_path->base_path()."/payment.php?act=mx"; ?>"><input type="radio" name="cur" id="" value="" <?php //if($_SESSION['pay'] == 'mx'){ echo "checked";}?> /></a>-->
 ...
 <?php if($_SESSION['langSessId']=='eng') {?>  US$ <?php }elseif($_SESSION['langSessId']=='spn'){?>EE.UU. $<?php }?> <!--<a href="<?php //echo $obj_base_path->base_path()."/payment.php?act=us"; ?>"><input type="radio" name="cur" id="" value="" <?php //if($_SESSION['pay'] == 'us'){ echo "checked";}?> /></a> -->
					...
					{
					?>
<?php if($_SESSION['langSessId']=='eng') {?>  MX Pesos <?php }elseif($_SESSION['langSessId']=='spn'){?> Pesos MX <?php }?> <input type="radio" name="cur" onclick="change(<?php echo $e_id;?>,'mx',<?php echo $sub_id;?>);" id="" value="" <?php if($_SESSION['pay'] == 'mx'){ echo "checked";}?> />

<?php if($_SESSION['langSessId']=='eng') {?>  US$ <?php }elseif($_SESSION['langSessId']=='spn'){?>EE.UU. $<?php }?> <input type="radio" name="cur" onclick="change(<?php echo $e_id;?>,'us',<?php echo $sub_id;?>);" id="" value="" <?php if($_SESSION['pay'] == 'us'){ echo "checked";}?> />
					 ...
					 <div  id="checkout_frm">
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="event_review">
                        ...
                        <tr>
						  ...
						  ?></td>
                          <td><a href="<?php echo $obj_base_path->base_path()."/sub_payment.php?event_id=".$e_id."&sub_id=".$sub_id."&action=del&tid=".$obj_ticket->f('cart_id'); ?>">Remove</a></td>
                        </tr>
