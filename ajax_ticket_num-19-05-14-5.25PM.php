...
?>		
			  ...
			  ?>
			    ...
			    ?>
                          ...
                          <td><?php 
						  if($_SESSION['pay'] == 'us'){
						  	echo $total = number_format($obj_ticket->f('ticket')*($obj_ticket->f('us_price')+$add_ed_fee_inc_payment + $add_ed_fee_inc_promotion),2,'.',',');
				                        $_SESSION['total'] = $total;
				                        $_SESSION['total_amnt_tckt'] = $total;
						  }elseif($_SESSION['pay'] == 'mx'){
						  	echo $total = number_format($obj_ticket->f('ticket')*($obj_ticket->f('mx_price')+$add_ed_fee_inc_payment + $add_ed_fee_inc_promotion),2,'.',',');
							$_SESSION['total'] = $total;
							$_SESSION['total_amnt_tckt'] = $total;
						  }
						  ?></td>
