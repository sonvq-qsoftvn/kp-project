			...
			<tbody><tr>
			  <td valign="top" bgcolor="#FFFFFF" style="font-size:12px;color:#444444;line-height:150%;font-family:trebuchet ms;border-left:1px solid #e0e0e0;border-right:1px solid #e0e0e0;border-bottom:1px solid #e0e0e0">
			    ...
			    <p dir="ltr"><strong id="docs-internal-guid-2a53dcf4-cf71-4930-5290-27dd9f591481">Gracias por unirse a kpasapp.com !</strong><br><br>
				  ...
				  <p dir="ltr">Una vez que su login se ha activado, puede comenzar utilizando su cuenta KPasapp y configurar su perfil para aprovechar al máximo las numerosas características de KPasapp.com, su pasaporte para todos los eventos de Baja California Sur.</p>
				  <p dir="ltr">Con una cálida bienvenida.<br>
					  <br>
...
//send email
if($user_id>0)
$obj_sendmail->merchant_login_mail($rem_password,$email,$user_id,$body,$subject);	
...
if($language=='English') 
{
	...
	if($phone==""){
		$_SESSION['user_msg'] = "<span style='font:normal 16px/20px Arial,Helvetica,sans-serif; font-style:italic;'>Un enlace de activación ha sido enviado a  ".$email." .<br>Por favor, consulta su correo electrónico y haga clic en el enlace para activar su cuenta KPasapp.</span><br>
	<span style='font:normal 12px/20px Arial,Helvetica,sans-serif;'>Si no recibe el e-mail de activación en 5 minutos por favor revise su carpeta de spam o basura para asegurar entrega segura. Si usted piensa que ha habido un problema con el envío del correo electrónico, por favor contáctenos a info@kpasapp.com.</span>";	}
	else{
		$_SESSION['user_msg'] = "<span style='font:normal 16px/20px Arial,Helvetica,sans-serif; font-style:italic;'>Un enlace de activación ha sido enviado a  ".$email." (or ".$phone.").<br>Por favor, consulta su correo electrónico (SMS) y haga clic en el enlace para activar su cuenta KPasapp.</span><br>
	<span style='font:normal 12px/20px Arial,Helvetica,sans-serif;'>Si no recibe el e-mail de activación en 5 minutos por favor revise su carpeta de spam o basura para asegurar entrega segura. Si usted piensa que ha habido un problema con el envío del correo electrónico, por favor contáctenos a info@kpasapp.com.</span>";
	}
}
