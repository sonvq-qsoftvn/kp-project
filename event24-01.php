...
if(isset($_POST['action']) && $_POST['action'] == 'cart')	
{
	...
	echo $_POST['frm_us_price'.$i]."<br>";*/
		if($_POST['frm_ticket'.$i] != ''){
			$cid[] = $obj_cart->add_to_cart($_POST['frm_event_id'],$_POST['frm_multi_id'],$_POST['frm_ticket'.$i],$_POST['frm_mx_price'.$i],$_POST['frm_us_price'.$i],$unique,$_POST['frm_us_tid'.$i],$_POST['frm_payment'],$_POST['frm_date'],$_POST['frm_start'],$_POST['frm_end']);
		}
	}
...
<meta property="og:image" content="<?php echo $obj_base_path->base_path()."/images/KPasapp_logo.png"; ?>">
...
function setHover1(val,setDateTime,multi_id,event_id,dd,st,et)
{
	//alert(multi_id);
	//alert(event_id);
	//alert(setDateTime);
...
<!--                	<span style="float: right; margin: 0 auto; padding: 0; width: 160px;">
	...
	<?php
			...
			<input type="hidden" name="is_multi" id="is_multi" value="<?php echo $objEvent->f('identical_function');?>" />
						...
						<div class="clear"></div>
                        <div class="like_box" style=" margin: 0 0 10px 0; width: 333px;">
...
<br><br>
<a rel="nofollow" href="https://twitter.com/share?original_referer=<?=$shareurl?>" class="twitter-share-button" target="_blank" data-count="none" title="Share on Twitter" alt="Share on Twitter"><img src="<?php echo $obj_base_path->base_path(); ?>/images/twitter.png" /></a>
<br><br>
...
<div class="g-plus" data-action="share" style="text-indent: 0px; margin: 0px; padding: 0px; background: none repeat scroll 0% 0% transparent; border-style: none; float: none; line-height: normal; font-size: 1px; vertical-align: baseline; display: inline-block; width: 180px; height: 20px;"></div>
