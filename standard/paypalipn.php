...
function ipnSuccess() {
	...
	//
	writeLog("UPDATE  ".SITE_PREFIX."cart_detail SET paid_status='1'   WHERE	 cart_detail_id='".$custom."' ");
	$sql=mysql_query("UPDATE  ".SITE_PREFIX."cart_detail SET paid_status='1'   WHERE	 cart_detail_id='".$custom."' ");
	//$rs=mysql_query($sql);
