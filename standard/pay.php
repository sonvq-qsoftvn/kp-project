<?php
	...
	$customArray = array($_POST['event_id'],$_POST['ticket'],$_POST['payment'],$_POST['ticket_id'],$_POST['multi_id'],$_SESSION['ses_admin_id'],$_POST['cart_id'],$_POST['unique_id']);
...
<form  action="https://www.paypal.com/cgi-bin/webscr" method="post" name="_xclick" id="frm">
<table width="675" cellpadding="2" cellspacing="2" border="0" align="center">
<tr><td>											
<input type="hidden" name="cmd" value="_xclick">
<input type="hidden" name="rm" value="2">
<input type="hidden" name="business" value="main@kpasapp.com">
...
<input type="hidden" name="return" value="<?php echo $obj_base_path->base_path(); ?>/success.php">
<!--<input type="hidden" name="return" value="<?php //echo $obj_base_path->base_path(); ?>/payment-complete.php">-->
<input type="hidden" name="cancel_return" value="<?php echo $obj_base_path->base_path(); ?>/payment/<?php echo $_POST['event_id'];?>/attempt/0">
