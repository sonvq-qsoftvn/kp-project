...
/*-------------------------------------------FOR FEES START--------------------------------------------*/
	...
	if($objEvent->f('include_payment') == 1){
		$add_ed_fee_inc_payment_mx = number_format($objfee->f('ticket_min_mx') + (($objfee->f('ticket_percent_incl')/100)*$_POST['frm_mx_price'.$i]),2,'.',',');
	}
	else  
	{
	...
	if($objEvent->f('include_promotion') == 1){
		$add_ed_fee_inc_promotion_mx = number_format($objfee->f('promo_fee_min_mx') + (($objfee->f('promo_percent_incl')/100)*$_POST['frm_mx_price'.$i]),2,'.',',');
	}
	else
	{
	...
	// For Us ===================    
	if($objEvent->f('include_payment') == 1){
	       $add_ed_fee_inc_payment_us = number_format($objfee->f('ticket_min_us') + (($objfee->f('ticket_percent_incl')/100)*$_POST['frm_us_price'.$i]),2,'.',',');
	}
	else
	{
	...
	if($objEvent->f('include_promotion') == 1){
	        $add_ed_fee_inc_promotion_us =  number_format($objfee->f('promo_fee_min_us') + (($objfee->f('promo_percent_incl')/100)*$_POST['frm_us_price'.$i]),2,'.',',');
	}
	else
	{
