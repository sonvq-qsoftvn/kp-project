...
//this will only work if fetch client is browser only.
 ...
 if (!empty($lang2) && $res != 'Unknown' && $_SESSION['langSessId'] == '') {
    if ($lang2 == 'en') {
        header("location: " . $obj_base_path->base_path() . "/en/event-list");
        exit;
    } elseif (trim($lang2) == 'es') {

        header("location: " . $obj_base_path->base_path() . "/es/event-list");
        exit;
    } else {
            ...
            <?php           
                ...
                <div class="party_box" style="width: 678px;">
                    ...
                    ?>
                            ...
                            <div class="box2">                            
                                <meta itemprop="url" content="<?php echo $obj_base_path->base_path(); ?>/eventPage/<?php echo $eachVal['id'];?>/<?php echo $objmul_id->f('multi_id');?>" />
                                <h2 class="heading" style="padding-right: 0;">
                                    <a href="<?php echo $obj_base_path->base_path(); ?>/eventPage/<?php echo $eachVal['id'];?>/<?php echo $objmul_id->f('multi_id');?>" >
                                        <span itemprop="name">
