...
if(isset($_POST['hid_edit']))
{
	...
	//echo $language."fsdf".$lang; 
		if($language != $lang){
			//echo "hii"; exit;
			$_SESSION['lang_change'] = 1;
			/*unset($_SESSION['langSessId']);
			if($language == 'English'){
...
function save_password(param)
{
	...
	//google MD5 encryption use here -[google]//
        ...
        <div class="cheese_box">
            ...
            <div class="Tchai_box1" style="width: 570px; margin: 18px auto; border-left: 0x solid #CCCCCC; float: left;">
                ...
                <table width="100%" align="center" border="0" cellpadding="4" cellspacing="4" style="border-collapse:separate;">
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <span style="margin-right:1px;"><a href="<?php echo $obj_base_path->base_path(); ?>/about/<?php echo $obj_page->f('page_link')?>" target="_blank" style="text-decoration:underline;"><?php echo Personal;?></a>&nbsp;&nbsp;<input type="radio" name="account_type" id="pincode1" checked="checked" value="0" onclick="redirectPage(0)" /></span> <?php echo OR_TXT;?>
              ...
              <tr>
                ...
                <option value="English" <?php if($obj->f('language')=="English"){?> selected="selected"<?php } ?>><?php echo "English";?></option>
                <option value="Spanish" <?php if($obj->f('language')=="Spanish"){?> selected="selected"<?php } ?>><?php echo "espa&#241;ol";?></option>
                </select>
              ...
              <tr>
                <td colspan="2" style="text-align:left; padding-left: 15px;"><input type="button" name="submit1" id="submit1" value="<?php echo NEXT;?>" style="cursor:pointer;" class="event_save" onclick="saveNexit('next');" />
                <span style="margin-left:10px;"><input type="button" name="submit1" id="submit1" value="<?php echo SAVE_EXIT;?>" style=" cursor:pointer;"  class="event_save" onclick="saveNexit('exit');" /></span></td>
              </tr>
              <tr><td>&nbsp;</td></tr>
            </table>
              </form>
