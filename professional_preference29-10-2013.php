	       ...
	       <div class="left_panel bg" style="width:978px;">
                ...
                <div style="width: 976px; float: none; margin: 0 auto;">                    
                  ...
                  <div style=" float:left; width:550px;">  <table width="100%" align="left" border="0" cellpadding="4" cellspacing="4" class="prefer_box">
					...
					<td width="64%"><input type="text" name="facebook_page_text" id="facebook_page_text" class="textbg_grey" style="width:283px;" value="<?php echo $obj_check_add_social->f('facebook_page_text');?>" onBlur="isUrl('facebook_page_text')" /><input type="checkbox" name="facebook_page" id="facebook_page" value="1" <?php if($obj_check_add_social->num_rows()){ if($obj_check_add_social->f('facebook_page')==1){?> checked="checked" <?php } }else{ echo 'checked="checked"';  } ?>/></td>
                  </tr>
					<tr>
                    <td><?php echo TWITTER_ACCOUNT;?></td>
					<td><input type="text" name="twitter_account_text" id="twitter_account_text" class="textbg_grey" style="width: 283px;" value="<?php echo $obj_check_add_social->f('twitter_account_text');?>" onBlur="isUrl('twitter_account_text')" /><input type="checkbox" name="twitter_account" id="twitter_account" value="1" <?php if($obj_check_add_social->num_rows()){ if($obj_check_add_social->f('twitter_account')==1){?> checked="checked" <?php } }else{ echo 'checked="checked"';  } ?>/></td>
                  </tr>
				 <tr>
                    <td><?php echo GOOGLE_ACCOUNT;?></td>
					<td><input type="text" name="google_account_text" id="google_account_text" class="textbg_grey" style="width: 283px;"  value="<?php echo $obj_check_add_social->f('google_account_text');?>" onBlur="isUrl('google_account_text')" /><input type="checkbox" name="google_account" id="google_account" value="1" <?php if($obj_check_add_social->num_rows()){ if($obj_check_add_social->f('google_account')==1){?> checked="checked" <?php } }else{ echo 'checked="checked"';  } ?>/></td>
                  </tr>
                       </table></td>
					 </tr>
					<tr>
