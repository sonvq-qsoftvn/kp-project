                 ...
                 <tr>
                   <td><table width="100%" align="left" border="0" cellpadding="0" cellspacing="0" class="prefer_pro1">
                      ...
                      <tr>
                        ...
                        <td>
                            <span style="margin-right:1px;"><a href="<?php echo $obj_base_path->base_path(); ?>/about/<?php echo $obj_page->f('page_link')?>" target="_blank" style="text-decoration:underline;"><?php echo Personal;?></a>&nbsp;&nbsp;<input type="radio" name="account_type" id="pincode1"  value="0"  onclick="displayOther()" /></span> <?php echo OR_TXT;?>
                      ...
                      <tr>
                        ...
                        <td><input type="text" name="us_phone" id="us_phone" class="textbg_grey" style="width: 190px; margin-right: 6px;" value="<?php echo $obj->f('us_phone')?>" /></td>
                      </tr>
                      
                      <tr>
                        <td><?php echo NEXTEL;?></td>
                        <td>
                        <input type="text" name="nextel" id="nextel" class="textbg_grey" style="width: 190px; margin-right: 6px;" value="<?php echo $obj->f('nextel')?>" />
                        </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <?php echo ENGL;?><!--English-->
                        </option>
                        <option value="Spanish" <?php if($obj->f('language')=="Spanish"){?> selected="selected"<?php } ?>>
                        <?php echo SPAL;?><!--Spanish-->
                        </option>
                        </select>
                         <span class="err" id="err_lname"></span></td>
                      </tr>
                      <tr>
                        <td><?php echo STATE;?><span style="color:red; display:none;" id="star1">*</span></td>
                        <td>
                      ...
                      <tr>
                        <td><?php echo COUNTY;?><span style="color:red; display:none;" id="star2">*</span></td>
                        <td>
                      ...
                      <tr>
                        <td><?php echo CITY;?><span style="color:red; display:none;" id="star3">*</span></td>
                        <td>
                   ...
                   <table width="100%" align="left" border="0" cellpadding="4" cellspacing="0" class="prefer_pro">
                    ...
                    <tr>
                    <td><input type="hidden" name="bus_language" id="bus_language"  /><?php echo STATE;?><span style="color:red; display:none;" id="star1">*</span></td>
                    <td>
                   ...
                   <tr>
                    ...
                    <td colspan="2" style="text-align:left; padding-left: 109px;"><input type="button" name="submit1" id="submit1" value="<?php echo NEXT;?>" style="cursor:pointer;" class="event_save" onclick="redirectPage(1)" />
                    <span style="margin-left:10px;"><input type="button" name="submit1" id="submit1" value="<?php echo SAVE_EXIT;?>" style=" cursor:pointer;"  class="event_save"  onclick="redirectPage(2)" /></span>
