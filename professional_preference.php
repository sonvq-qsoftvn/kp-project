...
if( isset($_POST['hid_reset_password']) )
{
	...
	if($obj_check_add->num_rows()){
	 ...
	 if($_POST['set_param']==1){
		//redirect
		header("Location:".$obj_base_path->base_path()."/professional_payment");
		exit;
	}
	else{
		header("Location:".$obj_base_path->base_path()."");
...
<title>proffessional preference</title>
    <meta charset="utf-8">
        <meta name="title" content="proffessional_preference">
        <meta name="keywords" content="proffessional_preference">
        <meta name="description" content="proffessional_preference">
    	...
    	<div class="container">
	       <div class="left_panel bg" style="width:978px;">
                <div class="blue_box1" style="width:976px;">
                 <div class="blue_boxh">
                    <p style="font-size: 28px; line-height: 30px;"><?php echo MYKPASAPP."<br/><span>".PROFPRO."</span>";?></p>
                 </div>
                 <div class="blue_boxr" style="width: 754px;">
                   <ul>
                       <li><a href="<?php echo $obj_base_path->base_path(); ?>/professional_userprofile"><?php echo ACCOUNT?></a></li>
                       <li><a href="<?php echo $obj_base_path->base_path(); ?>/professional_preference" class="here"><?php echo PREFERENCES?></a></li>
                       <li><a href="<?php echo $obj_base_path->base_path(); ?>/professional_payment"><?php echo PAYMENT?></a></li>
                   </ul>
                 </div>
                </div>
                <div class="clear"></div>                
                <div style="width: 976px; float: none; margin: 0 auto;">                    
                  ...
                  <div style=" float:left; width:550px;">  <table width="100%" align="left" border="0" cellpadding="4" cellspacing="4" class="prefer_box">
					<tr>
					...
					<td width="64%">https://www.facebook.com/<input type="text" name="facebook_page_text" id="facebook_page_text" class="textbg_grey" placeholder="username only" style="width:100px;" value="<?php echo $obj_check_add_social->f('facebook_page_text');?>"  /><input type="checkbox" name="facebook_page" id="facebook_page" value="1" <?php if($obj_check_add_social->num_rows()){ if($obj_check_add_social->f('facebook_page')==1){?> checked="checked" <?php } }else{ echo 'checked="checked"';  } ?>/></td>
                  </tr>
					<tr>
                    <td><?php echo TWITTER_ACCOUNT;?></td>
					<td>https://twitter.com/<input type="text" name="twitter_account_text" id="twitter_account_text" class="textbg_grey" style="width: 152px;" placeholder="username only" value="<?php echo $obj_check_add_social->f('twitter_account_text');?>"  /><input type="checkbox" name="twitter_account" id="twitter_account" value="1" <?php if($obj_check_add_social->num_rows()){ if($obj_check_add_social->f('twitter_account')==1){?> checked="checked" <?php } }else{ echo 'checked="checked"';  } ?>/></td>
                  </tr>
				 <tr>
                    <td><?php echo GOOGLE_ACCOUNT;?></td>
					<td>https://plus.google.com/<input type="text" name="google_account_text" id="google_account_text" class="textbg_grey" style="width: 115px;" placeholder="username only"  value="<?php echo $obj_check_add_social->f('google_account_text');?>" /><input type="checkbox" name="google_account" id="google_account" value="1" <?php if($obj_check_add_social->num_rows()){ if($obj_check_add_social->f('google_account')==1){?> checked="checked" <?php } }else{ echo 'checked="checked"';  } ?>/></td>
                  </tr>
                       </table></td>
					 </tr>
					<tr>
					...
					<tr>
                      ...
                      <tr>
                        <td colspan="2"><input type="checkbox" name="send_notification_to_phone" id="send_notification_to_phone" value="1" <?php if($obj_check_add->num_rows()){ if($obj_check_add->f('send_notification_to_phone')==1){?> checked="checked" <?php } }else{ echo 'checked="checked"';  } ?>/> <?php echo CELL_PHONE_PER.' '.$obj_user->f('mobile');?></td>
                      </tr>
                      <tr>
                   ...
                   <div style=" float:left; width:400px;">   <table width="100%" align="right" border="0" cellpadding="4" cellspacing="4" class="prefer_box2">
                     ...
                     <tr>
                        <td style="padding-left: 28px;" colspan="2">
						<span style="margin:0 0 5px 10px; font: bold 12px/18px Arial, Helvetica, sans-serif; cursor:pointer;"><input type="checkbox" name="checkbox" value="checkbox" style="padding: 0; margin: 0;" onClick="SelectAll()" /> <?php echo ALL_COUNTY;?></span>
						<div class="clear"></div>
                      ...
                      <tr>
                      <td>
                      <div style="margin: 0 0 0 15px; float: right; width:400px;">
					...
					<div style="width: auto; margin: -35px auto 0 545px; float: left;"><input type="button" name="submit1" id="submit1" value="<?php echo NEXT;?>" class="event_save" style="cursor:pointer; float: left;" onClick="redirectPage(1)" /> <input type="button" name="submit1" id="submit1" value="<?php echo SAVE_EXIT;?>" class="event_save" style="cursor:pointer; float: right;" onClick="redirectPage(2)" /></div>
                </form>                    
                </div>
                <div class="clear"></div>
           </div>
