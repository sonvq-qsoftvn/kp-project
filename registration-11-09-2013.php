        	...
        	<div class="left_panel bg" style="width:978px;">
            	<div class="cheese_box">
					...
					<div style="width: 535px; float: left; margin: 0 auto 0 18px;">
						<div style="width: 120px; float: left; margin: 10px auto 0 3px;"><h1 style="font: normal 22px/20px Arial, Helvetica, sans-serif; color: #000000; padding: 0; margin: 0;">Sign up with</h1></div>
                    ...
                    <div style="width: 260px; float: left; margin: 0 0 0 21px;">
                    	<h1 style="font: normal 22px/22px Arial, Helvetica, sans-serif; padding: 0; margin: 0; color: #000000;">OR</h1>
                    </div> 
					<div class="clear"></div>
                      ...
                      <form method="post" action="" enctype="multipart/form-data" name="contact" id="contact" autocomplete = "off">
                        <table width="100%" align="center" border="0" cellpadding="4" cellspacing="4" style="border-collapse:separate;">
                          <tr>
                            <td style="padding-left: 18px;">Account Type:</td>
                            <td>
                                <span style="margin-right:1px;">Personal&nbsp;&nbsp;<input type="radio" name="account_type" id="pincode1" checked="checked" value="0"  /></span> or
                                <span style="margin-left:10px;">Professional&nbsp;&nbsp;<input type="radio" name="account_type" id="pincode2" value="1"  /></span>                            </td>
                          </tr>
                          <tr>
                            <td width="18%" style="padding-left: 18px;">First Name <span style="color:red;">*</span></td>
                          ...
                          <tr>
                            <td style="padding-left: 18px;">Last Name <span style="color:red;">*</span></td>
                          ...
                          <tr>
                            <td style="padding-left: 18px;">Email address 
                          ...
                          <tr>
                            <td style="padding-left: 18px;">Cell phone #</td>
                            <td><input type="text" name="phone" id="phone" class="textbg_grey" style="width: 190px;"/></td>
                          </tr>
                          <tr>
                            <td style="padding-left: 18px;">Language</td>
                            <td style="padding: 4px 0 0 7px;">
                                <select name="language" id="language" class="textbg_grey" style="width: 199px;">
                                    ...
                                    <option value="Spanish" <?php if($_SESSION['langSessId']=="spn"){?> selected="selected" <?php } ?>>Spanish</option>
                                </select>
                             </td>
                          </tr>
                          <tr>
                            ...
                            <td style="padding: 4px 0 0 7px;">
                                ...
                                ?>
                                    <option value="<?php echo $obj->f('id');?>" <?php if($_SESSION['langSessId']=="spn" && $obj->f('id')==138){ echo $sel; } if($_SESSION['langSessId']=="eng" && $obj->f('id')==226){ echo $sel; } ?>><?php echo $obj->f('printable_name')?></option>
                                <?php
                                }
                                ?>
                                </select>
                          ...
                          <tr>
                            <td style="padding-left: 18px;">Password <img src="<?php echo $obj_base_path->base_path(); ?>/images/question3_mark.gif " border="0"  style="margin: 0 5px;" /></td>
                          ...
                          <tr>
                            <td style="padding-left: 18px;">Confirm Password <span style="color:red;">*</span></td>
                          ...
                          <tr>
                            <td style="padding-left: 18px;"><a href="#" style="color:#00F;">Privacy & Terms</a></td>
                			<td>&nbsp;</td>
                          </tr>
                          <tr>
                            <td colspan="2" style="text-align:left; padding-left: 15px;">
                            	By creating my KPasapp account, I agree to the KPasapp Terms of Service,<br />KPasapp Privacy Policy and Communications Terms.
                            </td>
                          </tr>
                          <tr>
						    <td colspan="2" style="text-align:left; padding-left: 15px;"><input type="submit" name="submit1" id="submit1" value="Create Account" class="event_save" style="cursor:pointer;"/></td>
                          </tr>
                        </table>
                      </form>
                    </div>
