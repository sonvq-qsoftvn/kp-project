...
<?php //}
		...
		$sumticket=array_sum($ticket_arr);   // create used before but  not  required now.
...
$tid = $obj->add_order_TNS($event_name,$item_number,$txnResponseCodeDesc,$cent_amount,$currency,$receiptNo,$receiver_email,$payer_email,$new_event_id,$ticket,'CC',$new_ticket_id,$multi_id,$user_id,$cart_id,$cart_id,$unique_id); //order_info=order_id=$cart_id
