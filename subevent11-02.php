...
-->                          <!--<div id="map" style="width:323px; height:325px; font-family: arial; font-size: 12px; color: #313E61; text-align: center; background-color:#FFFFFF;"></div>-->    
			...
			<input type="hidden" name="is_multi" id="is_multi" value="<?php echo $objEvent->f('identical_function');?>" />
					...
					$count=1;
                              ...
                              <tr>
                                <td width="10%">
                                    <div class="dropdown25"><select name="ticket_num" id="ticket_num<?php echo $count;?>" onchange="addtocart(<?php echo $count;?>,<?php echo $obj_sub_ticket->f('price_mx');?>,<?php echo $obj_sub_ticket->f('price_us');?>,<?php echo $obj_sub_ticket->f('ticket_id');?>,<?php echo $event_id;?>);">
