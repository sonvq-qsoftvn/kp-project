...
function booking_appointment(rownum,booking_date)
{
			...
			if (e == 0) {
				...
				var url = '<?php echo BASE_URL.'appointments/saveBooking'; ?>';
					$.ajax({
							type: 'POST',
							url: url,
							data: {uid:uid,clinic_id:clinic_id,msg:msg,rownum:rownum,booking_date:booking_date},
							success:function(result){
													alert(result);
													}
							});
...
<div id="addanappointment" class="well">
    ...
    <form name="complete_booking" id="complete_booking" action="" method="post">
	   ...
	   <input type="hidden" name="book_user_type" id="book_user_type" readonly="true" value="<?php echo $this->Session->read('reid_user_type'); ?>" />
		<div class="code-b">
...
<div id="rescheduleappointment" class="well">
	<div class="fade_cont">
        ...
        <div class="reschedule_form">
            ...
            <div class="code-b"><img src="images/code.png" /><span class="re-mic"><img src="images/mic.png"/><img src="images/ref.png"/></span></div>
            <div class="code-in">
