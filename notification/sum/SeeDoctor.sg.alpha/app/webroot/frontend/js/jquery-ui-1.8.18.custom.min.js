...
(function($, undefined) {
    ...
    $.extend(Datepicker.prototype, {
        ...
        _generateHTML: function(a) {
            ...
            var path = 'http://www.phppowerhousedemo.com/webroot/team5/SeeDoctor.sg.alpha/frontend/';
            q = f ? this.formatDate(q, this._daylightSavingAdjust(new Date(o, n - i, 1)), this._getFormatConfig(a)) : q;
            var r = this._canAdjustMonth(a, -1, o, n) ? '<a href="javascript:void(0)" class="left_arrow ui-corner-all" onclick="DP_jQuery_' + dpuuid + ".datepicker._adjustDate('#" + a.id + "', -" + i + ", 'M');\"" + ' title="' + q + '"><span class="ui-icon ui-icon-circle-triangle-' + (c ? "e" : "w") + '"><img src="'+path+'images/monthly_left_arrow.png" alt="' + q + '" />' + '' + "</span></a>" : e ? "" : '<a class="left_arrow ui-corner-all ui-state-disabled" title="' + q + '"><span class="ui-icon ui-icon-circle-triangle-' + (c ? "e" : "w") + '"><img src="'+path+'images/monthly_left_arrow.png" alt="' + q + '" />' + '' + "</span></a>",
                s = this._get(a, "nextText");
            s = f ? this.formatDate(s, this._daylightSavingAdjust(new Date(o, n + i, 1)), this._getFormatConfig(a)) : s;
            var t = this._canAdjustMonth(a, 1, o, n) ? '<a href="javascript:void(0)" class="right_arrow ui-corner-all" onclick="DP_jQuery_' + dpuuid + ".datepicker._adjustDate('#" + a.id + "', +" + i + ", 'M');\"" + ' title="' + s + '"><span class="ui-icon ui-icon-circle-triangle-' + (c ? "w" : "e") + '"><img src="'+path+'images/monthly_right_arrow.png" alt="' + s + '">' + '' + "</span></a>" : e ? "" : '<a class="right_arrow ui-corner-all ui-state-disabled" title="' + s + '"><span class="ui-icon ui-icon-circle-triangle-' + (c ? "w" : "e") + '"><img src="'+path+'images/monthly_right_arrow.png" alt="' + s + '">' + '' + "</span></a>",
            ...
            for (var L = 0; L < g[0]; L++) {
                ...
                for (var N = 0; N < g[1]; N++) {
                    ...
                    Q += '<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix ' + P + '">' + this._generateMonthYearHeader(a, n, o, l, m, L > 0 || N > 0, D, E) + ' <div class="monthly_appointment_page"> ' +(/all|left/.test(P) && L == 0 ? c ? t : r : "") + (/all|right/.test(P) && L == 0 ? c ? r : t : "") + ' </div></div> ' + '</div><div class="monthly_appointment_table"><table class="monthly_appointment_info ui-datepicker-calendar"><thead>' + "<tr class='monthly_appointment_info_title'>";
                    var R = z ? '<td class="coll">' + this._get(a, "weekHeader") + "</td>" : "";
                    for (var S = 0; S < 7; S++) {
                        var T = (S + y) % 7;
                        R += "<td class='coll' >" + A[T] + "</td>"
                    }
                    Q += R + "</tr></thead><tbody>";
                    ...
                    for (var Z = 0; Z < X; Z++) {
                        Q += "<tr class='monthly_appointment_info_cont'>";
                        var _ = z ? '<td class="ui-datepicker-week-col">' + this._get(a, "calculateWeek")(Y) + "</td>" : "";
                        for (var S = 0; S < 7; S++) {
                            var ba = F ? F.apply(a.input ? a.input[0] : null, [Y]) : [!0, ""],
                                bb = Y.getMonth() != n,
                                bc = bb && !H || !ba[0] || l && Y < l || m && Y > m;
                            _ += '<td class="coll' + ((S + y + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (bb ? " ui-datepicker-other-month" : "") + (Y.getTime() == O.getTime() && n == a.selectedMonth && a._keyEvent || J.getTime() == Y.getTime() && J.getTime() == O.getTime() ? " " + this._dayOverClass : "") + (bc ? " " + this._unselectableClass + " ui-state-disabled g_back" : "") + (bb && !G ? "" : " " + ba[1] + (Y.getTime() == k.getTime() ? " " + this._currentClass : "") + (Y.getTime() == b.getTime() ? " ui-datepicker-today" : "")) + '"' + ((!bb || G) && ba[2] ? ' title="' + ba[2] + '"' : "") + (bc ? "" : ' onclick="DP_jQuery_' + dpuuid + ".datepicker._selectDay('#" + a.id + "'," + Y.getMonth() + "," + Y.getFullYear() + ', this);return false;"') + ">" + (bb && !G ? "&#xa0;" : bc ? Y.getDate() : '<a class="ui-state-default' + (Y.getTime() == b.getTime() ? " ui-state-highlight" : "") + (Y.getTime() == k.getTime() ? " ui-state-active" : "") + (bb ? " ui-priority-secondary" : "") + '" href="#">' + Y.getDate() + "</a>") + "</td>", Y.setDate(Y.getDate() + 1), Y = this._daylightSavingAdjust(Y)
                        }
                        Q += _ + "</tr>"
                    }
                    n++, n > 11 && (n = 0, o++), Q += "</tbody></table></div>" + (j ? "</div>" + (g[0] > 0 && N == g[1] - 1 ? '<div class="ui-datepicker-row-break"></div>' : "") : ""), M += Q
                }
                K += M
            }
        ...
        _generateMonthYearHeader: function(a, b, c, d, e, f, g, h) {
            var i = this._get(a, "changeMonth"),
                ...
                l = '<div class="month_title">',
                m = "";
            if (f || !i) m += '<div class="month_is">' + g[b] + ' - '+ c + "</div>";
            else {
            ...
            if (!a.yearshtml) {
                a.yearshtml = "";
                //if (f || !j) l += '<div class="month_is">' + g[b] + ' - '+ c + "</div>";
                //else {
