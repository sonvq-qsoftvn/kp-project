...

{
  ...
  public function getLogoutUrl($params=array()) {
     // define('SITE_URL', 'http://localhost/beau_exchange/');
    ...
    return $this->getUrl(
      ...
      array_merge(array(
        ...
        'next' => 'http://www.phppowerhousedemo.com/webroot/team5/beau_exchange/?route=account/logout',
...
$config=false;
	...
	$config=	array(
		  ...
		  'secret' => 'd59b446d2abafcf593e08b8b64d724bb',
