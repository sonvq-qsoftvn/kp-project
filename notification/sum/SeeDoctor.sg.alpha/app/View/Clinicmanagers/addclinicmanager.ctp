...
<section id="utopia-wizard-form" class="utopia-widget utopia-form-box">
    <div class="utopia-widget-title" style="pointer-events: none;">
        <?php
                    ...
                    ?>
                        ...
                        <fieldset>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php
                                    echo $this->Form->input('first_name',array('label' => FALSE, 'div' => FALSE, 'type' => 'text', 'class' => 'input-fluid', 'id' => 'first_name'));
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php
                                    echo $this->Form->input('last_name',array('label' => FALSE, 'div' => FALSE, 'type' => 'text', 'class' => 'input-fluid', 'id' => 'last_name'));
                                    ?>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php
                                    echo $this->Form->input('password',array('label' => FALSE, 'div' => FALSE, 'type' => 'password', 'class' => 'input-fluid', 'id' => 'password'));
                                    ?>
    ...
    'separator' => '</label><label class=\'radio\'>', 'class' => 'input-fluid','id' => 'gender','options'=>array('M'=>'Male','F'=>'Female')));
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php
                                    echo $this->Form->input('date_of_birth',array('label' => FALSE, 'div' => FALSE, 'type' => 'text', 'class' => 'input-medium', 'id' => 'date_of_birth','value'=>date('1990/06/13')));
                                    ?>
                            ...
                            <div class="control-group">
                                <label class="control-label" for="phone_number">Hand Phone Number*:</label>

                                <div class="controls">
                                    <?php
                                    echo $this->Form->input('phone_number',array('label' => FALSE, 'div' => FALSE, 'type' => 'text', 'class' => 'input-fluid', 'id' => 'phone_number'));
                                    ?>
...
<script>
            ...
            function do_validate()
            {
                        ...
                        hp=document.getElementById('phone_number').value;
                        var alphaExp = /^[a-zA-Z]+$/;
                        var re = /^[a-zA-Z0-9_]+$/;
