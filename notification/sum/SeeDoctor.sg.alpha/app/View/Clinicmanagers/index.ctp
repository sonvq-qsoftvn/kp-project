          ...
          <div class="span12">
               <section class="utopia-widget">
                    <div class="utopia-widget-title">
                         <?php echo $this->Html->image('../admin/img/icons/paragraph_justify.png',array('class'=>'utopia-widget-icon'));  ?>
                    ...
                    <div class="utopia-widget-content">
                         <div style="width: 100%;margin-right:9%;margin-bottom:1%;text-align:right;">
                              <a href='<?php echo BASE_URL;?>administrator/addclinicmanager'>
                                   <?php echo $this->Html->image('../admin/img/icons/add.png',array('alt'=>'add','title'=>'add'));  ?>
                                   &nbsp;&nbsp;Add Clinic Manager
                              </a>
                         </div>
                         ...
                         <table class="table table-striped table-bordered">
                              <thead>
                                   <tr>
                                        ...
                                        <th style="width: 10%;"><?php echo $this->Paginator->sort('first_name','First Name');?></th>
                                        <th style="width: 10%;"><?php echo $this->Paginator->sort('last_name','Last Name');?></th>
                                        <th style="width: 10%;"><?php echo $this->Paginator->sort('username','Username');?></th>
                                        <th style="width: 20%;"><?php echo $this->Paginator->sort('email','Email Id');?></th>
                                        ...
                                        <th style="width: 10%;"><?php echo $this->Paginator->sort('phone_number','Phone No');?></th>
                                   ...
                                   ?>
                                             <tr>
                                                 ...
                                                 <td>
                                                  ...
                                                  <td><?php echo $individual['User']['first_name'];?></td>
                                                  <td><?php echo $individual['User']['last_name'];?></td>
                                                  <td><?php echo $individual['User']['username'];?></td>
                                                  <td><?php echo $individual['User']['email'];?></td>
                                                  <td><?php echo $individual['User']['gender'];?></td>
                                                  <td><?php echo date('Y/m/d', strtotime($individual['User']['date_of_birth']));?></td>
                                                  <td><?php echo $individual['User']['phone_number'];?></td>
                                                  <td>
                                                      <a href="<?php echo BASE_URL;?>administrator/editclinicmanager?clinicmanagerid=<?php echo $individual['User']['id'];?>" class="edit">
                                                            <?php echo $this->Html->image('../admin/img/icons/pencil.png',array('alt'=>'Edit','title'=>'Edit'));?>
                                                      </a>
                                                      <a href="javascript:do_confirm('<?php echo BASE_URL;?>administrator/deleteclinicmanager?clinicmanagerid=<?php echo $individual['User']['id'];?>');" class="delete">
                                                            <?php echo $this->Html->image('../admin/img/icons/trash_can.png',array('alt'=>'Delete','title'=>'Delete'));?>
                                                      </a>
                                                  </td>
                                             </tr>
                         ...
                         <div class="row-fluid">
                              <div class="span6">
                                   <div class="dataTables_info" id="DataTables_Table_0_info">
                                        <?php echo $this->Paginator->counter(array('format' => 'Page {:page} of {:pages}, showing {:current} records out of {:count} total' ));?></div>
                              </div>
