...
?>
     <section id="utopia-wizard-form" class="utopia-widget utopia-form-box">
          <div class="utopia-widget-title">
               <?php  echo $this->Html->image('../admin/img/icons2/paragraph_justify.png',array('class'=>'utopia-widget-icon')); ?>
               <span>Edit Clinic Manager Form</span>
          </div>
                                        ...
                                        <div class="control-group">
                                             ...
                                             <div class="controls">
                                                  <?php
                                                       ...
                                                       echo $this->Form->input('clinicmanagers_date_of_birth',array('label' => FALSE, 'div' => FALSE, 'type' => 'text', 'class' => 'input-medium', 'id' => 'clinicmanagers_date_of_birth', 'value' => ($date_of_birth)?$date_of_birth:date('Y/m/d')));
                                                  ?>
                                             </div>
                                        </div>
                                        <div class="control-group">
