                                             ...
                                             for ($n=0; $n<=6; $n++)
                                             {
                                                  ...
                                                  if($is_in_slot == 1)
                                                  {
                                                       ...
                                                       else
                                                       {
                                                                 ...
                                                                 foreach($booked_slots as $slots)
                                                                 {
                                                                      ...
                                                                      if(strtotime($end_time) == $app_end_time)
                                                                      {
                                                                           if($slots['Appointment']['status'] == 2){
                                                                                $sec_class = 'r_back';
                                                                                $inner_cont = "<a href='javascript:void(0)' onclick='reshedule_appointment(\"".$this->clinic_id."\", \"".$current_ploted_dates[$n]."\", \"".$start_time."\", \"".$end_time."\", \"".$open_slot_id."\", \"".$slot_multiplier."\", \"".$slots['Appointment']['id']."\")' class='initialism rescheduleappointment_open icon1'><img src='".BASE_URL."frontend/images/manageinfo_icon3.png'></a><a href='Javascript:void(0)' class='icon2'><img src='".BASE_URL."frontend/images/manageinfo_icon4.png'></a><span>".$user_name."<br>".$phone_number."</span>";
                                                                           }
                                                                           else
                                                                           {
                                                                                $sec_class = 'y_back';
                                                                                $inner_cont = "<a href='Javascript:confirm_appointment(\"".BASE_URL.'appointments/confirm_appointment/clinic:'.$this->clinic_id.'/id:'.$slots['Appointment']['id']."\")' class='icon1'><img src='".BASE_URL."frontend/images/manageinfo_icon5.png'></a><a href='Javascript:void(0)' class='icon2'><img src='".BASE_URL."frontend/images/manageinfo_icon6.png'></a><span>".$user_name."<br>".$phone_number."</span>";
                                                                           }
                                                                      }
                                                                 }
                                                            }
                                                            
                                                            //confirm_delete(\"".BASE_URL.'appointments/delete_appointment/id:'.$slots['Appointment']['id']."\")
                                                            ...
                                                            //     {
                                                            //          if($exception_chk['Clinicexception']['slot_time'] == $start_time){
                              ...
                              else
                              {
                                   ...
                                   $Output .="<tr class='manage_appointment_info_cont'>";
                                        ...
                                        for ($n=0; $n<=6; $n++)
                                        {
                                             ...
                                             foreach($all_open_slots_details as $all_open_slot)
                                             {
                                                  if($all_open_slot['Openinghour']['fromhour'] <= $i && $all_open_slot['Openinghour']['tohour'] >= $i){
                                                       
                                                       $is_in_slot = 1; $open_slot_id = $all_open_slot['Openinghour']['id']; $slot_multiplier++;
                                                       
                                                       //echo $this->generate_time($open_slot_id, $current_date, $slot_id, $start_time, $end_time, $slot_multiplier);
                                                  }
                                                  else{
                                                       $is_in_slot = 0; $open_slot_id = '';
                                                       //echo $this->generate_time($open_slot_id, $current_date, $slot_id, $start_time, $end_time, $slot_multiplier);
                                             ...
                                             { 
                                                  ...
                                                  else
                                                  {
                                                       ...
                                                       if(in_array($date_name, $day_avilable))
                                                       {
                                                            $sec_class = ''; $inner_cont = "<a id='".$slot_id."' href='javascript:void(0)' onclick='booking_appointment(\"".$this->clinic_id."\", \"".$current_ploted_dates[$n]."\", \"".$start_time."\", \"".$end_time."\", \"".$open_slot_id."\", \"".$slot_multiplier."\")' class='initialism makeanappointment_open'><img src='".BASE_URL."frontend/images/manageinfo_icon1.png'></a>";
                                                       }
                                                       else
                                                       {
                                                            $sec_class = 'g_back'; $inner_cont = '';
