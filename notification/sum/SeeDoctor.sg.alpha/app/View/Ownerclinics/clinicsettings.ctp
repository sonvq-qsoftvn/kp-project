                    ...
                    <?php echo $this->Form->create('Clinic',$settings=array('class'=>'form-horizontal','id'=>'validation','name'=>'validation','enctype'=>'multipart/form-data')); ?>
                        ...
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php
                                        $options_arr[0]='Please Select Speciality';
                                        ...
                                        echo $this->Form->input('type',array('type'=>'select','label' => FALSE, 'div' => FALSE, 'id' => 'type', 'options'=>$options_arr,'style'=>'width:60%;','data-placeholder'=>'Select Speciality','class'=>'chzn-select-deselect','onchange'=>'ajax_sub(this.value,"'.BASE_URL.'/clinicmanager/producesub")'));
                                    ?>
