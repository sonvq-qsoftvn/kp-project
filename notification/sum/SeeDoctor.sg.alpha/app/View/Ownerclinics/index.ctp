...
else if($msg=='clinicaddsuccess')
{
?>
            <div class="alert alert-info">
                        <a class="close" data-dismiss="alert" href="#">×</a>
                        <strong>Success!</strong>
                        Clinic Successfully Created And It Will be Approved By Admin!!!<br/>An email has been sent to the clinic manager informing him/her about the clinic creation.Please setup the followings to complete the proper clinic creation:<ul><li>Setup the opening hours and time slots</li><li>Complete/edit the clinic settings.</li></ul>
            </div>
<?php            
}
else if($msg=='openingtimesuccess')
{
?>
            <div class="alert alert-info">
                        <a class="close" data-dismiss="alert" href="#">×</a>
                        <h4 class="alert-heading">SUCCESS!</h4>
                        Opening timing Added successfully !!!
            </div>
<?php             
}
else if($msg=='openingtimenotsuccess')
{
?>
            <div class="alert alert-error">
                        <a class="close" data-dismiss="alert" href="#">×</a>
                        <h4 class="alert-heading">Failure!</h4>
                        Opening timing not successfully !!!
            </div>
<?php             
}
else if($msg=='deletefailure')
...
?>
            <div class="alert alert-error">
                        <a class="close" data-dismiss="alert" href="#">×</a>
                        <h4 class="alert-heading">Failure!</h4>
                        Opening time delete not successfully !!!
            </div>
<?php             
}
else if($msg=='timingdeletesuccess')
{
?>
            <div class="alert alert-info">
                        <a class="close" data-dismiss="alert" href="#">×</a>
                        <h4 class="alert-heading">SUCCESS!</h4>
                        Opening time delete successfully !!!
            </div>
<?php             
}
else if($msg=='doctoraddsuccess')
{
?>
            <div class="alert alert-info">
                        <a class="close" data-dismiss="alert" href="#">×</a>
                ...
                <div class="span12">
                    <section class="utopia-widget">
                        <div class="utopia-widget-title">
                            ...
                            ?>
                            <span>Approve Clinic List</span>
                        </div>

                        <div class="utopia-widget-content">
                                    <div style="width: 100%;margin-right:9%;margin-bottom:1%;text-align:right;">
                                                <a href='<?php echo BASE_URL;?>clinicmanager/addclinic'>
                                                            <?php
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 15%;"><?php echo $this->Paginator->sort('url','Url');?></th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                           ...
                                           <td>
                                                <a href="<?php echo BASE_URL;?>clinicmanager/clinicexceptions?clinicid=<?php echo $individual['Clinic']['id'];?>" class="edit">
                                                            <?php echo $this->Html->image('../admin/img/icons/cancel.png',array('alt'=>'Exceptions','title'=>'Exceptions'));?>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="<?php echo BASE_URL;?>clinicmanager/openinghours?clinicid=<?php echo $individual['Clinic']['id'];?>" class="edit">
                                                            <?php echo $this->Html->image('../admin/img/icons/clock.png',array('alt'=>'Opening Hours','title'=>'View/Edit Opening Hours'));?>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="<?php echo BASE_URL;?>clinicmanager/doctors?clinicid=<?php echo $individual['Clinic']['id'];?>"  class="edit">
                                                            <?php echo $this->Html->image('../admin/img/icons/user.png',array('alt'=>'Doctor.','title'=>'Doctor'));?>
                                                            
                                                </a>
                                            </td>
                                            <td>
                                                <a href="<?php echo BASE_URL;?>clinicmanager/clinicsettings?clinicid=<?php echo $individual['Clinic']['id'];?>" class="edit">
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:do_confirm('<?php echo BASE_URL;?>clinicmanager/deleteclinic?clinicid=<?php echo $individual['Clinic']['id'];?>');" class="delete">
