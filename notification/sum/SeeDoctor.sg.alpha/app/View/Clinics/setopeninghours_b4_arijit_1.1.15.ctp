                                                    ...
                                                    if(count($slots_arr[$k]))
                                                    {
                                                        foreach($slots_arr[$k] as $key=>$each_slot)
                                                        {
                                                           ...
                                                           <tr class='myclass_<?php echo $k;?>_<?php echo $my_count;?> tr_top'>
                                                                                    ...
                                                                                    <input type='hidden' value='<?php echo $each_slot['Openinghour']['id'];?>' name='id_<?php echo $k.'_'.$my_count;?>' id='id_<?php echo $k.'_'.$my_count;?>' ><div class="lefttitletxt"><i class="sloticon"></i>Slot <?php echo $my_count;?></div>
                                                                        </th>
                                                            ...
                                                            <tr class='myclass_<?php echo $k;?>_<?php echo $my_count;?> fromtr'>
                                                                        ...
                                                                        <td class="ful_td">
                                                                                    <div class="fieldblockbox"><div class="left_fieldblock"><label>Hours</label><div class="select_dropdownbox"><select id='from_hours_<?php echo $k.'_'.$my_count;?>' name='from_hours_<?php echo $k.'_'.$my_count;?>'>
                                                                                                <?php
                                                                                                for($i=0;$i<=23;$i++)
                                                                                                {
                                                                                                            ?>
                                                                                    ...
                                                                                    <div class="right_fieldblock"><label>Minutes</label><div class="select_dropdownbox"><select id=from_minutes_<?php echo $k.'_'.$my_count;?> name='from_minutes_<?php echo $k.'_'.$my_count;?>'>
                                                                                                <?php
                                                                                                for($i=0;$i<=59;$i++)
                                                                                                {
                                                                                                            ?>
                                                            ...
                                                            <tr class='myclass_<?php echo $k;?>_<?php echo $my_count;?> fromtr'>
                                                                        ...
                                                                        <td class="ful_td">
                                                                                    <div class="fieldblockbox"><div class="left_fieldblock"><label>Hours</label><div class="select_dropdownbox"><select id='to_hours_<?php echo $k.'_'.$my_count;?>' name='to_hours_<?php echo $k.'_'.$my_count;?>'>
                                                                                                <?php
                                                                                                for($i=0;$i<=23;$i++)
                                                                                                {
                                                                                                            ?>
                                                                                    ...
                                                                                    <div class="right_fieldblock"><label>Minutes</label><div class="select_dropdownbox"><select name='to_minutes_<?php echo $k.'_'.$my_count;?>' id='to_minutes_<?php echo $k.'_'.$my_count;?>'>
                                                                                                <?php
                                                                                                for($i=0;$i<=59;$i++)
                                                                                                {
                                                                                                            ?>
...
<script type='text/javascript'>
            ...
            function addslot(k)
            {
                        ...
                        var txt="<tr class='myclass_"+k+"_"+c+" tr_top'><th  style='text-align: left;font-size: large;'><input type='hidden' id='mystatus_"+k+"_"+c+"' name='status_"+k+"_"+c+"' value='1'><input type='hidden' name='id_"+k+"_"+c+"' id='id_"+k+"_"+c+"' value='"+maxid+"'> <div class='lefttitletxt'><i class='sloticon'></i>Slot "+c+"</div></th><th style='text-align:right;'><a href='javascript:deleteopeninghour("+k+","+c+")'><img src='<?php echo BASE_URL;?>app/webroot/admin/img/icons2/slot_closeicon.png' class='utopia-icons2-small-img' title='delete'></a></th></tr><tr class='myclass_"+k+"_"+c+" fromtr'><td class='full_w'>From :</td><td class='ful_td'><div class='fieldblockbox'><div class='left_fieldblock'><label>Hours</label><div class='select_dropdownbox'><select name='from_hours_"+k+"_"+c+"' id='from_hours_"+k+"_"+c+"' >";
                        for(ai=0;ai<=23;ai++)
                        {
