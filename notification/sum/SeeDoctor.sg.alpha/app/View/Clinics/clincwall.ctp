							...
							<div class="see-orc">
								...
								<div class="see-orc-right">
									<h2>Waiting Time</h2>
                                                    ...
                                                    <?php  if($client_all_detail[0]['Clinic']['waitingtime']>60)
                                                    {
                                                        
                                                      $hours =round(($client_all_detail[0]['Clinic']['waitingtime']/60));
                                                      
                                                      $minutes =($client_all_detail[0]['Clinic']['waitingtime']%60);
                                                      
                                                      
                                                      $waitingtime=$hours .' hours : '.$minutes.' minutes' ;
                                                        
                                                    }else{
                                                        
                                                        
                                                          $waitingtime=$client_all_detail[0]['Clinic']['waitingtime'].' minutes' ;
									...
									<p>
<?php echo ($client_all_detail[0]['Clinic']['waitingtime'])?'Between 0 to '.$waitingtime:'Between 0 to 15 minutes.'; ?></p>
								</div>
							</div>
				<?php  	} ?>      
					<div class="see-orc">
