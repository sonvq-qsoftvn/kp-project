                            ...
                            <div class="control-group">
                                 ...
                                 <div class="controls">
                                     ...
                                     <?php
                                                 ...
                                                 //creating the dropdown
                                                 foreach($all_eligibility as $k=>$v)
                                                 {
                                                             ?>
                                                             <option <?php if(gettype(array_search($v['Eligibilitie']['id'],$checked_arr1))!='boolean'){?>selected='selected'<?php }?> value="<?php echo $v['Eligibilitie']['id'];?>"><?php echo $v['Eligibilitie']['name'];?></option>
                                                             <?php
                                                 }
                                     ?>
                                     </select>
