     ...
     <div class="row-fluid">
          <div class="utopia-widget-content">
               <div class="span12 utopia-form-freeSpace">
                    <div class="sample-form">
                         ...
                         <fieldset>
                              <div class="control-group">
                                   ...
                                   <div class="controls">
                                        <?php
                                             ...
                                             {
                                                  echo $this->Html->image('../admin/uploads/thumb/'.$my_data['Clinic']['logo'],array('alt'=>'logo'));
                                             }
                                        ?>
                                   </div>
                              </div>
                              ...
                              <div class="control-group">
                                   ...
                                   <div class="controls">
                                        <?php
                                             ...
                                             {
                                                  $options_arr[$v['User']['id']]=$v['User']['first_name'].' '.$v['User']['last_name'];
                                             }
                             ...
                             <div class="control-group">
                                 ...
                                 <div class="controls">
                                     <?php
                                     //echo $this->request->data['Clinic']['handphone'];
                                    // $num = preg_replace('/65/', '', $this->request->data['Clinic']['handphone'], 1);
                                     //echo '+65&nbsp;&nbsp;&nbsp;'.$this->Form->input('handphone',array('label' => FALSE, 'div' => FALSE, 'type' => 'text', 'class' => 'input-fluid', 'id' => 'handphone','style'=>'width:77%;', 'value' => $num));
                                     ?>
                                     +65 <input type="text" id='handphone' name="data[Clinic][handphone]" style="width:77%;" value="<?php echo ($this->request->data['Clinic']['handphone'])?$this->request->data['Clinic']['handphone']:''; ?>" />
                                 </div>
                             </div>
                             <div class="control-group">
                             ...
                             <div class="control-group">
                                 ...
                                 <div class="controls">
                                     ...
                                     <?php echo $this->Form->input('address',array('type' => 'textarea','id' => 'address','label' => FALSE,'cols'=>20,'rows'=>10,'div' => FALSE,'class' => 'input-fluid')); ?>
                             ...
                             <div class="control-group">
                                 ...
                                 <div class="controls">
                                     ...
                                     <?php echo $this->Form->input('about',array('type' => 'textarea','id' => 'about','label' => FALSE,'cols'=>20,'rows'=>10,'div' => FALSE,'class' => 'input-fluid')); ?>
                             ...
                             <div class="controls">
                                 ...
                                 <span>Display waiting time on clinic wall</span>
                             </div>
                         </div>
                         <div class="control-group">
                             ...
                             <div class="controls">
                                 ...
                                 <span>Allow users to post on clinic wall?</span>
                             </div>
                         </div>
                         <div class="control-group">
                             ...
                             <div class="controls">
                                 ...
                                 <span>Lock clinic wall?</span>
                             </div>
                         </div>
                         <div class="control-group">
                                 <label class="control-label" for="name">Clinic Slogan:</label>
 
                                 <div class="controls">
                                     <?php
                                     echo $this->Form->input('slogan',array('label' => FALSE, 'div' => FALSE, 'type' => 'text', 'class' => 'input-fluid', 'id' => 'slogan'));
                                     ?>
                         ...
                         <div class="control-group">
                                 <label class="control-label" for="insurances">Insurance Eligibility:</label>

                                 <div class="controls">
                                     <select id='insurances' class='fancy_dropdown'  name='insurances[]' multiple>
                                     <?php
                                    ...
                                    <option <?php if(gettype(array_search($value['Insurance']['id'],$checked_arr))!='boolean'){?>selected='selected'<?php }?> value="<?php echo $value['Insurance']['id'] ?>" style="color:#fff;background-color: #B5B5B5;  border: 1px;text-overflow:ellipsis; padding:5px 4px 3px 4px;" disabled >
                            ...
                            <div class="control-group">
                                 <label class="control-label" for="insurances">Co-Payment Eligibility:</label>
 
                                 <div class="controls">
                                     <select id='eligibilities'  class='fancy_dropdown'  name='eligibilities[]' multiple>
                                     <?php
                                    ...
                                    <option <?php if(gettype(array_search($value['Eligibilitie']['id'],$checked_arr1))!='boolean'){?>selected='selected'<?php }?> value="<?php echo $value['Eligibilitie']['id'] ?>" style="color:#fff;background-color: #B5B5B5; border: 1px;text-overflow:ellipsis; padding:5px 4px 3px 4px;" disabled >
				...
				<div class="control-group">
                                 <label class="control-label" for="address">Tags:</label>
 
                                 <div class="controls">
                                     
                                     <?php echo $this->Form->input('tags',array('type' => 'textarea','id' => 'tags','label' => FALSE,'cols'=>20,'rows'=>10,'div' => FALSE,'class' => 'input-fluid')); ?>
...
<script>
          ...
          //  $(window).load(function(){v=$('#handphone').val();if(v.length==8){new_v='';for(i=2;i<v.length;i++){new_v+=v[i];}$('#handphone').val(new_v);}});
            ...
            function do_validate()
            {
                        ...
                        var cs=document.getElementById('type').value;
                        var a=CKEDITOR.instances.about.getData();
