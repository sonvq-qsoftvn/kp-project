                        ...
                        <div class="utopia-widget-content">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 5%;"><?php echo $this->Paginator->sort('Cm.username','Clinic Manager');?></th>
                                    ...
                                    ?>
                                        <tr>
                                             ...
                                             <td>
                                                 ...
                                                 <a href="<?php echo BASE_URL;?>administrator/approveclinic?clinicid=<?php echo $individual['Clinic']['id'];?>" class="delete">
                                                  <?php echo $this->Html->image('../admin/img/icons/checkmark2.png',array('alt'=>'approve','title'=>'approve'));?>
                                                 </a>
                                             </td>
                                        </tr>
                                   <?php
