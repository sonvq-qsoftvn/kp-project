...
<script>
  ...
  function cheking_validation()
	   ...
	   $("#wall_post").validate({
				  ...
				  rules: {
						"data[Wallpost][post_title]" : "required",
                                                "data[Wallpost][post_main_text]" : "required",
						
						
					},
					messages: {
						"data[Wallpost][post_title]" : "Please enter post title.",
						"data[Wallpost][post_main_text]" : "Please enter post text.",
...
<div class="container">
    <div class="inner-gapbox-1">
      <div class="add_clinic">
		       ...
		       <button class="save" id="form_save" onclick="cheking_validation()">Save Changes</button>
                        <button  class="cancel" type="button" onclick="window.location.href='<?php echo BASE_URL;?>clinics/addwallpost/<?php echo $clinic_id; ?>'">Cancel</button>
