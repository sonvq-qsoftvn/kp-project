...
<?php
		if(isset($doctor_list['Doctor']['img']) && $doctor_list['Doctor']['img']!="")
			$profile_img = $this->Html->image('../admin/uploads/'.$doctor_list['Doctor']['img'],array('alt'=>'logo image'));
		else
      ...
      <div class="add_clinic">
        ...
        <div class="form-row">
            <div class="row">
                ...
                <div class="col-xs-12 col-md-9"><input type="text" name="f_name" id="f_name" class="user-in" value="<?php if(isset($doctor_list['Doctor']['f_name'])) echo $doctor_list['Doctor']['f_name']  ?>"></div>
        ...
        <div class="form-row">
            <div class="row">
                ...
                <div class="col-xs-12 col-md-9"><input type="text" name="l_name" id="l_name" class="user-in" value="<?php if(isset($doctor_list['Doctor']['l_name'])) echo $doctor_list['Doctor']['l_name']  ?>"></div>
            </div>
        </div>
        <div class="form-row">
            <div class="row">
                <label class="col-xs-12 col-md-3">Doctor Title<sup>*</sup> :</label>
                <div class="col-xs-12 col-md-9"><input type="text" name="title" id="title"  class="user-in" value="<?php if(isset($doctor_list['Doctor']['title'])) echo $doctor_list['Doctor']['title']  ?>"></div>
            </div>
        </div>
        <div class="form-row">
            <div class="row">
                <label class="col-xs-12 col-md-3">Doctor Qualification<sup>*</sup> :</label>
                <div class="col-xs-12 col-md-9"><input type="text" name="qualification" id="qualification" class="user-in" value="<?php if(isset($doctor_list['Doctor']['qualification'])) echo $doctor_list['Doctor']['qualification']  ?>"></div>
            </div>
        </div>
