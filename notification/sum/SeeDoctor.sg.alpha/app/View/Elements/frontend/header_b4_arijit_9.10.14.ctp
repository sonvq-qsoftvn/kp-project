				...
				<div class="container">
					<div class="row login-main">
						...
						<div class="login">
							...
							<div class="loginform">
								<h2>Login</h2>
								<?php echo $this->Form->create(array('name'=>'login_form', 'id'=>'login_form', 'enctype'=>'multipart/formdata', 'controller' => 'Users', 'action' => 'logincheck')); ?>
									<div class="login_field">
										<?php
											echo $this->Form->input('', array('name' => 'token', 'id' => 'token', 'value' => (isset($user_login_token))?$user_login_token:0, 'type' => 'hidden'));
									...
									<div class="login_link">
										<?php echo $this->Html->link('Forget Password', array()); ?>
										|
