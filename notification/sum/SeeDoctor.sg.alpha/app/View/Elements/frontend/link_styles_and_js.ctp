<?php
	...
	echo $this->Html->css('../frontend/css/mediaqueries.css');
        ...
        echo $this->Html->css('../frontend/css/styles.css');
	echo $this->Html->css('../frontend/css/multiselect');
	
	echo $this->Html->script('../frontend/js/jquery-1.10.2.js');
	echo $this->Html->script('../frontend/js/jquery-ui.js');
	
	echo $this->Html->script('../frontend/js/jquery.slimscroll.js');
	...
	echo $this->Html->script('../frontend/js/ui-scroll.js');
        ...
        echo $this->Html->script('../frontend/js/typehead.min.js');
	echo $this->Html->script('../frontend/js/multiselect');
