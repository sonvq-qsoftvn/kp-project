                ...
                <div class="nav-collapse collapse leftmenu">
                    ...
                    <ul>
                        ...
                        <li id='cmsforpages'><a class="editor" href="<?php echo BASE_URL.'administrator/';?>cmsforpages" title="CMS FOR FRONTEND PAGES"><span>Cms Pages</span></a>
                         <li id='sitesettings'><a class="editor" href="<?php echo BASE_URL.'administrator/';?>sitesettings" title="SITE SETTINGS FOR FRONTEND PAGES"><span>Site Settings</span></a>
                          <li id='listfeaturein'><a class="editor" href="<?php echo BASE_URL.'administrator/';?>listfeaturein" title="FEATURED IN FOR FRONTEND PAGES"><span>Featured In</span></a>
                        </li>
...
<li><a class="simple smronju" href="<?php echo BASE_URL.'administrator/';?>eligibilitymaster" title="Eligibility"><span>Eligibility Master</span></a></li>
                        ...
                        <li id='clinics'><a class="grid" href="<?php echo BASE_URL.'administrator/';?>clinics" title="Clinics"><span>Clinics</span></a>
                            <ul class="dropdown">
                        ...
                        <li id='doctors'><a class="elements" href="<?php echo BASE_URL.'administrator/';?>doctors" title="Doctors"><span>Doctors</span></a></li>
                        <!--<li id='wallposts'><a class="elements" href="<?php echo BASE_URL.'administrator/';?>wallposts" title="Wall Posts"><span>Wall Posts</span></a></li>-->
                        <!--<li id='events'><a class="elements" href="<?php echo BASE_URL.'administrator/';?>events" title="Events"><span>Events</span></a></li>
