            ...
            <div class="span12 utopia-form-freeSpace">
                <div class="sample-form">
                    ...
                    <?php echo $this->Form->input('id', array('type' => 'hidden')); ?>
                        ...
                        {         
                        ?>
                        <div style="display:  <?php echo $is_parent;?>">
...
<script>
            ...
            function do_validate()
            {
                        ...
                        inpi=document.getElementById('insurance_parent_id').value;
                        if (inn=='')
                        {
                        ...
                        {
                                    alert('Select insurance parent');
                                    document.getElementById('insurance_parent_id').focus();
                                    status=0;
                        }
