...
?>
            <div class="alert alert-error">
                        ...
                        <h4 class="alert-heading">Invalid Insurance Id</h4>
                        Sorry Insurance Not Updated !!!
            </div>
<?php
}
...
?>
            <div class="alert alert-error">
                        <a class="close" data-dismiss="alert" href="#">×</a>
                        <h4 class="alert-heading">No Insurance With Supplied Id</h4>
                        Sorry Insurance Not Updated !!!
            </div>
<?php            
}
                    ...
                    <section class="utopia-widget">
                        ...
                        <div class="utopia-widget-content">
                                    <div style="width: 100%;margin-right:9%;margin-bottom:1%;text-align:right;">
                                                <a href='<?php echo BASE_URL;?>administrator/addinsurance'>
                                                            <?php
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 35%;"><?php echo $this->Paginator->sort('insurances_name');?></th>
                                   <th style="width: 35%;"><?php echo $this->Paginator->sort('Pi.insurances_name','Parent Insurance');?></th>
                                ...
                                <tbody>
                                    ...
                                    foreach($all_insurances as $k=>$individual)
                                    {
                                    ?>
                                        <tr>
                                            <td><?php echo $sl_start+$k;?></td>
                                            <td><?php echo $individual['Insurance']['insurances_name'];?></td>
                                             <td><?php echo $individual['Pi']['insurances_name'];?></td>
                                            
                                            <td>
                                                <a href="<?php echo BASE_URL;?>administrator/editinsurance?insuranceid=<?php echo $individual['Insurance']['id'];?>" class="edit">
                                                            <?php echo $this->Html->image('../admin/img/icons/pencil.png',array('alt'=>'Edit','title'=>'Edit'));?>
                                                </a>
                                                <a href="javascript:do_confirm('<?php echo BASE_URL;?>administrator/deleteinsurance?insuranceid=<?php echo $individual['Insurance']['id'];?>');" class="delete">
