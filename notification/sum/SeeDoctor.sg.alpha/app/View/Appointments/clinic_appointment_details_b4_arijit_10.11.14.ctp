	...
	<script>
		...
		function reshedule_appointment()
		{
					...
					<form name="search_appointment" id="search_appointment" action="<?php echo BASE_URL;?>appointments/clinic_appointment_details/id:<?php echo $clinic_id ?>" method="post">
						...
						<div class="col-2">
							...
							<div class="upcoming_past">
								<button type="button" <?php if($cal_type == 'month')echo 'class="active"'; ?>  onclick="window.location='<?php echo BASE_URL.'appointments/clinic_appointment_details/id:'.$sec_clinic.'/cal:month' ?>'">Monthly</button>
								<button type="button" <?php if($cal_type == 'week')echo 'class="active"'; ?> onclick="window.location='<?php echo BASE_URL.'appointments/clinic_appointment_details/id:'.$sec_clinic.'/cal:week' ?>'">Weekly</button>
							</div>
						</div>    
					</form>
				</div>
			...
			<div id="pop_up_cont">
				<div class="reschedule_form">
					<form name="complete_booking" id="complete_booking" action="<?php echo BASE_URL.'appointments/complete_booking' ?>" method="post">
						...
						<div class="code-in"><input name="booking_captcha" placeholder="Enter captcha value" class="user-in" id="booking_captcha" onblur="captcha_check('<?php echo $manager_cap_val; ?>')" type="text" /><span id="msg_new"></span></div>
