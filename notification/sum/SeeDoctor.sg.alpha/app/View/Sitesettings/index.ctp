...
?>
            <div class="alert alert-error">
                        ...
                        <h4 class="alert-heading">Invalid Site Setting Id</h4>
                        Sorry Site Setting Content Not Updated !!!
            </div>
<?php
}
...
?>
            <div class="alert alert-info">
                        ...
                        Site Setting Content Successfully updated!!!
            </div>
<?php            
}
?>
                        ...
                        <div class="utopia-widget-content">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 35%;"><?php echo $this->Paginator->sort('field_name');?></th>
                                    <th style="width: 40%;"><?php echo $this->Paginator->sort('field_title');?></th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $individual['Sitesetting']['field_name'];?></td>
                                            <td><?php echo $individual['Sitesetting']['field_title'];?></td>
                                            <td><a href="<?php echo BASE_URL;?>administrator/editsitesetting?sitesettingid=<?php echo $individual['Sitesetting']['id'];?>" class="edit"><?php echo $this->Html->image('../admin/img/icons/pencil.png',array('alt'=>'Edit','title'=>'Edit'));?></a></td>
