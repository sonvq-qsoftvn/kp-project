...
<marquee direction='left' scrollamount='2' behavior='alternate'>Click on the column name to sort by that column.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Click on the subject to continue composing the message.</marquee>
<div class="row-fluid">
                        ...
                        <div class="utopia-widget-content">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 15%;"><?php echo $this->Paginator->sort('Message.touname','To');?></th>
                                    <th style="width: 15%;"><?php echo $this->Paginator->sort('Message.totype','User Type');?></th>
                                ...
                                <tbody>
                                    ...
                                    foreach($all_drafts as $k=>$individual)
                                    {
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href='<?php echo BASE_URL;?>administrator/composemessage?messageid=<?php echo $individual['Messagecontent']['id'];?>'><?php echo $individual['Messagecontent']['subject'];?></a></td>
                                            <td><?php echo $individual['Messagecontent']['datesent'];?></td>
                                            
                                            <td>
                                                
                                                <a href="javascript:do_trash('<?php echo BASE_URL;?>administrator/sendtotrashdraft?messageid=<?php if($individual['Message']['id']!=""){echo $individual['Message']['id'];}else{echo $individual['Messagecontent']['id'];}?>');" class="delete">
