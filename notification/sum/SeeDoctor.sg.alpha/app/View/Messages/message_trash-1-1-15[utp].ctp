      ...
      <div class="container">
		...
		<?php echo $this->element("frontend/message_tab");?>
			...
			<!--<span><a href="#">
                        ...
                        <span><a onclick="return confirm('Are you sure to delete this Message?')"  href="<?php echo BASE_URL.'messages/MessageDelete/id:'.$all_trash['Message']['id'] ?>" class="initialism rescheduleapp_open">
