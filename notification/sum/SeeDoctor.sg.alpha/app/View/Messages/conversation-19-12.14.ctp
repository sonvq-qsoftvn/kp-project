	...
	?>
		...
		<!------For Send Message Start----->
			...
			<h4><?php echo $logged_user_details['username'];?></h4><!----NA---->
				...
				<p>Subject</p>
				<input type="text" name="subject" class="subject_text">
				<p>Message</p>
				<textarea rows="5" cols="5" name="message" class="text_msg"></textarea>
				<input type="submit" name="save" value="Save" class="save btn_send"/>
