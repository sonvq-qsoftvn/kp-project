<div class="row-fluid">
            <div class="span12">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo BASE_URL;?>administrator/inbox" >Inbox</a> <span class="divider">/</span>
                    </li>
                    ...
                    <section class="utopia-widget">
                        ...
                        <div class="utopia-widget-content">
                            ...
                            <div class="row-fluid">
                                ...
                                if(count($child_messages)!=0)
                                {
                                    ...
                                    <tr style='cursor:pointer;' onclick='maketoggle("msg_<?php echo $child['Messagecontent']['id'];?>","imgid_<?php echo $child['Messagecontent']['id'];?>");'>
                                        ...
                                        <td style='text-align:center;' rowspan=2>
                                            <img id='imgid_<?php echo $child['Message']['id']?>' imgvalue='down' src='<?php echo BASE_URL;?>app/webroot/admin/img/icons2/directional_down.png' height='20px' width='20px' style='vertical-align: center;'>
                                        </td>
                                    </tr>
                                    <tr style='cursor:pointer;' onclick='maketoggle("msg_<?php echo $child['Messagecontent']['id'];?>","imgid_<?php echo $child['Messagecontent']['id'];?>");'>
                                        <td>
                                ...
                                <table style='width:100%;'>
                                    <tr style='cursor:pointer;' onclick='maketoggle("msg_<?php echo $thismessage['Message']['id'];?>","imgid_<?php echo $thismessage['Message']['id'];?>");'>
                                        <td>
                                            From&nbsp;&nbsp;:&nbsp;&nbsp;
                                            <?php
                                        ...
                                        <td style='text-align:center;' rowspan=2>
                                            <img id='imgid_<?php echo $thismessage['Message']['id']?>' imgvalue='up' src='<?php echo BASE_URL;?>app/webroot/admin/img/icons2/directional_up.png' height='20px' width='20px' style='vertical-align: center;'>
                                        </td>
                                    </tr>
                                    <tr style='cursor:pointer;' onclick='maketoggle("msg_<?php echo $thismessage['Message']['id'];?>","imgid_<?php echo $thismessage['Message']['id'];?>");'>
                                        <td>
                                    ...
                                    <tr id='msg_<?php echo $thismessage['Message']['id']?>'>
                                        <td colspan=3 style='padding-top:1%;padding-bottom:2%;' >
                                            <?php
