                        ...
                        <div class="utopia-widget-content">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    foreach($all_messages_outbox as $k=>$individual)
                                    {
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href='<?php echo BASE_URL;?>administrator/viewmessageoutbox?messageid=<?php echo $individual['Message']['id'];?>'><?php echo $individual['Messagecontent']['subject'];?></a></td>
                                            <td><?php echo $individual['Messagecontent']['datesent'];?></td>
                                            
                                            <td>
                                                
                                                <!--<a href="javascript:do_trash('<?php echo BASE_URL;?>administrator/sendtotrashoutbox?messageid=<?php echo $individual['Message']['id'];?>');" class="delete">-->
