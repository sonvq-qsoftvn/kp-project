...
<section class="emai-registration">
                ...
                <tr class="msg_info_cont">
                    <td class="col-1">
                        ...
                        <div class="pic">
                            ...
                            <?php
                                        if((isset($all_messages_inboxs['User']['profile_image']) &&  $all_messages_inboxs['User']['profile_image']!='') && (file_exists("frontend/uploads/profile_image/".$all_messages_inboxs['User']['profile_image'])))
                                        {
                                        ?>
                                                <img  width="51" height="50" src="<?php echo $this->webroot; ?>frontend/uploads/profile_image/thumbimage/<?php echo $all_messages_inboxs['User']['profile_image']; ?>" style="margin-bottom: 10px;">
                                        <?php
                                        }
                                        else
                                        {
    ...
    <div class="picdetails">
        ...
        if($all_messages_inboxs['Messagecontent']['fromtype']=='superadmin'){            
           // echo ($from_users['admin'][$all_messages_inboxs['Messagecontent']['fromid']]['Admin']['admin_email']);         
        ?>
        
       
                                                                                                                                                           <?php echo ucfirst($all_messages_inboxs['User']['username']); 
                                                                                                                                                       
        }else{ 
            
            $all_types=array('User','Clinic Manager');
            
//echo ($from_users['user'][$all_messages_inboxs['Messagecontent']['fromid']]['User']['email']); ?> 
    <?php echo  ucfirst($all_messages_inboxs['User']['username']);  ?>                                                   <?php  }?>
