					...
					<div id="user_form">
						<form name='user_reg_form' id='user_reg_form' action='<?php echo BASE_URL;?>userupdate' method='post' enctype='multipart/form-data' >
							...
							<div class="form-row">
								<div class="col-md-4">
									<?php
									if(($profile_img!='') && (file_exists("frontend/uploads/profile_image/".$profile_img)))
									{
									?>
										<img src="<?php echo $this->webroot; ?>frontend/uploads/profile_image/thumbimage/<?php echo $profile_img; ?>" style="margin-bottom: 10px;">
									<?php
									}
									else
									{
										?>
										<img src="<?php echo $this->webroot; ?>frontend/images/no-avatar.jpg" width="150" height="150" style="margin-bottom: 10px;">
										<?php
									}
									?>
									<input type="hidden" name="old_profile_img" id="old_profile_img" value="<?php echo $profile_img; ?>">
									<!--<input type="file" name="profile_img" id="profile_img">-->
									
									<div class="upload_clinic_pic">
										<div style="height:0px;visibility: hidden;"><input type="file" onchange="chage_name(this.value)" name="profile_img" id="fileInput" /></div>
