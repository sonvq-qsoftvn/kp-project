 ...
 <!------------------------------------SEARCH DENTIST SECTION--------------------------->
                                   ...
                                   <form name="form_dentist" action="<?php echo BASE_URL."search/"?>" method="get">
                                            ...
                                            <div class="find_doctor_element">
                                             <input type="text" name="clinic_doc" class="user-in" placeholder="Name of Clinic, Dentist, Condition or Procedure">
                                            </div>
                                             <div class="find_doctor_element">
...
<!-----------------------------------------------------------SEARCH DENTIST SECTION-------------------------------------------------------------------->
                         ...
                         <div class="banner_slider">
                              <ul class="bxslider">
                                   ...
                                   ?>
                                   <li><?php echo $this->Html->image('../admin/company_logo/banner_logo/'.$eachbannerlogo['Companylogo']['company_logo'],array('alt'=>'')); ?></li>
