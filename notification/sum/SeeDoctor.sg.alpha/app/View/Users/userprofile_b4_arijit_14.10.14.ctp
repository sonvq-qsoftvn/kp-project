                              ...
                              <div class="rgeistration-wrapp">
                                   <div id="user_form">
                                        <form name='user_pass_form' id='user_pass_form' action='<?php echo BASE_URL;?>change_password' method='post' enctype='multipart/form-data' >
                                             ...
                                             <input type="hidden" name="user_type" id="user_type" value="<?php echo (isset($user_type))?$user_type:''; ?>" />
                                             <div class="form-row">
                                                  <div class="col-md-4"><input type="password" name="password" placeholder="Password" value="" class="user-in"></div>
                                             </div>
                                             <div class="form-row">
                                                  <div class="col-md-4"><input type="password" name="re_password" value="" placeholder="Re-Enter Password" class="user-in"></div>
                                             </div>
                                             <div class="clearfix"></div>
                                             <div class="button-wrapp">
