					...
					<div class="add_clinic">
							...
							<div class="row">
								...
								<div class="col-xs-12 col-md-9">
									<span class="select-wrapper">
										...
										<span class="holder"><?php echo ($seleted_name)?$seleted_name:'Select clinic Speciality'; ?></span>
									</span>
							...
							<div class="row">
								...
								<div class="col-xs-12 col-md-9" id='sub'>
									...
									?>
											...
											<span class="holder"><?php echo ($seleted_name)?$seleted_name:'Select Sub Speciality'; ?></span>
									<?php
										}
										else
										{
						...
						<div class="form-row">
							<div class="row">
								...
								<div class="col-xs-12 col-md-9">
									<textarea rows="5" cols="5" name="about" id="about" placeholder="Enter address" class="user-in-area ck_editor"><?php echo ($this->request->data['about'])?$this->request->data['about']:''; ?></textarea>
