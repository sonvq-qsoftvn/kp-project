                     ...
                     <?php
                        ...
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                  <?php
									echo $this->Form->input('post_title',array('label' => FALSE, 'div' => FALSE, 'type' => 'text', 'class' => 'input-fluid', 'id' => 'post_title','value'=>$edit_wall_post[0]['Wallpost']['post_title']));
			?>   
                                </div>
                            </div>
                             ...
                             <div class="control-group">
                                ...
                                <div class="controls">
                                  <?php
									echo $this->Form->input('name',array('label' => FALSE, 'div' => FALSE, 'type' => 'text', 'class' => 'input-fluid', 'id' => 'post_title','value'=>ucwords($edit_wall_post[0]['Wallpost']['alias_fname'].' '.$edit_wall_post[0]['Wallpost']['alias_lname'])));
			?>   
                             ...
                             <div class="control-group">
                                ...
                                <div class="controls">
                                  <?php
									echo $this->Form->input('designation',array('label' => FALSE, 'div' => FALSE, 'type' => 'text', 'class' => 'input-fluid', 'id' => 'post_title','value'=>ucwords($edit_wall_post[0]['Wallpost']['alias_designation'])));
			?>   
