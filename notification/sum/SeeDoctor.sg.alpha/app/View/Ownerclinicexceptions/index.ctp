                    ...
                    <section class="utopia-widget">
                        ...
                        <div class="utopia-widget-content">
                                    <div style="width: 100%;margin-right:9%;margin-bottom:1%;text-align:right;">
                                                <a href='<?php echo BASE_URL;?>clinicmanager/addexception?clinicid=<?php echo $clinicid;?>'>
                                                            <?php
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:do_confirm('<?php echo BASE_URL;?>clinicmanager/deleteexception?exceptionid=<?php echo $individual['Clinicexception']['id'];?>&clinicid=<?php echo $individual['Clinicexception']['clinicid'];?>');" class="delete">
