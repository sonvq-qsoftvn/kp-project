<div class="row-fluid">
            <div class="span12">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo BASE_URL;?>clinicmanager/clinicexceptions?clinicid=<?php echo $clinicid;?>">Exceptions</a> <span class="divider">/</span>
                    </li>
...
<h2 id='noslot' style='display:none;'> Sorry no slots to be cancelled for this clinic</h2>
    <div class="row-fluid">
        <div class="utopia-widget-content">
                ...
                <div class="sample-form">
                    <?php echo $this->Form->create('Clinicexception',$settings=array('class'=>'form-horizontal','id'=>'validation','name'=>'validation')); ?>
                        ...
                        <fieldset>
                            ...
                            <div class="control-group">
                                    <div class="controls">
                                                <button onclick="ajax_list('<?php echo BASE_URL;?>clinicmanager/slotlist')" class="btn btn-primary span2" type="button">Show Slot List</button>
            ...
            <div class="utopia-from-action myshowhide" style='display:none;'>
                               ...
                               <button class="btn span2" type="button" onclick="window.location.href='<?php echo BASE_URL;?>clinicmanager/clinics'">Cancel</button>
                            </div>
                        </fieldset>
