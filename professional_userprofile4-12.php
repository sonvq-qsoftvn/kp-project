                 ...
                 <tr>
                   ...
                   <table width="100%" align="left" border="0" cellpadding="4" cellspacing="0" class="prefer_pro">
                    ...
                    <td width="35%"><?php echo LEGAL_BUS_NAME;?> <span style="color:red;">*</span></td>
                        <td width="65%"><input type="text" name="bus_name" id="bus_name" class="textbg_grey required" value="<?php echo $busi_obj->f('busi_name')." ".$busi_obj->f('busi_display_name');?>" style="width: 190px;"/><span class="err" id="err_name"></span></td>
                    </tr>
                    <tr>
                    <td><?php echo DISPLAY_NAME;?><!--<span style="color:red;">*</span>--></td>
                    <td>
                    <input type="text" name="bus_display_name" id="bus_display_name" class="textbg_grey required" value="" style="width: 190px;"/> <span class="err" id="err_lname"></span>
                    </td>
                    </tr>						  
