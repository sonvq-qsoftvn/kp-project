                    ...
                    <div>
	                  <form method="post" action="" enctype="multipart/form-data" name="signin" id="signin" autocomplete = "off">
                    	...
                    	<table width="100%" border="1">
                          <tr>
                            <td width="44%" style="text-align:center;"><input type="text" name="email_cell"  id="email_cell" class="textbg_grey" placeholder="<?php if($_SESSION['langSessId']=='eng') {?>Email address or Cell# <?php } else {?>Email o celular # <?php }?>" style="width: 190px;"/></td>
                            <td width="27%"><input type="password" name="pass_signin" placeholder="<?php if($_SESSION['langSessId']=='eng') {?>Password <?php } else {?> contraseña<?php }?>" id="pass_signin" style="width: 190px;"/></td>
                            <td width="29%" style="text-align:left;"><input type="submit" name="submit11" id="submit11" value="" class="<?php if($_SESSION['langSessId']=='eng') {?>event_signin<?php } else {?>event_signin_sp<?php }?>" style="cursor:pointer;" /></td>
                          </tr>
                        </table>
					 </form>
                    </div>
