											...
											<tbody>
												<tr>
													<td valign="top" bgcolor="#FFFFFF" style="font-size:12px;color:#444444;line-height:150%;font-family:trebuchet ms;border-left:1px solid #e0e0e0;border-right:1px solid #e0e0e0;border-bottom:1px solid #e0e0e0">
														<p style="margin-top:0px"></p>
														<div style="color:#f3164f;font-family:arial;line-height:100%;padding:20px 0px">
															<p>Han pedido reinicializar su contraseña KPasapp. Por favor, confirme esta solicitud haciendo clic en el enlace <br/><br/>
															  <a target="_blank" href="'.$obj_base_path->base_path().'/resetpassword.php?user='.$faq->f('admin_id').'" style="font-weight:bold;"> Reset Your Password. </a>
														    </p>
															<p><span style="font-size:12px;color:#444444;line-height:150%;font-family:trebuchet ms">Si no puede abrir el hipervínculo anterior, copie y pegue el URL en su navegador de Internet. "'.$obj_base_path->base_path().'/resetpassword.php?user='.$faq->f('admin_id').'"</span></p>
														</div>
													  <p style="font-size:12px;color:#444444;line-height:150%;font-family:trebuchet ms">
															Esta solicitud se hizo en '.date("F d, Y,  h:i a").'<br>
															Si no hiciste esta solicitud, háganoslo saber de inmediato para su propia seguridad. Es importante porque nos ayuda a asegurarnos de que nadie se está metiendo en su cuenta sin su conocimiento.														</p>
														<p style="font-size:12px;color:#444444;line-height:150%;font-family:trebuchet ms"> Atentamente,<br>
														  ...
														  Envíanos un email a info@kpasapp.com si necesita ayuda adicional.</p>
<p></p>
													</td>
												</tr>
												<tr>
