...
<?php
//if($_SESSION['langSessId']=='eng'){ $lang = 'en';}else{ $lang = 'es';}
{ $lang = 'es';}
$actual_link = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]/og.php?page_id=".$objintro->f('page_id')."&lang=".$lang."";
?>
<!--<meta property="og:title" content="<?php// if($_SESSION['langSessId']=='eng'){echo $objintro->f('page_name');}else{echo $objintro->f('title_sp');}?>" />-->
<meta property="og:title" content="<?php echo $objintro->f('title_sp');?>" />
<meta property='og:site_name' content='Kpasapp' />

<!--<meta name="title" content="<?php //if($_SESSION['langSessId']=='eng'){echo $objintro->f('page_name');}else{echo $objintro->f('title_sp');}?>" />-->
<meta name="title" content="<?php echo $objintro->f('title_sp');?>" />
<meta property="og:url" content="<?php echo $actual_link;?>" />
<!--<meta property="og:description" content="<?php //if($_SESSION['langSessId']=='eng'){echo strip_tags($objintro->f('page_content'));}else{echo strip_tags($objintro->f('page_content_sp'));}?>" />-->
...
.addbox-innerbox .textadd-container {
...
.botbutt-add a {
  background: none repeat scroll 0 0 #23446d;
  color: #fff;
  font-family: arial;
  font-size: 13px;
  font-weight: bold;
...
.addbox-innerbox1 .textadd-container1 {
  border-top: 1px solid #fff;
  color: #444;
  float: left;
  font-family: arial;
     ...
     <div class="left_panel bg">
        <div class="spotlight_box">
            ...
            <div class="spotlight" style=" position: relative;">
              <div id="go-prev" style="margin: 0 0 0 5px; top: 54px; left: 0; position: absolute;"><img src="<?php echo $obj_base_path->base_path(); ?>/images/arrow_left.png" /></div>          <div id="go-next" style="margin: 0 5px 0 0; top: 54px;right: 0; position:absolute;"><img src="<?php echo $obj_base_path->base_path(); ?>/images/arrow_right.png" /></div>           <ul id="slider2" style="padding-left:2px; padding: 0; width: 680px; height: 140px;display:none">
                <?php
                    if($objEventpic->num_rows()){
                        while($objEventpic->next_record()){
                            if($objEventpic->f('event_photo')!=""){
                ?>
                        <li style="border: 1px solid #CCCCCC; margin: 0 4px; width: 170px;"><a href="<?php echo $obj_base_path->base_path(); ?>/event/<?php echo $objEventpic->f('event_id');?>" ><img src="<?php echo $obj_base_path->base_path(); ?>/files/event/large/<?php echo $objEventpic->f('event_photo');?>" width="160" height="126"/></a></li>
                <?php 
                            }
                        }
                    }
        ...
        <div class="hotevent_box">
           ...
           <div class="hot_events" style="position: relative;">
            ...
            ?>
                    <li style="border: 1px solid #CCCCCC; margin: 0 4px; width: 170px;"><a href="<?php echo $obj_base_path->base_path(); ?>/event/<?php echo $objEventpic1->f('event_id');?>" ><img src="<?php echo $obj_base_path->base_path(); ?>/files/event/large/<?php echo $objEventpic1->f('event_photo');?>" width="160" height="126" /></a></li>
            <?php 
						}
					}
				}
...
-->
		<div style="margin: 4px;float:left;padding: 5px;">
			...
			<script>(function(d, s, id) {
			  ...
			  js.src = "//connect.facebook.net/<?php echo $lang?>/all.js#xfbml=1&appId=149448255219243";
...
<!--                              <p><a href="<?php echo $obj_base_path->base_path(); ?>/event/<?php echo $eachVal['id'];?>" style="color:#FFFFFF;">US $<?php echo number_format($obj_min_ticket_cost->f('price_us'),2); ?> </span><span>MXP <?php echo number_format($obj_min_ticket_cost->f('price_mx'),2); ?></span></a></p> -->
    ...
    <div class="left_panel addbox">
       ...
       ?>
        ...
        <div class="add10"><a href="#"><img src="<?php echo $obj_base_path->base_path(); ?>/files/event/advertisement/thumb/<?php echo $objright_bottom->f('ad_image_name') ?>" border="0" height="156px" width="681px"/></a></div>
		...
		<div class="botbutt-add"> <a target="_blank" href="<?php echo $objright_bottom->f('link_url') ?>">Call for an appointment</a></div>
		</div>
	</div>	

<!--        <div class="add1"><a href="#"><img src="<?php //echo $obj_base_path->base_path(); ?>/files/event/advertisement/thumb/<?php //echo $objright_bottom->f('ad_image_name') ?>" border="0" /></a></div>-->
	...
	<div class="left_panel addbox1">
        
          <?php while($rows= $objright_bottom->next_record())
          {
	
       ?>
        <div class="addbox-innerbox1">
        <div class="add101"><a href="#"><img src="<?php echo $obj_base_path->base_path(); ?>/files/event/advertisement/thumb/<?php echo $objright_bottom->f('ad_image_name') ?>" border="0" /></a></div>
		<div class="addboxtext-right1">
		<h2><?php echo $objright_bottom->f('ad_title') ?></h2>
		<div class="textadd-container1"><?php echo $objright_bottom->f('ad_text') ?> </div>
		<div class="botbutt-add1"> <a target="_blank" href="<?php echo $objright_bottom->f('link_url') ?>">Call for an appointment</a></div>
		</div>
	</div>	
