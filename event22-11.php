...
function addtocart(num,mx,us,tid)
{
	//alert(val)
...
<!--                	<span style="float: right; margin: 0 auto; padding: 0; width: 160px;">
			...
			?>
						...
						if($_REQUEST['sub_id'] == ''){?>
                          <div class="select_box1">
                           <table width="100%" border="0" cellspacing="0" cellpadding="0" class="select_table1">
                              ...
                              <tr>
                                <td width="10%">
                                    <div class="dropdown25"><select name="ticket_num" id="ticket_num<?php echo $count;?>" onchange="addtocart(<?php echo $count;?>,<?php echo $obj_ticket->f('price_mx');?>,<?php echo $obj_ticket->f('price_us');?>,<?php echo $obj_ticket->f('ticket_id');?>);">
                                    <?php for($i=0;$i<=$obj_ticket->f('ticket_num');$i++) {?>
                                        <option value="<?php echo $i;?>"><?php echo $i;?></option>
                                    <?php } ?>
                                    </select></div>
                                    
                                    <input type="hidden" name="frm_ticket<?php echo $count;?>" id="frm_ticket<?php echo $count;?>" value="" />
                              ...
                              <div class="select_box2">
                                ...
                                <div class="icon_link">
                                    <ul>
                                        ...
                                        <!--<li><input type="radio" name="same" /><a href="javascript:void(0);" onclick="save();"><img src="<?php echo $obj_base_path->base_path(); ?>/images/icon3.gif" border="0" /></a></li>-->
				...
				<div class="view_box7">
					...
					<h1>EventNameEn</h1> 
					<p>EventStartDateTime - EventEndTime</p>
					<p>EventVenue</p>
					<p>VenueAddress</p>
					<p>VenueCity, VenueCounty, VenueState</p>                
                    </div>
                    <div class="clear"></div>
                </div>
				<div class="view_box7">
                	...
                	<div class="hot_event7">
                    <div><span>If Tickets are priced in both US$ and MX pesos:  <span style="float: right; padding: 0; margin: 0 auto; width: 272px;"><strong>Select payment currency:  MX Pesos   -  US$</strong></span></span></div>
					<div class="clear"></div>
					<div class="hot_event7">
