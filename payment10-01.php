...
function validate(){
  ...
  if (password=='' || password==null) { $("#err_password").html('Please input your password.'); err = 1; }
...
<?php if($_SESSION['langSessId']=='eng') {?>  US$ <?php }elseif($_SESSION['langSessId']=='spn'){?>EE.UU. $<?php }?> <a href="<?php echo $obj_base_path->base_path()."/payment.php?event_id=".$e_id."&act=us"; ?>"><input type="radio" name="cur" id="" value="" <?php if($_SESSION['pay'] == 'us'){ echo "checked";}?> /></a> 
	      ...
	      <?php if($_SESSION['langSessId']=='eng') {?>
	      For your convenience and security,<br /> you can sign in with your social account.
	      <?php }elseif($_SESSION['langSessId']=='spn'){?>
	      Para su comodidad y seguridad,<br /> se puede iniciar sesión con tu cuenta social.
	      <?php }?>
              <br />
		 ...
		 <div class="account_left">
			...
			?>
           <form method="post" action="" enctype="multipart/form-data" name="contact" id="contact" autocomplete = "off" onsubmit="return validate()"> 
           <?php if($_SESSION['ses_admin_id'] == ''){?>
		...
		<?php if($_SESSION['langSessId']=='eng'){
		  echo "Or Let's check your email address";
		    ...
		    echo "O echemos's cheque su direcci&#243;n de correo electr&#243;nico";
	  ...
	  <input type="hidden" name="language" id="language" value="<?php echo $obj->f('language')?>" />
        ...
        <div class="blue_bg"><?php if($_SESSION['langSessId']=='eng') {?>Select your payment method<?php }elseif($_SESSION['langSessId']=='spn'){?>Seleccione su forma de pago<?php }?></div> 
		 ...
		 <li><a href="javascript:void(0);" >Credit/Debit Card</a><br/><img src='<?php echo $obj_base_path->base_path(); ?>/images/logo5.gif' width="35" height="19" border="0"/><br/>
		   <input name="radiobutton" id="standard" type="radio" value="radiobutton" onClick="pay_type('standard');"/></li>
		 <li><a href="#">Paypal</a><br/><img src='<?php echo $obj_base_path->base_path(); ?>/images/logo6.gif' width="35" height="19" border="0"/><br/><input name="radiobutton" id="radiobutton" type="radio" value="radiobutton"/></li>
