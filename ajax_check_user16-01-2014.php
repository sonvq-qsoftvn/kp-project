...
?>		
		...
		<span class="err" id="err_postal_code" style="color:red;"></span>
              ...
              <tr>
                <td style="padding-left: 18px;"><?php if($_SESSION['langSessId']=='eng'){echo "Password";}elseif($_SESSION['langSessId']=='spn'){ echo "Contrase&#241;a";}?><br /></td>
                <td>
              ...
              <tr>
                <td style="padding-left: 18px;"><?php if($_SESSION['langSessId']=='eng'){echo "Retype password";}elseif($_SESSION['langSessId']=='spn'){ echo "Vuelva a escribir la contrase&#241;a";}?></td>
                <td>
