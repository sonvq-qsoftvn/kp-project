...
$(document).ready( function() {
	...
	$('#submit1').click( function() {
		if( $('#contact').valid() ) {
				ajaxSubmit();
			alert(window.location.protocol+'//'+window.location.host+'/'+'kcpasa/registration');exit;
...
function ajaxSubmit() {
	...
	var data = 'fname=' +fname+ '&lname=' +lname+ '&email=' +email+ '&phone=' +phone+ '&country_id=' +country_id+ '&country_code=' +country_code+'&account_type=' +account_type+ '&country_id=' +country_id+ '&country_code=' +country_code+ '&language=' +language;
