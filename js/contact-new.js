...
$(document).ready(function () {
    ...
    $('#submit1').click(function () {
        ...
        if(g_recaptcha_response == '') {
            ...
            var returnValue = ajaxSubmit();
            //alert("mailchimp");

            /* ======================= this is  for mailchimp form. ================================*/
...
function ajaxSubmit() {
    ...
    var data = 'fname=' + fname + '&lname=' + lname + '&email=' + email + '&phone=' + phone + '&country_id=' + country_id + '&country_code=' + country_code + '&password=' + password + '&account_type=' + account_type + '&country_id=' + country_id + '&country_code=' + country_code + '&language=' + language + '&aid=' + aid;
