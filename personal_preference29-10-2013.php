                    ...
                    <div class="showHeading"><?php echo SETUP_SOCIAL;?></div></td>
					 ...
					 <td colspan="2">					 
                       ...
                       <tr>
                        ...
                        <td width="64%"><input type="text" name="facebook_page_text" id="facebook_page_text" class="textbg_grey" style="width:283px;" value="<?php echo $obj_check_add_social->f('facebook_page_text');?>"/><input type="checkbox" name="facebook_page" id="facebook_page" value="1" <?php if($obj_check_add_social->num_rows()){ if($obj_check_add_social->f('facebook_page')==1){?> checked="checked" <?php } }else{ echo 'checked="checked"';  } ?>/></td>
                      </tr>
                        <tr>
                     ...
                     <tr>
                        ...
                        <td><input type="text" name="google_account_text" id="google_account_text" class="textbg_grey" style="width:283px;"  value="<?php echo $obj_check_add_social->f('google_account_text');?>" /><input type="checkbox" name="google_account" id="google_account" value="1" <?php if($obj_check_add_social->num_rows()){ if($obj_check_add_social->f('google_account')==1){?> checked="checked" <?php } }else{ echo 'checked="checked"';  } ?>/></td>
                      </tr>
                       </table></td>
					 </tr>
					<tr>
