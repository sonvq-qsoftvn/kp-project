...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="event_review">
    ...
    <tr>
      <td>
      <select name="ticket_num" id="ticket_num<?php echo $count;?>" onchange="tkt_num(<?php echo $count;?>,<?php echo $obj_ticket->f('cart_id');?>,<?php echo $event_id;?>);">
    ...
    <tr>
      ...
      <td><strong>Total : <?php $obj_total->totalAmount($_SESSION['ses_admin_id'],$_SESSION['pay'],$_SESSION['unique'],$event_id,$cart_id); $obj_total->next_record(); echo number_format($obj_total->f('Amt'),2,'.',',');?></strong></td>
