...
<title>proffessional user profile</title>
    <meta charset="utf-8">
        <meta name="title" content="proffessional_user_profile">
        <meta name="keywords" content="proffessional_user_profile">
        <meta name="description" content="proffessional_user_profile">
...
<!----MD5 ENCRYPTION BY GOOGLE---->
<script src="<?php echo $obj_base_path->base_path(); ?>/js/md5crypto.js"></script>
<!----MD5 ENCRYPTION BY GOOGLE---->
...
{
	sendData = {"country_id":$('#bus_country_id').val()};
	 $.ajax({ 
	   url: "<?php echo $obj_base_path->base_path(); ?>/ajax_folder/ajax_set_country_code.php",
	   cache: false,
	   type: "POST",
...
function IsEmail() {
  ...
  if(regex.test(email) == false){
  	//$('#bus_email_err').html("Incorrect Email!");
		...
		$.ajax({ 
		   ...
		   success: function(data){
			   if(data==1){
				 ...
				 $('#showStatus').html("<p>Un correo electr�nico de confirmaci�n ha sido enviado a esa direcci�n. Por favor, confirme su solicitud haciendo clic en el enlace del correo electr�nico.</p>")
				 <?php } else { ?>
		...
		sendData = {"altername_email":$('#altername_email').val(),"mode":"save"};
		 $.ajax({ 
		   ...
		   success: function(data){
			   if(data==1){
				 <?php if($_SESSION['langSessId']=="spn"){?>
				 $('#sh_alt_email').html("<p>Altername direcci�n de correo electr�nico guardado.</p>");
				 <?php } else { ?>
		...
		sendData = {"altername_email":$('#altername_email').val(),"mode":"make_primary","old_email":$('#email_orig_hid').val()};
		 $.ajax({ 
		   ...
		   success: function(data){
			   if(data==1){
				 <?php if($_SESSION['langSessId']=="spn"){?>
				 $('#sh_alt_email').html("<p>Correo electr�nico de verificaci�n enviado a la adici�n de direcci�n de correo electr�nico:</p>");
				 <?php } else { ?>
			    ...
			    <?php if($_SESSION['langSessId']=="spn"){?>
				 $('#sh_alt_email').html("<p>"+altm+" ya se utiliza como correo principal de otra cuenta KPasapp. Utilice otra direcci�n de correo electr�nico alternativa.</p>");
				 <?php } else { ?>
...
function save_password(param)
{
	...
	if(CryptoJS.MD5($('#current_pass').val()) != $('#pass_orig_hid').val()){
...
function getpersoninfo(chb)
{
	if(chb.checked==1)
	{
		sendData = {"country_id":$('#country_id').val(),"state_id":$('#province').val()};
		$.ajax({ 
		   url: "<?php echo $obj_base_path->base_path(); ?>/ajax_folder/ajax_state_bycountry_same.php",
		   cache: false,
		   type: "POST",
		   data: sendData,   
		   success: function(data){
		...
		$('#bus_name').val($('#fname').val()+' '+$('#lname').val());
...
function checkPhone(text_field_name){
	if($('#'+text_field_name).val()!="")
	{
		...
		{
			<?php if($_SESSION['langSessId']=="spn"){ ?>
			alert("Por favor, s�lo introducir caracteres num�ricos, espacios o guiones! (Se permite la entrada:0-9,,-)")
			<?php } else {?>
        ...
        <div class="left_panel bg" style="width:978px;">
          ...
          <div class="clear"></div>                    
            ...
            <div style="font:14px/20px Arial,Helvetica,sans-serif;" id="showStatus"></div>
              ...
              <input type="hidden" name="lang" id="lang" value="<?php echo $obj->f('language')?>" />
                 ...
                 <tr>
                   <td><table width="100%" align="left" border="0" cellpadding="0" cellspacing="0" class="prefer_pro1">
                      ...
                      <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="phone" id="phone" style="width: 150px;" class="textbg_grey" value="<?php echo $obj->f('mobile')?>" onkeyup="checkPhone('phone')" />
                      ...
                      <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="propphone" id="propphone" style="width:150px;" class="textbg_grey" value="<?php echo $obj->f('phone')?>" onkeyup="checkPhone('propphone')" />
                      ...
                      <tr>
                        ...
                        <td><input type="text" name="us_phone" id="us_phone" class="textbg_grey required" style="width: 190px; margin-right: 6px;" value="<?php echo $obj->f('us_phone')?>" onkeyup="checkPhone('us_phone')"/></td>
                      </tr>
                      
                      <tr>
                        <td><?php echo NEXTEL;?></td>
                        <td>
                        <input type="text" name="nextel" id="nextel" class="textbg_grey required" style="width: 190px; margin-right: 6px;" value="<?php echo $obj->f('nextel')?>" onkeyup="checkPhone('nextel')"/>
                        </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <div style="padding:6px;" id="pass_show">
                            ...
                            <input type="hidden" id="pass_orig_hid" value="<?php echo $obj->f('password');?>"/>
                   ...
                   <table width="100%" align="left" border="0" cellpadding="4" cellspacing="0" class="prefer_pro">
                    ...
                    <td width="35%"><?php echo LEGAL_BUS_NAME;?> <span style="color:red;">*</span></td>
                        <td width="65%"><input type="text" name="bus_name" id="bus_name" class="textbg_grey required" value="<?php if($busi_obj->f('busi_name') == ''){ echo $obj->f('fname')." ".$obj->f('lname');}else{ echo $busi_obj->f('busi_name');}?>" style="width: 190px;"/><span class="err" id="err_name"></span></td>
                    </tr>
                    <tr>
                    <td><?php echo DISPLAY_NAME;?><!--<span style="color:red;">*</span>--></td>
                    <td>
                    <input type="text" name="bus_display_name" id="bus_display_name" class="textbg_grey required" value="<?php if($busi_obj->f('busi_display_name') == ''){ echo $obj->f('fname')." ".$obj->f('lname');}else{ echo $busi_obj->f('busi_display_name');}?>" style="width: 190px;"/> <span class="err" id="err_lname"></span>
                    </td>
                    </tr>						  
                    ...
                    <td><?php echo PRIMARY_EMAIL;?><span style="color:red;">*</span></td>
                    <td>
                    <input type="text" name="bus_email" id="bus_email" class="textbg_grey" style="width: 190px; margin-right: 6px;" value="<?php echo $busi_obj->f('busi_primary_email')?>" onblur="return IsEmail();" />
                    </td>
                    </tr>
                    <tr>
                        <td><?php echo CELL_PHONE;?></td>
                        <td>
                            ...
                            <input type="text" name="bus_phone" id="bus_phone" style="width: 100px;" class="textbg_grey" value="<?php echo $busi_obj->f('busi_mobile')?>" onkeyup="checkPhone('bus_phone')"/>
                         </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="bus_propphone" id="bus_propphone" style="width: 100px;" class="textbg_grey" value="<?php echo $busi_obj->f('busi_phone')?>" onkeyup="checkPhone('bus_propphone')" />
                      ...
                      <tr>
                        <td><?php echo US_PHONE_NEXTEL;?></td>
                        <td>
                        <input type="text" name="bus_us_phone" id="bus_us_phone" class="textbg_grey" style="width: 190px; margin-right: 6px;" value="<?php echo $busi_obj->f('busi_us_phone')?>" onkeyup="checkPhone('bus_us_phone')" />
                        </td>
                      </tr>
                      ...
                      <tr>
                        <td><?php echo NEXTEL;?></td>
                        <td>
                        <input type="text" name="bus_nextel" id="bus_nextel" class="textbg_grey" style="width: 190px; margin-right: 6px;" value="<?php echo $busi_obj->f('busi_nextel')?>" onkeyup="checkPhone('bus_nextel')" />
                        </td>
                      </tr>
