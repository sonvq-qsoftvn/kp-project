...
/*-------------------------------------------FOR FEES START--------------------------------------------*/
	...
	if($objEvent->f('include_payment') == 1){
		$add_ed_fee_inc_payment_mx = $objfee->f('ticket_min_mx') + (($objfee->f('ticket_percent_incl')/100)*$_POST['frm_mx_price'.$i]);
	}
	else  
	{
	  $add_ed_fee_inc_payment_mx = $objfee->f('ticket_min_mx') + (($objfee->f('ticket_percent_nincl')/100)*$_POST['frm_mx_price'.$i]);
	}
	
	if($objEvent->f('include_promotion') == 1){
		$add_ed_fee_inc_promotion_mx = $objfee->f('promo_fee_min_mx') + (($objfee->f('promo_percent_incl')/100)*$_POST['frm_mx_price'.$i]);
	}
	else
	{
	 $add_ed_fee_inc_promotion_mx = $objfee->f('promo_fee_min_mx') + (($objfee->f('promo_percent_nincl')/100)*$_POST['frm_mx_price'.$i]);
	}
	...
	// For Us ===================    
	if($objEvent->f('include_payment') == 1){
	       $add_ed_fee_inc_payment_us = $objfee->f('ticket_min_us') + (($objfee->f('ticket_percent_incl')/100)*$_POST['frm_us_price'.$i]);
	}
	else
	{
       $add_ed_fee_inc_payment_us = $objfee->f('ticket_min_us') + (($objfee->f('ticket_percent_nincl')/100)*$_POST['frm_us_price'.$i]);
	}
	
	if($objEvent->f('include_promotion') == 1){
	        $add_ed_fee_inc_promotion_us =  $objfee->f('promo_fee_min_us') + (($objfee->f('promo_percent_incl')/100)*$_POST['frm_us_price'.$i]);
	}
	else
	{
          $add_ed_fee_inc_promotion_us =  $objfee->f('promo_fee_min_us') + (($objfee->f('promo_percent_nincl')/100)*$_POST['frm_us_price'.$i]);
	}
