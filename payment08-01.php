...
<?php if($_SESSION['langSessId']=='eng') {?>  US$ <?php }elseif($_SESSION['langSessId']=='spn'){?>EE.UU. $<?php }?> <a href="<?php echo $obj_base_path->base_path()."/payment.php?event_id=".$e_id."&act=us"; ?>"><input type="radio" name="cur" id="" value="" <?php if($_SESSION['pay'] == 'us'){ echo "checked";}?> /></a> 
			  ...
			  <?php if($_SESSION['langSessId']=='eng') {?>Sign in with <?php }elseif($_SESSION['langSessId']=='spn'){?>Entrar con <?php }?> <a href="<?php echo $obj_base_path->base_path(); ?>/login-facebook.php"><img src='<?php echo $obj_base_path->base_path(); ?>/images/facebook_blue.gif' width="22" height="22" border="0"/></a><a href="<?php echo $authUrl; ?>"><img src='<?php echo $obj_base_path->base_path(); ?>/images/4google_blue.gif' width="22" height="22" border="0"/></a><strong><?php if($_SESSION['langSessId']=='eng') {?> OR<?php }elseif($_SESSION['langSessId']=='spn'){?> O<?php }?></strong> 
		 ...
		 <div class="account_left">
           ...
           <table width="100%" align="center" border="0" cellpadding="4" cellspacing="4" style="border-collapse:separate;">
           	 <tr>
                <td width="23%" style="padding-left: 18px;"><?php if($_SESSION['langSessId']=='eng'){echo "Primary Email";}elseif($_SESSION['langSessId']=='spn'){ echo "Correo Electrónico";} ?><span style="color:red;">*</span></td>
                <td width="30%">
                <input type="text" name="email_cell" id="email_cell" class="textbg_grey" style="width: 190px; margin-right: 6px;" value="<?php echo $obj->f('email')?>" />
                </td>
                <td><a href="javascript:void(0);" onclick="check_user();">Check</a></td>
              </tr>
              <tr>
                ...
                <td>
                  <div id="div_state_display">
                   <select onchange="display();" name="province" id="province" class="selectbg12" style="width:205px; margin-left:5px;">
                        ...
                        <?php
                          $obj_venuestate->getStateById(226);
