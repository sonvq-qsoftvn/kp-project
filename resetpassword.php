					...
					<div class="clear"></div>
                      ...
                      <form method="post" action="" enctype="multipart/form-data" name="reset_pwd" id="reset_pwd" autocomplete = "off" onsubmit="return resetPassword();">
                        ...
                        <table width="100%" align="center" border="0" cellpadding="4" cellspacing="4" style="border-collapse:separate;">
                          ...
                          <tr>
						    <td colspan="2" style="text-align:left; padding-left: 15px;"><input type="submit" name="submit1" id="submit1" value="<?php if($_SESSION['langSessId']=='eng') {?>Reset Password<?php } else {?>restablecer contraseña<?php }?>" class="event_save" style="cursor:pointer;"/></td>
                          </tr>						  
                        </table>
                      </form>
                    </div>
